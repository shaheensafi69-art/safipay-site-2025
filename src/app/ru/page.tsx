    ...
    <div className="bg-[#050505] text-white overflow-x-hidden selection:bg-amber-500/30 relative font-sans" dir="ltr">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-32 overflow-hidden z-10">
        ...
        <div className="relative z-10 text-center max-w-6xl pointer-events-none">
          ...
          >
            Финансовая свобода для каждого афганца
          </motion.div>
          ...
          >
            Расширение возможностей миллионов людей через первый международный цифровой банк.
            Без границ, без ограничений — только безупречный мировой финансовый опыт.
          </motion.p>
          ...
          >
            ...
            >
              Узнать о вызовах <ArrowRight className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center mb-24 text-center">
            ...
            <p className="text-gray-500 text-xl max-w-2xl font-light">
              Текущая финансовая система Афганистана изолирована, устарела и не функционирует.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-7xl mx-auto">
            {[
              { title: '85% без счетов', desc: 'Большинство населения, особенно женщины, не имеют доступа к базовым банковским услугам.' },
              { title: 'Изоляция SWIFT', desc: 'Отключение от мировых сетей делает международные переводы невозможными или опасными.' },
              { title: 'Нерабочие карты', desc: 'Местные карты не принимаются на таких платформах, как Amazon, Netflix или Google.' },
              { title: 'Комиссия 15%', desc: 'Зависимость от неформальных систем приводит к огромным потерям и отсутствию прозрачности.' },
              { title: 'Высокая инфляция', desc: 'Нет простого способа хранить сбережения в стабильных активах (USD/EUR) для защиты семьи.' },
              { title: 'Нет Digital KYC', desc: 'Открытие счета все еще требует личного присутствия и старой бюрократии.' },
              { title: 'Непрозрачность', desc: 'Слабая инфраструктура повышает риски мошенничества и отмывания денег.' },
              { title: 'Закрытая экономика', desc: 'Бизнес не может принимать платежи из-за рубежа, что тормозит национальный рост.' },
            ].map((problem, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-24">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-tighter uppercase italic">
              Будущее уже <span className="text-amber-500">здесь</span>
            </h2>
            <p className="text-gray-400 text-xl font-light italic">
              SafiPay — это не просто приложение, это мост, соединяющий афганцев с мировым рынком.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {[
              { icon: <Globe />, title: 'Глобальный доступ', desc: 'Мгновенные международные счета для афганцев без визитов в банк.' },
              { icon: <CreditCard />, title: 'Виртуальные карты', desc: 'Мгновенный выпуск Visa/Mastercard для мирового шоппинга и подписок.' },
              { icon: <Zap />, title: 'Комиссия 1%', desc: 'Обход дорогой системы «Хавала» с помощью быстрых и прозрачных переводов.' },
              { icon: <Shield />, title: 'Безопасность', desc: 'Банковское шифрование и цифровая верификация (KYC) для вашего спокойствия.' },
              { icon: <BarChart3 />, title: 'Мультивалютность', desc: 'Хранение USD, EUR и других валют для защиты от инфляции.' },
              { icon: <CheckCircle2 />, title: 'Полный комплаенс', desc: 'Работа в рамках мировых правовых норм для финансовой инклюзивности.' },
            ].map((item, i) => (
              <motion.div
                key={i}
