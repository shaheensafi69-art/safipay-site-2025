    ...
    <div className="min-h-screen overflow-x-hidden bg-black text-white font-sans selection:bg-amber-500/30" dir="ltr">
      ...
      <section className="relative z-10 overflow-hidden pt-40 pb-24">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            СВЯЖИТЕСЬ С <span className="bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">НОВОЙ ЭРОЙ</span>
          </motion.h1>
          ...
          >
            Если у вас есть вопросы о международном цифровом банкинге, партнёрствах, поддержке или глобальном финансовом доступе,
            исполнительные каналы SafiPay готовы ответить вам
          </motion.p>
          ...
          >
            <InfoBadge icon={<Headphones size={14} />} text="Живая поддержка" />
            <InfoBadge icon={<ShieldCheck size={14} />} text="Безопасный контакт" />
            <InfoBadge icon={<BadgeCheck size={14} />} text="Проверенные каналы" />
            <InfoBadge icon={<Sparkles size={14} />} text="Премиальная помощь" />
          </motion.div>
        </div>
      </section>
            ...
            <div className="h-full rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-9 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="rounded-[1.8rem] border border-amber-500/15 bg-gradient-to-br from-amber-500/10 to-transparent p-5">
                ...
                <p className="text-sm leading-7 text-gray-400">
                  Всё общение проходит через официальные и защищённые каналы с профессиональной обработкой, ориентированной на конфиденциальность
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative h-full overflow-hidden rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-10 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="relative z-10">
                ...
                >
                  <div className="grid gap-7 md:grid-cols-2">
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        name="name"
                        required
                        placeholder="например, Shaheen Safi"
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      placeholder="Опишите ваш запрос, предложение о партнёрстве, проблему поддержки или детали проекта..."
                  ...
                  >
                    ОТПРАВИТЬ БЕЗОПАСНОЕ СООБЩЕНИЕ
                    <Send size={20} />
                  </motion.button>
                </form>
                ...
                {submitted && (
                  ...
                  >
                    Ваш запрос успешно отправлен в каналы SafiPay
                  </motion.div>
                )}
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Местоположение</p>
                    <p className="mt-2 text-sm font-bold text-white">Париж, Франция</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Операции</p>
                    <p className="mt-2 text-sm font-bold text-white">Глобальное покрытие</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Безопасность</p>
                    <p className="mt-2 text-sm font-bold text-white">Защищено AES-256</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative z-10 border-t border-white/5 bg-black/20 py-16">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {[
              { icon: <MapPin size={16} />, text: 'Париж, Франция' },
              { icon: <Globe size={16} />, text: 'Глобальные операции' },
              { icon: <ShieldCheck size={16} />, text: 'Шифрование AES-256' },
              { icon: <ArrowUpRight size={16} />, text: 'Быстрый ответ руководства' },
            ].map((item, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -3 }}
