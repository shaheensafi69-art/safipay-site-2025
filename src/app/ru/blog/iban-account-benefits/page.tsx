            ...
            <div className="lg:col-span-4 order-2 lg:order-1">
              <div className="sticky top-32 space-y-8">
                <div className="p-10 rounded-[3rem] bg-black border border-[#D4AF37]/30 gold-glow relative overflow-hidden group hover:animate-[border-flow_2s_infinite]">
                  ...
                  <h3 className="text-[#D4AF37] font-black text-xs uppercase tracking-[0.4em] mb-8 text-left">СТРАТЕГИЧЕСКОЕ УПРАВЛЕНИЕ</h3>
                  <p className="text-gray-300 italic text-lg leading-relaxed mb-12 relative z-10 text-left">
                    «В рамках стратегии международного развития под руководством Сахель, ваш европейский IBAN мгновенно интегрируется в сеть SEPA, гарантируя глобальную ликвидность и правовую защиту».
                  </p>
                  ...
                  <div className="flex items-center gap-5 relative z-10">
                    <div className="relative w-16 h-16">
                      <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#D4AF37] to-[#8A6D3B] p-[1px] shadow-[0_0_15px_rgba(212,175,55,0.3)]">
                        <div className="relative w-full h-full rounded-2xl overflow-hidden bg-black">
                          <Image 
                            src="/sahel.jpeg" 
                            alt="Сахель — Директор по международному развитию"
                            fill
                    ...
                    <div>
                      <p className="font-black text-white text-lg tracking-tight">Сахель</p>
                      <p className="text-[10px] text-[#D4AF37] uppercase tracking-widest font-bold">Директор по межд. развитию</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 text-center hover:bg-[#D4AF37]/5 transition-colors group">
                    <p className="text-4xl font-black text-[#D4AF37] group-hover:scale-110 transition-transform">1 мин</p>
                    <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest">Мгновенная выдача</p>
                  </div>
                  <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 text-center hover:bg-[#D4AF37]/5 transition-colors group">
                    <p className="text-4xl font-black text-[#D4AF37] group-hover:scale-110 transition-transform">ЕС</p>
                    <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest">Регулируется в ЕС</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 order-1 lg:order-2 space-y-32">
              <div className="space-y-16 animate-reveal">
                <div className="flex items-center gap-6">
                  ...
                  <h2 className="text-5xl md:text-8xl font-black italic uppercase tracking-tighter text-white">
                    ЗОЛОТОЙ <span className="text-[#D4AF37]">IBAN</span>
                  </h2>
                </div>

                <p className="text-gray-400 text-2xl leading-[2] font-light text-left text-justify">
                  SafiPay предоставляет прямой мост в финансовую систему Европы. Благодаря ядру безопасности военного уровня под контролем **Муджтабы**, мы устранили все традиционные банковские задержки. Ваш выделенный IBAN обеспечивает мгновенные переводы SEPA и дает вам власть управлять своими активами по всему миру со скоростью ведущего европейского банка.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-12 rounded-[3.5rem] bg-gradient-to-br from-white/5 to-transparent border border-white/10 group hover:border-[#D4AF37]/50 transition-all duration-500">
                    ...
                    <h4 className="text-2xl font-black uppercase mb-4 text-white italic tracking-tight">СКОРОСТЬ SEPA</h4>
                    <p className="text-gray-500 text-lg leading-relaxed">Открытие счета менее чем за 1 минуту. Глобальные переводы без бюрократических преград.</p>
                  </div>
                  <div className="p-12 rounded-[3.5rem] bg-gradient-to-br from-white/5 to-transparent border border-white/10 group hover:border-[#D4AF37]/50 transition-all duration-500">
                    <Fingerprint className="text-[#D4AF37] mb-8 group-hover:scale-125 transition-transform duration-500" size={44} />
                    <h4 className="text-2xl font-black uppercase mb-4 text-white italic tracking-tight">ЗАЩИТА МУДЖТАБЫ</h4>
                    <p className="text-gray-500 text-lg leading-relaxed">Защищено самыми современными протоколами шифрования Европейского Союза.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative py-24 border-y border-[#D4AF37]/20">
                ...
                <div className="mt-16 px-12 flex items-center gap-6">
                  ...
                  <p className="text-xs text-gray-600 uppercase font-black">Основатель и CEO</p>
                </div>
              </div>
              ...
              <div className="flex justify-end pt-10 pb-40">
                <Link href={`/${lang}/blog`} className="group flex items-center gap-12">
                  <div className="text-right">
                    <span className="block text-[#D4AF37] font-black uppercase tracking-[0.4em] text-xs mb-3 text-right">ВЕРНУТЬСЯ В ШТАБ-КВАРТИРУ</span>
                    <span className="text-5xl font-black uppercase italic text-white group-hover:text-[#D4AF37] transition-all duration-500">ЭНЦИКЛОПЕДИЯ</span>
                  </div>
