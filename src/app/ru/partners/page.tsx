...
export default function SafiEmpireUltimateRussian() {
    ...
    <div className="bg-[#020202] text-white overflow-x-hidden selection:bg-amber-500/30 font-sans text-left" dir="ltr">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity, scale: heroScale }} className="container mx-auto px-6 text-center z-10">
          ...
          <h1 className="text-6xl md:text-[8rem] font-black italic tracking-tighter leading-[0.9] uppercase mb-10">
            ЛИКВИДНОСТЬ <br/> <span className="text-amber-500">В НОВОМ СВЕТЕ</span>
          </h1>
          <p className="max-w-3xl mx-auto text-gray-500 text-2xl font-light italic leading-relaxed">
            Суверенная финансовая инфраструктура для цифровой элиты. 
            Мгновенный банкинг, глобальные хабы и абсолютная связность.
          </p>
          <motion.div animate={{ y: [0, 20, 0] }} transition={{ repeat: Infinity, duration: 2 }} className="mt-24 flex flex-col items-center gap-4">
            <span className="text-[10px] font-black tracking-widest text-gray-600 uppercase">Узнать больше о Safi</span>
      ...
      <section className="py-32 border-y border-white/5 bg-white/[0.01]">
        <div className="container mx-auto px-6 grid md:grid-cols-4 gap-12 text-center">
          {[
            { label: "ВРЕМЯ ИСПОЛНЕНИЯ", val: "60 СЕК.", icon: Zap },
            { label: "ГЛОБАЛЬНЫЙ ОХВАТ", val: "150+ СТРАН", icon: Globe },
            { label: "ЗАЩИТА АКТИВОВ", val: "TIER 1", icon: ShieldCheck },
            { label: "АКТИВНЫЕ УЗЛЫ", val: "500+", icon: Server }
          ].map((stat, i) => (
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-10">
          <div className="max-w-2xl">
            <h2 className="text-7xl font-black italic uppercase tracking-tighter leading-none mb-8">
              ИНФРАСТРУКТУРА <span className="text-amber-500">SafiPay</span>
            </h2>
            <p className="text-gray-500 text-xl font-light italic leading-relaxed">
              Мы устраняем традиционную банковскую бюрократию. Наша технология vIBAN позволяет управлять капиталом по всему миру от лица вашего юридического лица.
            </p>
          </div>
          <div className="bg-amber-500 text-black px-10 py-4 rounded-full font-black text-sm uppercase italic flex items-center gap-4 hover:scale-105 transition-transform cursor-pointer">
            ДОСТУП К ПОРТАЛУ vIBAN <ArrowUpRight />
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          <BentoCard className="lg:col-span-8 group">
            <div className="flex justify-between items-start mb-24">
              <div>
                <span className="text-amber-500 font-black text-[10px] tracking-widest uppercase">МУЛЬТИВАЛЮТНЫЕ УЗЛЫ</span>
                <h3 className="text-4xl font-black italic uppercase mt-2">ПЕРСОНАЛЬНЫЕ vIBAN</h3>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {['USD', 'EUR', 'GBP', 'PLN', 'SEK', 'NOK', 'RON', 'HUF', 'CZK', 'DKK'].map((curr) => (
                <div key={curr} className="p-6 bg-white/5 border border-white/5 rounded-2xl text-center group-hover:border-amber-500/20 transition-all">
                  ...
                  <div className="text-[8px] text-gray-600 font-bold uppercase tracking-widest">МЕСТНЫЕ РАСЧЕТЫ</div>
                </div>
              ))}
            </div>
          </BentoCard>
          ...
          <BentoCard className="lg:col-span-4 bg-amber-500 text-black border-none flex flex-col justify-between group">
            ...
            <div>
              <h4 className="text-6xl font-black italic leading-[0.8] mb-6 uppercase tracking-tighter">60 <br/> СЕК.</h4>
              <p className="font-bold text-sm uppercase opacity-80 italic leading-tight">Мгновенный выпуск карт Visa через ведущий европейский BIN-спонсоринг.</p>
            </div>
          </BentoCard>
        </div>
      </section>
      ...
      <section className="py-40 bg-white/[0.01] border-y border-white/5 relative">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-32 items-center">
          <div className="space-y-12">
            <h2 className="text-7xl font-black italic uppercase leading-none tracking-tighter">СУВЕРЕННАЯ <br/> <span className="text-amber-500">БЕЗОПАСНОСТЬ</span></h2>
            <div className="space-y-8">
              {[
                { t: "Регулируется EFSA Эстонии", d: "Инфраструктура под надзором, гарантирующая защиту активов по стандартам ЕС." },
                { t: "PCI DSS Level 1", d: "Высшая сертификация безопасности для обработки глобальных платежей." },
                { t: "Институциональные vIBAN", d: "Прямые счета через узлы Safi International Capital LTD." }
              ].map((item, i) => (
          ...
          <div className="relative p-12 bg-black border border-white/10 rounded-[4rem] overflow-hidden group">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <h3 className="text-4xl font-black italic uppercase tracking-tighter">РЕГУЛИРУЕМО И ПРОВЕРЕНО</h3>
              <p className="text-gray-500 text-lg leading-relaxed italic">
                Наша инфраструктура построена на прозрачности. Каждая транзакция отслеживается AML-системами на базе ИИ, при этом сохраняется полная конфиденциальность наших клиентов.
              </p>
              <div className="pt-8 border-t border-white/5 flex gap-8">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-700 mb-2">РЕГИСТРАЦИОННЫЙ НОМЕР</p>
                  <p className="font-mono text-xs">UK #17063286</p>
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-700 mb-2">СТАТУС ЛИЦЕНЗИИ</p>
                  <p className="font-mono text-xs text-green-500 uppercase font-bold">АКТИВНА / ACTIVE</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-60 container mx-auto px-6 overflow-hidden">
        <div className="text-center mb-40">
          <motion.h2 initial={{ scale: 0.8 }} whileInView={{ scale: 1 }} className="text-[10vw] font-black italic uppercase tracking-tighter leading-none mb-10">
            ГЛОБАЛЬНАЯ <br/> <span className="text-blue-500">СВЯЗЬ</span>
          </motion.h2>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <BentoCard className="aspect-square flex flex-col items-center justify-center border-blue-500/10 hover:border-blue-500/40">
            ...
            <p className="text-gray-500 uppercase text-[10px] font-black tracking-[0.5em]">700+ ПРЯМЫХ УЗЛОВ ОПЕРАТОРОВ</p>
          </BentoCard>

          <div className="space-y-16">
            <h3 className="text-5xl font-black italic uppercase tracking-tighter leading-tight">СВЯЗЬ ДЛЯ <br/> 5 МИЛЛИАРДОВ УСТРОЙСТВ</h3>
            <p className="text-gray-400 text-2xl font-light italic leading-relaxed">
              От улиц Лондона до центров Дубая — мы обеспечиваем мгновенное пополнение и 5G E-SIM пакеты данных в более чем 150 странах.
            </p>
            <div className="grid grid-cols-2 gap-8">
              {[
                { label: "ОПЕРАТОРЫ", val: "700+", icon: Layers },
                { label: "МГНОВЕННАЯ ДОСТАВКА", val: "99.9%", icon: Zap }
              ].map((item, i) => (
      ...
      <section className="py-40 container mx-auto px-6 text-center">
        <div className="bg-white/[0.02] border border-white/10 rounded-[4rem] p-16 overflow-hidden relative">
          <div className="relative z-10">
            <h2 className="text-5xl font-black italic uppercase tracking-tighter mb-20">ТРАДИЦИОННЫЙ БАНКИНГ VS. <span className="text-amber-500">SAFI EMPIRE</span></h2>
            <div className="grid md:grid-cols-2 gap-20">
              <div className="space-y-10 opacity-40">
                <h4 className="text-2xl font-black italic uppercase border-b border-white/10 pb-4">УСТАРЕВШИЕ СИСТЕМЫ</h4>
                {["Недели на открытие счета", "Скрытые комиссии за обмен", "Бумажная волокита", "Ограниченные виртуальные карты"].map(text => (
              ...
              <div className="space-y-10">
                <h4 className="text-2xl font-black italic uppercase border-b border-amber-500/30 pb-4 text-amber-500">ЭКОСИСТЕМА SAFI</h4>
                {["Выпуск за 60 секунд", "Институциональные курсы", "100% цифровой KYC", "Безлимитные активы vIBAN"].map(text => (
      ...
      <section className="py-60 container mx-auto px-6">
        <div className="max-w-4xl mx-auto space-y-64">
          {[
            { phase: "01", title: "GENESIS", date: "МАРТ 2026", desc: "Основание в Лондоне. Развертывание банковских API-узлов Tier-1 в Европе.", icon: <Database /> },
            { phase: "02", title: "VELOCITY", date: "ИЮНЬ 2026", desc: "Полный запуск Safi TopUp. Интеграция глобального хаба E-SIM.", icon: <Wifi /> },
            { phase: "03", title: "SOVEREIGNTY", date: "СЕНТЯБРЬ 2026", desc: "Запуск мобильного приложения SafiPay. Активация верификации в реальном времени.", icon: <Smartphone /> },
            { phase: "04", title: "DOMINANCE", date: "2027", desc: "Выпуск физических титановых карт. Эксклюзивные лаунджи в Лондоне и Дубае.", icon: <Briefcase /> }
          ].map((item, i) => (
        ...
        <div className="container mx-auto px-6">
          <MagneticElement>
            <h2 className="text-7xl md:text-[9rem] font-black italic uppercase tracking-tighter leading-none mb-20 hover:text-amber-500 transition-colors cursor-pointer">
              ЗАЩИТИТЕ <br/> <span className="text-amber-500">СВОЕ НАСЛЕДИЕ</span>
            </h2>
          </MagneticElement>
          ...
          <div className="grid md:grid-cols-4 gap-12 mt-40 text-[10px] font-black uppercase tracking-[0.2em] text-gray-700 border-t border-white/5 pt-20">
            <div>
              <p className="text-amber-500 mb-4">ОРГАНИЗАЦИЯ</p>
              <p className="text-white">UK Reg. #17063286</p>
            </div>
            <div>
              <p className="text-amber-500 mb-4">ШТАБ-КВАРТИРА</p>
              <p className="text-white">Shelton Street, London</p>
            </div>
            <div>
              <p className="text-amber-500 mb-4">БЕЗОПАСНОСТЬ</p>
              <p className="text-green-500">УЗЛЫ АКТИВНЫ / OPERATIONAL</p>
            </div>
            <div>
              <p className="text-amber-500 mb-4">ОСНОВАТЕЛЬ</p>
              <p className="text-white tracking-[0.1em]">ШАХИН САФИ</p>
            </div>
          </div>
          <p className="mt-20 text-[8px] tracking-[1.5em] text-gray-800 uppercase">Safi International Capital LTD © 2026 | Все права защищены</p>
        </div>
      </footer>
    </div>
  );
