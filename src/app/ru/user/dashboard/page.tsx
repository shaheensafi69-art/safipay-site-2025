...
const fullCurrencies = [
  ...
  { 
    code: 'NOK', name: 'Norway', flag: '🇳🇴', balance: '0.00',
    details: [
  ...
  { 
    code: 'RON', name: 'Romania', flag: '🇷🇴', balance: '0.00',
    details: [
  ...
  { 
    code: 'HUF', name: 'Hungary', flag: '🇭🇺', balance: '0.00',
    details: [
  ...
  { 
    code: 'CZK', name: 'Czech Republic', flag: '🇨🇿', balance: '0.00',
    details: [
  ...
  { 
    code: 'DKK', name: 'Denmark', flag: '🇩🇰', balance: '0.00',
    details: [
...
const features = [
  { 
    ...
    desc: "Send funds to Afghanistan and 150+ countries. Real-time tracking and zero hidden fees.",
    icon: <Send />,
    ui: (
      <div className="p-5 space-y-4">
        <div className="bg-zinc-900/80 p-3 rounded-xl border border-white/5">
          <p className="text-[8px] text-zinc-500 uppercase">Amount to Send</p>
          <p className="text-xl font-black text-amber-500">$1,500.00</p>
        </div>
        <div className="space-y-2">
           <div className="flex justify-between text-[10px] font-bold px-1"><span>Receiver</span><span className="text-amber-500">Add New +</span></div>
        ...
        <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">CONFIRM TRANSFER</button>
      </div>
    )
  },
  { 
    title: "Visa Gold Cards", 
    desc: "Generate virtual cards instantly or order physical Gold-Plated cards for global use.",
    icon: <CardIcon />,
    ui: (
      <div className="p-5 space-y-6">
        ...
        <div className="space-y-2">
           <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">Contactless</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
           <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">Online Payments</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
        </div>
      </div>
    )
  },
  { 
    title: "Bank Details", 
    desc: "Full local banking infrastructure in Europe, UK, and USA. Your own personal IBANs.",
    icon: <Building2 />,
    ui: (
      <div className="p-5 space-y-3">
        <div className="text-[10px] font-black text-zinc-500 uppercase px-1">My Accounts</div>
        {['EUR IBAN', 'UK Sort Code', 'USD Routing'].map((t, i) => (
        ...
        <button className="w-full border border-dashed border-zinc-700 py-3 rounded-xl text-[8px] text-zinc-500">REQUEST NEW IBAN</button>
      </div>
    )
  },
  { 
    title: "Smart Exchange", 
    desc: "Instant currency swap with real-time institutional rates. No hidden commissions.",
    icon: <RefreshCcw />,
    ui: (
      <div className="p-5 space-y-8 text-center">
        <div className="bg-zinc-900 p-4 rounded-2xl">
           <p className="text-[8px] text-zinc-500 uppercase">From EUR</p>
        ...
        <div className="bg-zinc-900 p-4 rounded-2xl">
           <p className="text-[8px] text-zinc-500 uppercase">To USD</p>
  ...
  { 
    title: "Mobile Top-up", 
    desc: "Recharge 700+ global operators including AWCC, Roshan, and Etisalat instantly.",
    icon: <SmartphoneNfc />,
    ui: (
      <div className="p-5 space-y-4">
        ...
        <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">RECHARGE NOW</button>
      </div>
    )
  },
  { 
    ...
    ui: (
      <div className="p-5 space-y-3">
        <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
           ...
           <p className="text-[10px] font-black italic">Electricity Kabul</p>
        </div>
        <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
           <div className="flex justify-between items-center"><div className="w-8 h-8 bg-zinc-800 rounded-lg" /><div className="w-12 h-4 bg-zinc-800 rounded-full" /></div>
  ...
  { 
    title: "Analytics", 
    desc: "Monitor your financial health with AI-driven charts and real-time transaction history.",
    icon: <TrendingUp />,
    ui: (
      <div className="p-5 space-y-6">
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-28 pb-32 px-6 font-sans">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
               <span className="px-3 py-1 bg-amber-500/10 border border-amber-500/20 text-amber-500 text-[9px] font-black uppercase rounded-full tracking-widest">VIP Executive</span>
        ...
        {/* --- 7 FEATURE SECTIONS WITH PERFECT 3D ANGLES --- */}
              ...
              >
                <div className="flex justify-between items-center mb-12">
                  <div className="flex items-center gap-6">
                    ...
                    <h3 className="text-4xl font-black italic uppercase tracking-tighter">{selectedCurrency.code} <span className="text-zinc-600">Assets</span></h3>
                  </div>
                ...
                <div className="mt-10 p-6 bg-amber-500/5 border border-amber-500/20 rounded-3xl text-center">
                   <p className="text-[10px] text-amber-500 font-black uppercase tracking-widest">Global Transfer Instruction</p>
                   <p className="text-[11px] text-zinc-500 mt-2">Use these local bank details to receive funds directly into your SafiPay wallet. Transfers within the SEPA/Faster Payments network are instant.</p>
                </div>
              </motion.div>
            </div>
          )}
