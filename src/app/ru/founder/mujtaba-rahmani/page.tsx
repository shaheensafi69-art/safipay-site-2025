      ...
      <div className="relative z-10">
          ...
          <motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }} className="relative">
            <div className="relative w-64 h-64 md:w-80 md:h-80 z-10">
              ...
              <div className="relative h-full w-full rounded-[4rem] overflow-hidden border-2 border-blue-500/30 p-2 bg-[#050505]">
                <Image src="/mujtaba.jpeg" alt="Муджтаба Рахмани" fill className="object-cover rounded-[3.5rem]" priority />
              </div>
            </div>
            ...
            <motion.div style={{ x: moveY, y: moveX, translateZ: 180 }} className="absolute -right-16 top-10">
                <div className="bg-blue-600 text-white p-4 rounded-3xl shadow-2xl font-black italic tracking-widest uppercase">Сооснователь</div>
            </motion.div>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mt-12 px-6">
            <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter text-white uppercase">МУДЖТАБА <span className="text-blue-500">РАХМАНИ</span></h1>
            <p className="text-blue-400 font-bold tracking-[0.3em] text-xl mt-4 uppercase">Сооснователь SafiPay и специалист по экономике</p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-10 text-gray-500 text-sm">
               <span className="flex items-center gap-2"><MapPin size={16}/> Район 5, Чарахи Камбар, Кабул</span>
        ...
        <section className="py-20 bg-blue-600/[0.02]">
          <div className="container mx-auto max-w-6xl px-6">
            <h2 className="text-center text-4xl font-black mb-20 italic uppercase">Ключевые компетенции</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4">Анализ рынка</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">Продвинутый технический анализ, Price Action, управление ликвидностью и торговые стратегии Forex.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <Globe className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Цифровая экономика</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">Стратегическое развитие онлайн-бизнеса, масштабирование e-commerce и глобальная экспансия.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <PieChart className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Финансовая стратегия</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">Распределение активов, управление Risk-to-Reward и оптимизация систем FinTech.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <Gamepad2 className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Технологии Next-Gen</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">Цифровая банковская инфраструктура, основы блокчейна и высокопроизводительные игровые системы.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12">
            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><Briefcase className="text-blue-500"/> ПРОФЕССИОНАЛЬНЫЙ ОПЫТ</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-xl font-bold text-white">Независимый Forex-трейдер</h4>
                  <p className="text-blue-400 text-sm mb-2">Индивидуальный предприниматель (2021 - Наст. время)</p>
                  <p className="text-gray-500 text-sm leading-relaxed">Анализ мировых валютных рынков и точное управление портфелями диверсифицированных цифровых активов.</p>
                </div>
              </div>
            </div>

            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><GraduationCap className="text-blue-500"/> ОБРАЗОВАНИЕ</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                <div className="relative">
                  <div className="absolute -left-[41px] top-2 w-4 h-4 bg-blue-600 rounded-full" />
                  <h4 className="text-xl font-bold text-white">Бакалавр экономики и онлайн-бизнеса</h4>
                  <p className="text-blue-400 text-sm font-bold uppercase tracking-widest mt-1">Специализированный диплом</p>
                  <p className="text-gray-500 text-sm mt-2">Глубокое изучение мировых финансовых рынков, стратегий цифровой торговли и экономического моделирования.</p>
                </div>
                <div className="pt-6">
                   <h3 className="text-xl font-bold mb-6 flex items-center gap-3 uppercase"><Activity size={20} className="text-blue-500"/> ФИЗИЧЕСКАЯ ДИСЦИПЛИНА</h3>
                   <div className="flex flex-wrap gap-4">
                     {['MMA', 'Бег на выносливость', 'High-Stakes Гейминг'].map(item => (
        ...
        <section className="py-20 container mx-auto max-w-4xl px-6 text-center">
            <div className="bg-gradient-to-br from-blue-600/20 to-transparent p-12 rounded-[4rem] border border-blue-500/20 relative overflow-hidden">
                ...
                <h2 className="text-3xl font-black mb-6 italic uppercase">Ключевые достижения</h2>
        ...
        <footer className="py-20 text-center">
          ...
          <p className="opacity-30 text-[10px] tracking-[0.4em] uppercase font-black">
            Муджтаба Рахмани • Сооснователь SafiPay и специалист по экономике • 2026
          </p>
        </footer>
      </div>
    </div>
