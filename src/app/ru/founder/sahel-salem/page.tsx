      ...
      <div className="relative z-10">
        ...
        <section ref={containerRef} className="relative pt-40 pb-20 flex flex-col items-center">
          ...
          <div className="text-center mt-16 px-6">
            ...
            <p className="text-emerald-500 font-bold tracking-[0.5em] text-lg uppercase mt-4">Директор по международному развитию</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="p-10 rounded-[3.5rem] bg-gradient-to-br from-emerald-600/20 to-transparent border border-emerald-500/20">
                ...
                <h4 className="text-2xl font-black italic uppercase mb-2">Академические успехи</h4>
                <p className="text-gray-400 text-sm leading-relaxed">
                  University of the People, США <br/>
                  <span className="text-emerald-400 font-mono tracking-widest uppercase text-xs">Специализация: Бизнес-администрирование</span>
                </p>
              </div>
              ...
              <div className="p-10 rounded-[3.5rem] bg-white/[0.02] border border-white/5 flex items-center justify-between group cursor-pointer hover:bg-white/[0.05] transition-all duration-500">
                 <div>
                    <p className="text-[10px] uppercase font-black text-gray-500 mb-1">Прямой контакт</p>
                    <p className="text-lg font-bold">Официальный WhatsApp</p>
                 </div>
        ...
        <footer className="py-20 text-center relative">
          ...
          <p className="text-gray-600 text-[10px] uppercase font-black tracking-[1em] mb-8">
            Сахель Салем • Международный лидер SafiPay • 2026
          </p>
