...
export default function VisaCardGuidePage() {
  ...
  // تنظیم زبان بر اساس پارامتر یا پیش‌فرض عربی
  const lang = params?.lang || 'ar';
  const isRtl = lang === 'ar' || lang === 'fa';

  const content = {
    ar: {
      category: "الدليل والتحليل الاستراتيجي",
      title: "بطاقة فيزا SafiPay الافتراضية؛",
      subtitle: "إنهاء العزلة المالية في أفغانستان",
      author: "Safi AI",
      role: "المتحدث الرسمي باسم SafiPay",
      readTime: "قراءة لمدة 15 دقيقة",
      intro: "تصدر العديد من البنوك المحلية في أفغانستان بطاقات صالحة فقط داخل الحدود الوطنية. لقد حطمت SafiPay هذه القيود. نحن نصدر بطاقات تعمل بقوة في قلب أوروبا والولايات المتحدة وعبر جميع المواقع والمنصات العالمية.",
      advantageTitle: "لماذا تختلف بطاقة الفيزا الخاصة بنا؟",
      advantageText: "المشكلة الأكبر في البطاقات المصرفية الحالية في أفغانستان هي الافتقار التام للاتصال بأنظمة الدفع العالمية. تصدر بطاقات SafiPay مباشرة من المؤسسات المالية في الاتحاد الأوروبي. وهذا يعني أنه يمكنك دفع نفقاتك في جميع أنحاء العالم من كابل أو هرات — أو أي مكان آخر — دون خوف من رفض المعاملة أو الحظر.",
      comparisonTitle: "الاختلافات الرئيسية في لمحة",
      comp1: "الوظائف العالمية: على عكس البنوك المحلية، بطاقتنا نشطة بنسبة 100% على جميع البوابات الدولية دون قيود جغرافية.",
      comp2: "سرعة الإصدار: إصدار رقمي في أقل من دقيقة واحدة، بينما تجعلك البنوك التقليدية تنتظر لأسابيع للحصول على بطاقة بسيطة.",
      comp3: "الأمن الفني: إشراف مباشر من قبل مجتبى (مدير الأمن الفني) لضمان أعلى مستويات التشفير في جميع البروتوكولات.",
      techTitle: "البنية التحتية التقنية والإدارية",
      techDesc: "قام مجتبى، مدير العمليات والأمن الفني لدينا، بتنفيذ بروتوكولات متطورة تضمن تجاوز معاملاتك للفلاتر الدولية الصارمة. بالإضافة إلى ذلك، ضمنت ساحل (مديرة التطوير الدولي) توافق هذه البطاقات بالكامل مع القوانين النقدية الأوروبية وحسابات IBAN لتحقيق تكامل سلس.",
      quote: "نحن لا نصدر بطاقة فحسب؛ بل نفتح بوابات الاقتصاد العالمي لكل مواطن أفغاني. من حقك أن تكون متصلاً بالعالم.",
      quoteAuthor: "شاهين صافي — مؤسس SafiPay",
      backBtn: "العودة إلى موسوعة SafiPay"
    }
  };
            ...
            <article className={`space-y-16 text-gray-300 leading-[2.4] ${isRtl ? 'text-right' : 'text-left'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 my-24">
                <div className="p-12 rounded-[3rem] bg-white/[0.02] border border-white/10 transition-all duration-500 hover:scale-105 hover:bg-white/[0.05] group">
                  ...
                  <h4 className="text-white font-black text-2xl mb-4">التسوق العالمي</h4>
                  <p className="text-gray-500 leading-relaxed text-sm">احصل على وصول غير محدود إلى أمازون وإيباي وجميع بوابات الدفع الدولية بأمان SafiPay النخبة.</p>
                </div>
                <div className="p-12 rounded-[3rem] bg-white/[0.02] border border-white/10 transition-all duration-500 hover:scale-105 hover:bg-white/[0.05] group">
                  ...
                  <h4 className="text-white font-black text-2xl mb-4">أمن أوروبي</h4>
                  <p className="text-gray-500 leading-relaxed text-sm">تتم مراقبة معاملاتك مباشرة من قبل مجتبى وهي تتوافق تماماً مع معايير البنك في الاتحاد الأوروبي.</p>
                </div>
              </div>
            </article>
