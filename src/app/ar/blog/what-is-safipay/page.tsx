...
export default function WhatIsSafiPay() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-[#D4AF37] font-sans overflow-x-hidden" dir="rtl">
      ...
      <section className="relative pt-32 pb-24 px-6 z-10 border-b border-white/5">
        <div className="container mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/5 mb-8 animate-fade-in">
            ...
            <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-[0.3em]">البيان الرسمي 2026</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-black mb-10 tracking-tighter italic leading-none">
            إعادة تعريف <br />
            <span className="text-[#D4AF37]">المالية الرقمية</span>
          </h1>
          
          <p className="max-w-4xl mx-auto text-gray-400 text-xl md:text-2xl leading-relaxed font-light mb-12">
            صافي باي (SafiPay) ليست مجرد محفظة رقمية؛ بل هي منظومة مالية عالية الأداء تم هندستها في قلب أوروبا. لقد جسرنا الفجوة بين أمان الخدمات المصرفية التقليدية وسرعة التكنولوجيا المالية الحديثة لتمكين مواطني العالم من تجاوز الحدود المالية.
          </p>
      ...
      {/* الركائز الأساسية - لماذا نحن الرواد */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="text-right">
              <h2 className="text-4xl md:text-5xl font-black mb-8 italic uppercase">
                لماذا تختار النخبة <br /><span className="text-[#D4AF37]">SafiPay</span>
              </h2>
              <div className="space-y-8">
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="text-2xl font-bold mb-2">أمان مؤسسي</h4>
                    <p className="text-gray-500">نعمل تحت إشراف معايير الاتحاد الأوروبي المالية، مما يضمن حماية أصولك من خلال أكثر أطر الامتثال صرامة في العالم.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="text-2xl font-bold mb-2">إصدار فوري بدون انتظار</h4>
                    <p className="text-gray-500">انسَ فترات الانتظار التي تمتد لأسابيع. في صافي باي، يتم إصدار بطاقات فيزا الافتراضية وحسابات IBAN في أقل من 60 ثانية. السرعة هي وعدنا الأساسي.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="text-2xl font-bold mb-2">حساب IBAN أوروبي مباشر</h4>
                    <p className="text-gray-500">حساب بنكي أوروبي شرعي باسمك الخاص. أرسل واستقبل تحويلات SEPA وكأنك تعيش في بروكسل أو برلين.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="glass-card rounded-[3rem] p-4 border border-white/10 relative overflow-hidden">
                 <Image 
                  ...
                  alt="تكنولوجيا صافي باي الأساسية" 
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-500 uppercase tracking-widest text-xs">دولة مدعومة</div>
            </div>
            <div>
              <div className="text-[#D4AF37] text-5xl font-black mb-2">دقيقة واحدة</div>
              <div className="text-gray-500 uppercase tracking-widest text-xs">وقت التفعيل</div>
            </div>
            <div>
              <div className="text-[#D4AF37] text-5xl font-black mb-2">100%</div>
              <div className="text-gray-500 uppercase tracking-widest text-xs">امتثال للاتحاد الأوروبي</div>
            </div>
            <div>
              <div className="text-[#D4AF37] text-5xl font-black mb-2">24/7</div>
              <div className="text-gray-500 uppercase tracking-widest text-xs">دعم عالمي</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-32 bg-gradient-to-t from-[#D4AF37]/10 to-transparent z-10 relative text-center px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black mb-8 italic uppercase">إرث قيد التأسيس</h2>
          <p className="text-gray-400 text-lg mb-12 italic">
            "لم نقم ببناء صافي باي لتكون مجرد تطبيق آخر على هاتفك؛ بل بنيناها لتكون المفتاح الذي يفتح أبواب الاقتصاد العالمي للجميع، بغض النظر عن مكان ولادتهم."
          </p>
          <div className="h-[1px] w-20 bg-[#D4AF37] mx-auto mb-4" />
          <div className="text-white font-bold tracking-widest uppercase italic">فريق قيادة SafiPay</div>
        </div>
      </footer>
