            ...
            <div className="lg:col-span-4 order-2 lg:order-2">
              <div className="sticky top-32 space-y-8">
                <div className="p-10 rounded-[3rem] bg-black border border-[#D4AF37]/30 gold-glow relative overflow-hidden group hover:animate-[border-flow_2s_infinite]">
                  ...
                  <h3 className="text-[#D4AF37] font-black text-xs uppercase tracking-[0.4em] mb-8 text-right">الإشراف التنفيذي</h3>
                  <p className="text-gray-300 italic text-lg leading-relaxed mb-12 relative z-10 text-justify">
                    "تحت استراتيجية التطوير الدولي التي تقودها ساحل، يتم دمج حساب IBAN الأوروبي الخاص بك فوراً في شبكة SEPA، مما يضمن لك السيولة العالمية والحماية القانونية."
                  </p>
                  ...
                  <div className="flex items-center gap-5 relative z-10">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-[#D4AF37] uppercase tracking-widest font-bold">مديرة التطوير الدولي</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 text-center hover:bg-[#D4AF37]/5 transition-colors group">
                    <p className="text-4xl font-black text-[#D4AF37] group-hover:scale-110 transition-transform">دقيقة ١</p>
                    <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest">إصدار فوري</p>
                  </div>
                  <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 text-center hover:bg-[#D4AF37]/5 transition-colors group">
                    <p className="text-4xl font-black text-[#D4AF37] group-hover:scale-110 transition-transform">EU</p>
                    <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest">خاضع للرقابة الأوروبية</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 order-1 lg:order-1 space-y-32">
              <div className="space-y-16 animate-reveal">
                <div className="flex items-center gap-6">
                  ...
                  <h2 className="text-5xl md:text-8xl font-black italic uppercase tracking-tighter text-white">
                    الجسر الذهبي <span className="text-[#D4AF37]">IBAN</span>
                  </h2>
                </div>

                <p className="text-gray-400 text-2xl leading-[2] font-light text-justify">
                  توفر SafiPay جسراً مباشراً إلى النظام المالي الأوروبي. بفضل النواة الأمنية ذات المعايير العسكرية التي يشرف عليها **مجتبى**، قمنا بإلغاء جميع التأخيرات المصرفية التقليدية. يتيح لك حسابك المخصص تحويل الأموال فوراً عبر شبكة SEPA، مما يمنحك القدرة على إدارة ثروتك عالمياً بسرعة تضاهي كبرى البنوك الأوروبية.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-12 rounded-[3.5rem] bg-gradient-to-br from-white/5 to-transparent border border-white/10 group hover:border-[#D4AF37]/50 transition-all duration-500 text-right">
                    ...
                    <h4 className="text-2xl font-black uppercase mb-4 text-white italic tracking-tight">سرعة SEPA</h4>
                    <p className="text-gray-500 text-lg leading-relaxed">إصدار الحساب في أقل من دقيقة واحدة. تحويلات عالمية فورية دون تعقيدات بيروقراطية.</p>
                  </div>
                  <div className="p-12 rounded-[3.5rem] bg-gradient-to-br from-white/5 to-transparent border border-white/10 group hover:border-[#D4AF37]/50 transition-all duration-500 text-right">
                    <Fingerprint className="text-[#D4AF37] mb-8 group-hover:scale-125 transition-transform duration-500" size={44} />
                    <h4 className="text-2xl font-black uppercase mb-4 text-white italic tracking-tight">أمن مجتبى</h4>
                    <p className="text-gray-500 text-lg leading-relaxed">محمي بأحدث بروتوكولات التشفير المعتمدة داخل الاتحاد الأوروبي.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative py-24 border-y border-[#D4AF37]/20">
                ...
                <div className="mt-16 px-12 flex items-center gap-6">
                  ...
                  <p className="text-xs text-gray-600 uppercase font-black">المؤسس والمدير التنفيذي</p>
                </div>
              </div>
              ...
              <div className="flex justify-start pt-10 pb-40">
                <Link href={`/${lang}/blog`} className="group flex items-center gap-12">
                  ...
                  <div className="text-right order-2">
                    <span className="block text-[#D4AF37] font-black uppercase tracking-[0.4em] text-xs mb-3">العودة إلى مركز المعلومات</span>
                    <span className="text-5xl font-black uppercase italic text-white group-hover:text-[#D4AF37] transition-all duration-500">الموسوعة</span>
                  </div>
                </Link>
              </div>
            </div>
