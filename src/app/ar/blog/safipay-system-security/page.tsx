        ...
        <div className="container mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-blue-500 font-bold tracking-widest text-[10px] uppercase">
              Encrypted Core v2.0 — النواة المشفرة
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed max-w-xl font-light text-justify opacity-0 animate-[fadeIn_1s_ease-out_0.3s_forwards]">
              نحن لسنا مجرد بنك؛ نحن قلعة رقمية. تحت القيادة التقنية لمجتبى، تستخدم SafiPay بروتوكولات معايير الاتحاد الأوروبي للقضاء على الحدود المالية وتوفير أمان لا يضاهى.
            </p>
            ...
            <div className="flex justify-start group">
              <div className="relative w-full max-w-md aspect-video rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl shadow-blue-500/10 transition-transform duration-500 group-hover:scale-[1.02]">
                ...
                <div className="absolute bottom-6 right-6 flex flex-row-reverse items-center gap-3">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-green-400">مصفوفة أمان مجتبى نشطة الآن</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-8 rounded-[2rem] bg-white/[0.03] border border-white/10 backdrop-blur-xl hover:bg-white/[0.06] transition-all duration-300">
                <div className="flex flex-row-reverse items-center gap-4 mb-6 text-right">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 uppercase font-bold">المتحدث الرسمي</p>
                  </div>
                </div>
                <p className="text-md text-gray-400 leading-relaxed mb-6 italic text-justify">
                  "أمننا هو الجسر بين العزلة والسوق العالمي. مجتبى يؤمن الأكواد البرمجية، بينما تضمن ساحل الامتثال للمعايير الدولية."
                </p>
                <div className="flex flex-row-reverse items-center gap-2 text-blue-500 text-xs font-bold justify-start">
                  <CheckCircle2 size={14} className="animate-pulse" /> معتمد من قبل SafiPay الاتحاد الأوروبي
                </div>
              </div>

              <div className="space-y-4 text-right">
                <div className="text-[10px] font-bold text-gray-600 uppercase tracking-widest px-4">طبقات الدفاع التقني</div>
                {['تشفير AES-256-GCM', 'بروتوكول TLS 1.3 عالي الأمان', 'إثباتات المعرفة الصفرية'].map((tech) => (
                  <div 
                    key={tech} 
              ...
              <div className="space-y-24">
                ...
                <div className="space-y-8">
                  <h2 className="text-4xl md:text-5xl font-black italic tracking-tight flex flex-row-reverse items-center gap-4 text-right">
                    <Activity className="text-blue-500" /> مصفوفة الأمان
                  </h2>
                  <p className="text-gray-400 text-lg leading-[2.2] text-justify font-light">
                    في العصر الرقمي، الأمان هو العملة الوحيدة التي تهم. لقد صمم مدير الأمن التقني لدينا، مجتبى، نظام دفاع متعدد الطبقات يعمل في الخفاء. تخضع كل معاملة لتدقيق Safi AI، ويتم الاحتفاظ بكل أصل ضمن بنية تحتية منظمة في الاتحاد الأوروبي لا تستطيع البنوك التقليدية مضاهاتها في السرعة أو الأمان.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-10">
                    <div className="p-10 rounded-[3rem] bg-gradient-to-br from-blue-600/10 to-transparent border border-blue-500/20 hover:translate-y-[-10px] transition-all duration-300 text-right">
                      ...
                      <h3 className="text-xl font-bold mb-4 uppercase italic">أكواد غير قابلة للاختراق</h3>
                      <p className="text-sm text-gray-400 leading-relaxed">يقوم فريق مجتبى باختبارات اختراق على مدار الساعة لكل عقدة في شبكة SafiPay لضمان عمليات خالية من الثغرات بنسبة 100%.</p>
                    </div>
                    ...
                    <div className="p-10 rounded-[3rem] bg-white/[0.02] border border-white/5 hover:translate-y-[-10px] transition-all duration-300 text-right">
                      ...
                      <h3 className="text-xl font-bold mb-4 uppercase italic">رقابة الاتحاد الأوروبي</h3>
                      <p className="text-sm text-gray-500 leading-relaxed">تضمن ساحل دمج جميع البروتوكولات مع نظام SEPA الأوروبي والتفويضات المصرفية لتحقيق أمان قانوني وسيولة عابرة للحدود.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative py-20 border-y border-white/10 group text-right">
                  ...
                  <div className="mt-12 flex flex-row-reverse items-center gap-6 justify-start">
                    ...
                    <p className="text-xl font-bold tracking-widest uppercase">شاهين صافي — المؤسس</p>
                  </div>
                </div>
