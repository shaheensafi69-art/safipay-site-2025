...
export default function FinalEliteDashboard() {
  ...
  const fullName = `${user?.user_metadata?.first_name || ''} ${user?.user_metadata?.last_name || ''}`.trim() || user?.user_metadata?.full_name || 'المستخدم';

  // --- القائمة الكاملة لـ 10 عملات مع جميع التفاصيل البنكية المطلوبة ---
  const fullCurrencies = [
    { 
      code: 'EUR', name: 'الاتحاد الأوروبي', flag: '🇪🇺', balance: '0.00',
      details: [
        { label: 'المستفيد', value: fullName },
        { label: 'IBAN', value: 'BE96 3633 1234 5678 9012' },
        { label: 'BIC / SWIFT', value: 'SAFIBEBBXXX' },
        { label: 'البنك', value: 'SafiPay Europe SA' }
      ]
    },
    { 
      code: 'GBP', name: 'بريطانيا', flag: '🇬🇧', balance: '0.00',
      details: [
        { label: 'صاحب الحساب', value: fullName },
        { label: 'رقم الحساب', value: '88776655' },
    ...
    { 
      code: 'USD', name: 'الولايات المتحدة', flag: '🇺🇸', balance: '0.00',
      details: [
        { label: 'صاحب الحساب', value: fullName },
        { label: 'رقم الحساب', value: '009876543210' },
        { label: 'ACH Routing', value: '123456789' },
        { label: 'Wire Routing', value: '987654321' },
        { label: 'نوع الحساب', value: 'Checking' }
      ]
    },
    { 
      code: 'PLN', name: 'بولندا', flag: '🇵🇱', balance: '0.00',
      details: [
        { label: 'صاحب الحساب', value: fullName },
        { label: 'NRB (محلي)', value: '91 1010 2020 3030 4040 5050' },
        { label: 'SWIFT / BIC', value: 'SAFIPLPL' }
      ]
    },
    { 
      code: 'SEK', name: 'السويد', flag: '🇸🇪', balance: '0.00',
      details: [
        { label: 'صاحب الحساب', value: fullName },
    ...
    { 
      code: 'NOK', name: 'النرويج', flag: '🇳🇴', balance: '0.00',
      details: [
    ...
    { 
      code: 'RON', name: 'رومانيا', flag: '🇷🇴', balance: '0.00',
      details: [
    ...
    { 
      code: 'HUF', name: 'المجر', flag: '🇭🇺', balance: '0.00',
      details: [
        { label: 'رقم الحساب', value: '12345678-87654321' },
        { label: 'اسم البنك', value: 'SafiPay Budapest' }
      ]
    },
    { 
      code: 'CZK', name: 'جمهورية التشيك', flag: '🇨🇿', balance: '0.00',
      details: [
    ...
    { 
      code: 'DKK', name: 'الدنمارك', flag: '🇩🇰', balance: '0.00',
      details: [
  ...
  // --- بيانات 7 هواتف مع واجهة داخلية ---
  const features = [
    { 
      title: "التحويلات العالمية", 
      desc: "إرسال الأموال إلى أفغانستان وأكثر من 150 دولة مع تتبع فوري وبدون رسوم مخفية.",
      icon: <Send />,
      ui: (
        <div className="p-5 space-y-4">
          <div className="bg-zinc-900/80 p-3 rounded-xl border border-white/5">
            <p className="text-[8px] text-zinc-500 uppercase">المبلغ المرسل</p>
            <p className="text-xl font-black text-amber-500">$1,500.00</p>
          </div>
          <div className="space-y-2">
             <div className="flex justify-between text-[10px] font-bold px-1"><span>المستلم</span><span className="text-amber-500">إضافة جديد +</span></div>
          ...
          <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">تأكيد التحويل</button>
        </div>
      )
    },
    { 
      title: "بطاقات فيزا الذهبية", 
      desc: "إنشاء بطاقة افتراضية فوراً أو طلب بطاقات فعلية مطلية بالذهب للاستخدام العالمي.",
      icon: <CardIcon />,
      ui: (
        <div className="p-5 space-y-6">
          ...
          <div className="space-y-2">
             <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">بدون تلامس</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
             <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">الدفع عبر الإنترنت</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
          </div>
        </div>
      )
    },
    { 
      ...
      desc: "بنية مصرفية محلية كاملة في أوروبا وبريطانيا وأمريكا. أرقام IBAN شخصية لك.",
      icon: <Building2 />,
      ui: (
        <div className="p-5 space-y-3">
          <div className="text-[10px] font-black text-zinc-500 uppercase px-1">حساباتي</div>
          {['IBAN اليورو', 'Sort Code بريطانيا', 'Routing الدولار'].map((t, i) => (
          ...
          <button className="w-full border border-dashed border-zinc-700 py-3 rounded-xl text-[8px] text-zinc-500">طلب IBAN جديد</button>
        </div>
      )
    },
    { 
      title: "التحويل الذكي", 
      desc: "تحويل فوري للعملات بأسعار مؤسسية لحظية وبدون عمولة مخفية.",
      icon: <RefreshCcw />,
      ui: (
        <div className="p-5 space-y-8 text-center">
          <div className="bg-zinc-900 p-4 rounded-2xl">
             <p className="text-[8px] text-zinc-500 uppercase">من اليورو</p>
          ...
          <div className="bg-zinc-900 p-4 rounded-2xl">
             <p className="text-[8px] text-zinc-500 uppercase">إلى الدولار</p>
    ...
    { 
      title: "شحن الهاتف", 
      desc: "شحن فوري لأكثر من 700 مشغل عالمي، بما في ذلك AWCC وRoshan وEtisalat.",
      icon: <SmartphoneNfc />,
      ui: (
        <div className="p-5 space-y-4">
          <div className="bg-zinc-900 p-3 rounded-xl border border-white/5">
             <input placeholder="أدخل رقم الهاتف" className="bg-transparent text-[10px] w-full outline-none" />
          </div>
          ...
          <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">اشحن الآن</button>
        </div>
      )
    },
    { 
      title: "فواتير الخدمات", 
      desc: "دفع فواتير الخدمات الدولية واشتراكات Starlink مباشرة من محفظتك.",
      icon: <Wifi />,
      ui: (
        <div className="p-5 space-y-3">
          <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
             ...
             <p className="text-[10px] font-black italic">كهرباء كابل</p>
          </div>
          <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
             <div className="flex justify-between items-center"><div className="w-8 h-8 bg-zinc-800 rounded-lg" /><div className="w-12 h-4 bg-zinc-800 rounded-full" /></div>
             <p className="text-[10px] font-black italic">إنترنت Starlink</p>
          </div>
        </div>
      )
    },
    { 
      ...
      desc: "تابع وضعك المالي عبر رسوم ذكية مدعومة بالذكاء الاصطناعي وسجل معاملات لحظي.",
      icon: <TrendingUp />,
      ui: (
        <div className="p-5 space-y-6">
          ...
          <div className="space-y-3">
             <div className="text-[8px] font-black text-zinc-600 uppercase">النشاط الأخير</div>
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <div className="relative group">
            ...
            <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-black ring-2 ring-amber-500/30">
              {user?.user_metadata?.avatar_url ? (
                <Image src={user.user_metadata.avatar_url} alt="الملف الشخصي" fill className="object-cover" />
              ) : (
          ...
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
               <span className="px-3 py-1 bg-amber-500/10 border border-amber-500/20 text-amber-500 text-[9px] font-black uppercase rounded-full tracking-widest">مدير تنفيذي VIP</span>
               <span className="px-3 py-1 bg-green-500/10 border border-green-500/20 text-green-500 text-[9px] font-black uppercase rounded-full tracking-widest italic flex items-center gap-1"><ShieldCheck size={10} /> آمن بالكامل</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter mb-2">
              {user?.user_metadata?.first_name || 'المستخدم'} <span className="text-amber-500">{user?.user_metadata?.last_name || ''}</span>
            </h1>
            <p className="text-zinc-500 text-xs font-bold uppercase tracking-[0.4em]">مرحباً بك في SafiPay International</p>
          </div>
        ...
        <section className="mb-40">
           <h2 className="text-xs font-black uppercase tracking-[0.5em] text-zinc-600 mb-10 flex items-center gap-4">
             <Wallet className="text-amber-500" size={16} /> الأصول المالية العالمية (10 حسابات)
           </h2>
        ...
        {/* --- 7 أقسام مميزات بزوايا ثلاثية الأبعاد مثالية --- */}
        <section className="space-y-60">
           {features.map((feat, idx) => (
             <div key={idx} className={`flex flex-col ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-20 lg:gap-40`}>
                ...
                {/* أضفنا منظوراً للحاوية الخارجية لخلق مساحة ثلاثية الأبعاد */}
                <div style={{ perspective: '2000px' }} className="flex justify-center items-center"> 
                  <motion.div 
                    initial={{ 
                      opacity: 0, 
                      x: idx % 2 === 0 ? -100 : 100,
                      rotateY: idx % 2 === 0 ? 30 : -30 // الزاوية الأولية
                    }} 
                    whileInView={{ 
                      opacity: 1, 
                      x: 0,
                      rotateY: idx % 2 === 0 ? 15 : -15 // الزاوية النهائية الناعمة
                    }} 
                    viewport={{ once: true, margin: "-100px" }}
                    transition={{ duration: 1.2, ease: "easeOut" }}
                    style={{ transformStyle: 'preserve-3d' }} // مهم جداً: هذا يسمح للعناصر الداخلية بالبقاء ثلاثية الأبعاد
                  ...
                  >
                    ...
                    {/* أعطينا حاوية المحتوى أيضاً نمطاً ثلاثي الأبعاد */}
                    <div 
                      style={{ transformStyle: 'preserve-3d', transform: 'translateZ(1px)' }} // قدمنا المحتوى 1 بكسل للأمام
                    ...
                    <div 
                      style={{ transform: 'translateZ(2px)' }} // قدمنا طبقة اللمعان أكثر إلى الأمام
                ...
                {/* Description Content (بدون تغيير) */}
                <motion.div 
              ...
              >
                <div className="flex justify-between items-center mb-12">
                  <div className="flex items-center gap-6">
                    ...
                    <h3 className="text-4xl font-black italic uppercase tracking-tighter">{selectedCurrency.code} <span className="text-zinc-600">الأصول</span></h3>
                  </div>
                ...
                <div className="mt-10 p-6 bg-amber-500/5 border border-amber-500/20 rounded-3xl text-center">
                   <p className="text-[10px] text-amber-500 font-black uppercase tracking-widest">دليل التحويل العالمي</p>
                   <p className="text-[11px] text-zinc-500 mt-2">استخدم هذه التفاصيل البنكية المحلية لاستلام الأموال مباشرة في محفظة SafiPay الخاصة بك. التحويلات ضمن شبكة SEPA/Faster Payments فورية.</p>
                </div>
              </motion.div>
            </div>
          )}
