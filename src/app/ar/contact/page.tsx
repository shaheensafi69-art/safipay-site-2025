...
export default function ContactPageAR() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    // فرم به Formspree متصل است، این تابع فقط برای نمایش پیام موفقیت است
    setSubmitted(true);
    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans selection:bg-amber-500/30 overflow-x-hidden" dir="rtl">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            تواصل <span className="bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">معنا</span>
          </motion.h1>
          ...
          >
            لديك استفسارات حول مستقبل الصيرفة الرقمية؟ 
            فريق SafiPay التنفيذي هنا لإرشادك في رحلتك المالية.
          </motion.p>
        </div>
      </section>
      ...
      <section className="pb-32 container mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-12 gap-12 items-stretch">
          ...
          {/* قنوات الاتصال والشبكات الاجتماعية */}
          <motion.div 
          ...
          >
            <div className="p-8 md:p-10 bg-white/5 border border-white/10 rounded-[2.5rem] h-full space-y-10">
              <div className="space-y-2">
                <h2 className="text-3xl font-black text-white uppercase tracking-tight">القنوات الرسمية</h2>
              ...
              <div className="space-y-4">
                {[
                  { icon: <MessageSquare />, title: "واتساب الرسمي", value: "+44 7476 620282", link: "https://wa.me/447476620282", color: "hover:text-green-400" },
                  { icon: <Phone />, title: "خط الدعم الساخن", value: "+44 7476 620282", link: "tel:+447476620282", color: "hover:text-amber-400" },
                  { icon: <Mail />, title: "البريد الإلكتروني", value: "safipay@hotmail.com", link: "mailto:safipay@hotmail.com", color: "hover:text-blue-400" },
                ].map((item, index) => (
                  <motion.a
                    key={index}
                    href={item.link}
              ...
              <div className="space-y-4">
                <h4 className="text-[10px] text-gray-500 font-black uppercase tracking-[0.2em] mr-2">تابعنا على</h4>
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { icon: <Facebook size={20} />, name: "فيسبوك", link: "https://www.facebook.com/share/1FDnCCnwJ4/" },
                    { icon: <Instagram size={20} />, name: "إنستغرام", link: "https://www.instagram.com/safipay2022?igsh=ZW9tdHRidHI1d2gz" },
                    { icon: <Linkedin size={20} />, name: "لينكد إن", link: "https://www.linkedin.com/company/safipay" },
                    { icon: <Twitter size={20} />, name: "إكس (تويتر)", link: "https://x.com/safipay" },
                  ].map((social, idx) => (
                    <a 
                      key={idx} 
                      href={social.link} 
              ...
              <div className="pt-6 border-t border-white/5">
                <div className="flex items-center gap-4 text-amber-500/80 mb-4">
                  <ShieldCheck size={20} />
                  <span className="text-xs font-bold uppercase tracking-widest">خصوصية مضمونة</span>
                </div>
                <p className="text-sm text-gray-500 leading-relaxed font-light">
                  وصول مباشر ومشفر إلى بروتوكولات الإدارة لدينا.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="h-full bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden text-right">
              ...
              <h3 className="text-3xl font-black mb-10 tracking-tight uppercase">استفسار مباشر</h3>
              ...
              >
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-gray-400 mr-1 uppercase tracking-widest block">الاسم الكامل</label>
                    <input
                      type="text"
                      name="name"
                      required
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-gray-400 mr-1 uppercase tracking-widest block">البريد الإلكتروني</label>
                    <input
                      type="email"
                      name="email"
                      required
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-gray-400 mr-1 uppercase tracking-widest block">تفاصيل الرسالة</label>
                  <textarea
                    name="message"
                    required
                    rows={5}
                    placeholder="اشرح استفسارك أو مشروعك هنا..."
              ...
              {submitted && (
                ...
                >
                  تم إرسال الاستفسار بنجاح إلى بروتوكولات SafiPay.
                </motion.div>
              )}
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-10 md:gap-20 text-gray-600 font-bold uppercase tracking-widest text-[10px]">
             <div className="flex items-center gap-2 hover:text-amber-500 transition-colors">
               <MapPin size={16} /> باريس، فرنسا
             </div>
             <div className="flex items-center gap-2 hover:text-amber-500 transition-colors">
               <Globe size={16} /> عمليات عالمية
             </div>
             <div className="flex items-center gap-2 hover:text-amber-500 transition-colors">
               <ShieldCheck size={16} /> تشفير AES-256
             </div>
          </div>
        </div>
      </section>
