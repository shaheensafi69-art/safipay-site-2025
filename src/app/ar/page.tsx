    ...
    <div className="bg-[#050505] text-white overflow-x-hidden selection:bg-amber-500/30" dir="rtl">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-32 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-6xl">
          ...
          >
            <span className="bg-gradient-to-b from-white via-white to-gray-500 bg-clip-text text-transparent italic">سافي بي</span>
            <br />
          ...
          >
            تمكين الملايين من خلال أول نظام مصرفي رقمي دولي. 
            بلا قيود، بلا حدود؛ تجربة الأمان والسرعة بمعايير عالمية.
          </motion.p>
          ...
          >
            ...
            >
              استكشاف التحديات <ArrowLeft className="group-hover:-translate-x-1 transition-transform" />
            </Link>
            <Link
            ...
            >
              <Handshake size={24} /> شراكة استراتيجية
            </Link>
          </motion.div>
        </div>
      </section>

      {/* --- قسم الأزمة المصرفية (Problems Section) --- */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center mb-24 text-center">
            ...
            <p className="text-gray-500 text-xl max-w-2xl font-light leading-relaxed">
              الأنظمة المالية الحالية غير فعالة، معزولة، ومتهالكة. 
              الملايين من الأفغان مستبعدون من الاقتصاد الرقمي الحديث.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-7xl mx-auto">
            {[
              { title: '٨٥٪ بلا حسابات', desc: 'غالبية السكان، خاصة النساء وسكان المناطق النائية، يفتقرون إلى الخدمات المصرفية الأساسية.' },
              { title: 'عزلة سويفت', desc: 'انقطاع الاتصال بالشبكات المصرفية العالمية جعل تحويل الأموال مساراً خطيراً وغير رسمي.' },
              { title: 'بطاقات غير صالحة', desc: 'البطاقات المحلية الحالية لا تعمل على المنصات العالمية مثل Amazon أو Netflix أو Google.' },
              { title: '١٥٪ رسوم تحويل', desc: 'الاعتماد على أنظمة "الحوالة" التقليدية يؤدي إلى خسائر مالية فادحة وانعدام الشفافية.' },
              { title: 'تضخم حاد', desc: 'غياب البنية التحتية للاحتفاظ بالعملات المستقرة (الدولار/اليورو) يدمر مدخرات الأسر.' },
              { title: 'غياب الهوية الرقمية', desc: 'فتح حساب بنكي لا يزال يتطلب الحضور الشخصي وإجراءات بيروقراطية معقدة.' },
              { title: 'أمن ضعيف', desc: 'البنية التحتية الأمنية الهشة أدت إلى زيادة مخاطر الاحتيال والتهديدات المالية.' },
              { title: 'اقتصاد غير متصل', desc: 'الشركات المحلية غير قادرة على قبول المدفوعات العالمية، مما يعيق نمو الاقتصاد الوطني.' },
            ].map((problem, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="bg-[#050505] border border-white/5 p-8 rounded-[2rem] hover:border-red-500/30 transition-all group text-right"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-24">
            ...
            <p className="text-gray-400 text-xl font-light italic">
              سافي بي ليس مجرد تطبيق، بل هو جسر لربط أفغانستان بالأسواق المالية العالمية.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {[
              { icon: <Globe />, title: 'وصول عالمي', desc: 'فتح حسابات دولية فورية للأفغان في جميع أنحاء العالم دون الحاجة لزيارة فعلية.' },
              { icon: <CreditCard />, title: 'بطاقات افتراضية', desc: 'إصدار فوري لبطاقات فيزا وماستركارد للتسوق العالمي والاشتراكات عبر الإنترنت.' },
              { icon: <Zap />, title: '١٪ رسوم تحويل', desc: 'بديل ذكي لنظام الحوالة المكلف مع تحويلات سريعة ورخيصة وشفافة تماماً.' },
              { icon: <Shield />, title: 'أمن متقدم', desc: 'تشفير بمعايير البنوك العالمية وتوثيق رقمي لضمان الأمان الكامل للأصول.' },
              { icon: <BarChart3 />, title: 'متعدد العملات', desc: 'الاحتفاظ بالعملات الدولية وتحويلها لحماية رأس المال من تقلبات السوق.' },
              { icon: <CheckCircle2 />, title: 'الامتثال القانوني', desc: 'العمل ضمن إطار القوانين المالية الدولية لضمان استدامة وموثوقية الخدمات.' },
            ].map((item, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -10 }}
                className="group p-10 bg-black/40 border border-white/5 rounded-[2.5rem] hover:border-amber-500/50 transition-all duration-500 shadow-2xl text-right"
              >
          ...
          {/* بطاقة الدعوة النهائية (Final CTA) */}
          <motion.div
          ...
          >
            ...
            >
              انضم إلى شبكة شركائنا <Handshake size={28} />
            </Link>
          </motion.div>
        </div>
      </section>
