...
const problems = [
  ...
  },
  {
    ...
    desc: 'غالباً ما يكون تحويل الأموال عبر الحدود بطيئاً أو مقيّداً أو مكلفاً أو غير موثوق بسبب ضعف الوصول الدولي.',
  },
  {
    title: 'عوائق الدفع عبر الإنترنت',
    desc: 'لا يزال الدفع لأمازون والاستضافة وأدوات SaaS والخدمات السحابية والاشتراكات والإعلانات والمنصات الرقمية صعباً بالنسبة للعديد من المستخدمين.',
  },
  {
    title: 'ارتفاع تكلفة التحويل',
    desc: 'غالباً ما تؤدي القنوات التقليدية وغير الرسمية إلى رسوم إضافية وتأخير غير ضروري وشفافية أقل وتحكم مالي محدود.',
  },
  {
    title: 'مشكلة الحفاظ على قيمة العملة',
    desc: 'يحتاج المستخدمون إلى طرق أكثر أماناً للاحتفاظ بأصولهم بعملات أقوى بدلاً من بقائها في خيار محلي محدود فقط.',
  },
  {
    title: 'إجراءات انضمام بطيئة',
    desc: 'يجب أن يكون فتح الخدمات المالية واستخدامها رقمياً وسريعاً وواضحاً، لكن العديد من الأنظمة ما زالت قديمة وتعتمد على المعاملات الورقية.',
  },
  {
    title: 'ضعف الثقة والأمان',
    desc: 'الشفافية المنخفضة والأنظمة الضعيفة والعمليات غير المنسقة تؤدي إلى زيادة الخوف والارتباك ومخاطر الاحتيال.',
  },
  {
    title: 'قيود في التجارة الرقمية',
    desc: 'لا تستطيع الشركات والمستقلون والفرق العاملة عن بُعد المشاركة بشكل كامل في التجارة الإلكترونية الدولية من دون بنية دفع مناسبة.',
  },
];
...
const solutions = [
  {
    icon: <Landmark />,
    title: 'حسابات دولية',
    desc: 'افتح حسابات دولية احترافية تم تصميمها للنشاط المالي الحقيقي والاستخدام عبر الحدود واحتياجات المستخدمين الحديثة.',
  },
  {
    icon: <Wallet />,
    title: 'أرصدة متعددة العملات',
    desc: 'احتفظ باليورو والدولار والجنيه والزلوتي والكرونة السويدية والكرونة النرويجية والليو الروماني والفورنت المجري والكرونة التشيكية والكرونة الدنماركية في تجربة موحدة.',
  },
  {
    icon: <CreditCard />,
    title: 'بطاقات افتراضية فورية',
    desc: 'احصل على بطاقات افتراضية آمنة بسرعة كبيرة للاشتراكات والتسوق عبر الإنترنت ودفع الخدمات والاستخدام في الأعمال الرقمية.',
  },
  {
    icon: <Banknote />,
    title: 'بطاقات فعلية',
    desc: 'استخدم البطاقات الفعلية لمزيد من المرونة في الدفع، حيث تكون الحاجة إلى قبول البطاقات تتجاوز الاستخدام الرقمي فقط.',
  },
  {
    icon: <Globe />,
    title: 'بيانات مصرفية محلية',
    desc: 'احصل على بيانات مصرفية محلية لتحويلات أكثر سلاسة واستلام المدفوعات والعمليات المالية الدولية.',
  },
  {
    icon: <RefreshCcw />,
    title: 'مرونة في العملات',
    desc: 'قم بإدارة واستخدام العملات الأقوى بسهولة أكبر مع حماية ورؤية أوضح.',
  },
  {
    icon: <Smartphone />,
    title: 'انضمام رقمي',
    desc: 'بدلاً من المعاملات الورقية التقليدية البطيئة، قدّم طلب حسابك وأدره من خلال تجربة رقمية نظيفة.',
  },
  {
    icon: <LockKeyhole />,
    title: 'أمان بمستوى أوروبا',
    desc: 'تساعد معايير الأمان القوية والبنية الرقمية الخاضعة للرقابة في حماية المستخدمين والأرصدة والمعاملات.',
  },
  {
    icon: <Shield />,
    title: 'التركيز على الامتثال والتوافق',
    desc: 'تم بناء هذه المنصة بنهج جاد تجاه العمليات الآمنة والهيكل القانوني وحماية المستخدم والنمو المسؤول.',
  },
];
...
const serviceBlocks = [
  {
    ...
    title: 'استلام المدفوعات العالمية',
    desc: 'مناسب للمستقلين والوكالات والموظفين عن بُعد ومقدمي الخدمات الذين يحتاجون إلى قناة دولية لاستلام الأموال.',
  },
  {
    icon: <Briefcase />,
    title: 'عمليات الدفع التجارية',
    desc: 'يدعم الاشتراكات وتكاليف البرمجيات وأدوات الفرق ومدفوعات التسويق وتكاليف البنية الرقمية.',
  },
  {
    icon: <BarChart3 />,
    title: 'التحكم المالي',
    desc: 'شاهد الأرصدة بوضوح وافصل العملات وأدر أموالك بهيكل أوضح وارتباك أقل.',
  },
  {
    icon: <Sparkles />,
    title: 'تجربة مستخدم حديثة',
    desc: 'تم تصميمه لينقل إحساساً مميزاً بالسرعة والبساطة والثقة من مرحلة الانضمام حتى الاستخدام اليومي.',
  },
];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-32 overflow-hidden z-10">
      ...
      <div className="relative z-10 text-center max-w-6xl pointer-events-none">
        ...
        >
          الهدف بسيط لكنه قوي: مساعدة الأفراد والمستقلين والعائلات والشركات على الوصول إلى الأدوات المالية الدولية بأمان أكبر، والحفاظ على قيمة أصولهم بعملات أقوى، والمشاركة بثقة أكبر في الاقتصاد الرقمي العالمي.
        </motion.p>
        ...
        >
          {['حسابات متعددة العملات', 'بيانات مصرفية محلية', 'بطاقات فيزا فورية', 'مدفوعات دولية', 'اعرف عميلك رقمياً', 'أمان بمستوى أوروبي'].map((item, i) => (
            <motion.span
              key={item}
        ...
        >
          ...
          >
            استكشف SafiPay <ArrowRight className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link
          ...
          >
            <Handshake size={24} /> الانضمام إلى الشراكة
          </Link>
        </motion.div>
      </div>
    </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 text-lg">
              ...
              <p>• للفرق التي تدفع للاشتراكات والبرمجيات والأدوات عبر الإنترنت</p>
              <p>• للطلاب والمهنيين الذين يستخدمون الخدمات الرقمية الدولية</p>
            </div>
          </motion.div>
        </div>
      </div>
...
function CrisisSection() {
  return (
    <section id="problems" className="py-32 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          badge="التحدي الرئيسي"
          title="أزمة"
          highlight="القطاع المصرفي"
          description="تمت إعادة بناء هذا القسم بكود نظيف ومتجاوب. وبدلاً من تخطيط أفقي غير مستقر، تظهر البطاقات الآن صعوداً ضمن شبكة قوية ومميزة مع قراءة أفضل وأداء أفضل على الهاتف."
        />
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-red-400/70 text-xs tracking-[0.25em] uppercase">الحالة {String(i + 1).padStart(2, '0')}</span>
                </div>
  ...
  return (
    <section className="py-32 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          badge="حل SafiPay"
          title="أدوات حديثة من أجل"
          highlight="الوصول العالمي"
          description="تحل SafiPay المشكلات المالية الحقيقية من خلال الحسابات الدولية والعملات الأقوى والانضمام الرقمي والبنية التحتية الآمنة للمدفوعات المصممة للاستخدام اليومي الحقيقي."
        />
    ...
    <section ref={ref} className="py-28 relative z-10 overflow-hidden">
      <div className="container mx-auto px-6">
        <SectionTitle
          badge="معلومات موسعة"
          title="أكثر من مجرد"
          highlight="منصة بطاقات"
          description="يضيف هذا القسم شرحاً أوسع حول ما تقوم به SafiPay فعلياً، حتى تتمكن الصفحة الرئيسية من الوقوف بمفردها ومنح الزائر فهماً أعمق منذ الزيارة الأولى."
        />
    ...
    <section className="py-28 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          ...
          title="مصمم من أجل"
          highlight="المستخدمين الحقيقيين"
          description="تشرح الصفحة الرئيسية الآن بوضوح أين يناسب هذا المنتج حياة الأفراد اليومية والمستقلين والشركات."
        />
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          {[
            {
              title: 'للأفراد',
              text: 'افتح حساباً دولياً واحتفظ بعملات أقوى واستلم الأموال وقم بالمدفوعات عبر الإنترنت بثقة وراحة أكبر.',
            },
            {
              title: 'للمستقلين',
              text: 'استلم الأموال من العملاء الدوليين وادفع للأدوات والمنصات وأدر دخلك المهني بطريقة أكثر احترافية.',
            },
            {
              title: 'للشركات',
              text: 'ادعم الاشتراكات والعمليات الرقمية والخدمات عبر الإنترنت والشراء العالمي والمشاركة الأوسع في التجارة الحديثة.',
            },
          ].map((item, i) => (
            <motion.div
              key={item.title}
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            >
              اعرف المزيد <ArrowRight size={26} />
            </Link>
          </div>
        </motion.div>
      </div>
