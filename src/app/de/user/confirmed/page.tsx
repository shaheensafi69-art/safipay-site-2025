      ...
      <div className="relative w-full max-w-lg text-center">
        ...
        >
          ...
          <h1 className="text-4xl font-black italic uppercase tracking-tighter mb-4">
            Verifizierung <span className="text-amber-500">Abgeschlossen</span>
          </h1>
          
          <p className="text-zinc-400 text-lg mb-10 leading-relaxed font-light">
            Ihre digitale Identität bei SafiPay wurde erfolgreich verifiziert. Sie haben jetzt vollen Zugriff auf unser globales Multi-Währungs-Ökosystem.
          </p>
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-zinc-600">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.2em]">Sicherheit auf institutionellem Niveau</span>
          </div>
        </motion.div>
        
        <p className="mt-10 text-[10px] text-zinc-700 uppercase tracking-[0.4em] font-bold">
          Offizieller Sprecher von SafiPay & Safi TopUp
        </p>
      </div>
    </div>
  );
