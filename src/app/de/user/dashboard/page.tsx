...
export default function FinalEliteDashboard() {
  ...
  const fullName = `${user?.user_metadata?.first_name || ''} ${user?.user_metadata?.last_name || ''}`.trim() || user?.user_metadata?.full_name || 'Benutzer';

  // --- Vollständige Liste von 10 Währungen mit allen erforderlichen Bankdetails ---
  const fullCurrencies = [
    { 
      code: 'EUR', name: 'Europäische Union', flag: '🇪🇺', balance: '0.00',
      details: [
        { label: 'Begünstigter', value: fullName },
    ...
    { 
      code: 'GBP', name: 'Großbritannien', flag: '🇬🇧', balance: '0.00',
      details: [
        { label: 'Kontoinhaber', value: fullName },
        { label: 'Kontonummer', value: '88776655' },
    ...
    { 
      code: 'USD', name: 'Vereinigte Staaten', flag: '🇺🇸', balance: '0.00',
      details: [
        { label: 'Kontoinhaber', value: fullName },
        { label: 'Kontonummer', value: '009876543210' },
        { label: 'ACH Routing', value: '123456789' },
        { label: 'Wire Routing', value: '987654321' },
        { label: 'Kontotyp', value: 'Checking' }
      ]
    },
    { 
      code: 'PLN', name: 'Polen', flag: '🇵🇱', balance: '0.00',
      details: [
        { label: 'Kontoinhaber', value: fullName },
        { label: 'NRB (lokal)', value: '91 1010 2020 3030 4040 5050' },
        { label: 'SWIFT / BIC', value: 'SAFIPLPL' }
      ]
    },
    { 
      code: 'SEK', name: 'Schweden', flag: '🇸🇪', balance: '0.00',
      details: [
        { label: 'Kontoinhaber', value: fullName },
    ...
    { 
      code: 'NOK', name: 'Norwegen', flag: '🇳🇴', balance: '0.00',
      details: [
    ...
    { 
      code: 'RON', name: 'Rumänien', flag: '🇷🇴', balance: '0.00',
      details: [
    ...
    { 
      code: 'HUF', name: 'Ungarn', flag: '🇭🇺', balance: '0.00',
      details: [
        { label: 'Kontonummer', value: '12345678-87654321' },
        { label: 'Bankname', value: 'SafiPay Budapest' }
      ]
    },
    { 
      code: 'CZK', name: 'Tschechische Republik', flag: '🇨🇿', balance: '0.00',
      details: [
    ...
    { 
      code: 'DKK', name: 'Dänemark', flag: '🇩🇰', balance: '0.00',
      details: [
  ...
  // --- Daten von 7 Telefonen mit interner Benutzeroberfläche ---
  const features = [
    { 
      title: "Globale Überweisungen", 
      desc: "Senden Sie Geld nach Afghanistan und in mehr als 150 Länder mit sofortiger Nachverfolgung und ohne versteckte Gebühren.",
      icon: <Send />,
      ui: (
        <div className="p-5 space-y-4">
          <div className="bg-zinc-900/80 p-3 rounded-xl border border-white/5">
            <p className="text-[8px] text-zinc-500 uppercase">Gesendeter Betrag</p>
            <p className="text-xl font-black text-amber-500">$1,500.00</p>
          </div>
          <div className="space-y-2">
             <div className="flex justify-between text-[10px] font-bold px-1"><span>Empfänger</span><span className="text-amber-500">Neu hinzufügen +</span></div>
          ...
          <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">Überweisung bestätigen</button>
        </div>
      )
    },
    { 
      title: "Goldene Visa-Karten", 
      desc: "Erstellen Sie sofort eine virtuelle Karte oder bestellen Sie physische, goldbeschichtete Karten für die weltweite Nutzung.",
      icon: <CardIcon />,
      ui: (
        <div className="p-5 space-y-6">
          ...
          <div className="space-y-2">
             <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">Kontaktlos</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
             <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">Online-Zahlung</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
          </div>
        </div>
      )
    },
    { 
      title: "Bankdetails", 
      desc: "Vollständige lokale Bankinfrastruktur in Europa, Großbritannien und Amerika. Persönliche IBAN-Nummern für Sie.",
      icon: <Building2 />,
      ui: (
        <div className="p-5 space-y-3">
          <div className="text-[10px] font-black text-zinc-500 uppercase px-1">Meine Konten</div>
          {['Euro IBAN', 'Sort Code Großbritannien', 'US-Dollar Routing'].map((t, i) => (
          ...
          <button className="w-full border border-dashed border-zinc-700 py-3 rounded-xl text-[8px] text-zinc-500">Neue IBAN anfordern</button>
        </div>
      )
    },
    { 
      title: "Intelligenter Umtausch", 
      desc: "Sofortiger Währungsumtausch zu institutionellen Echtzeitkursen und ohne versteckte Provision.",
      icon: <RefreshCcw />,
      ui: (
        <div className="p-5 space-y-8 text-center">
          <div className="bg-zinc-900 p-4 rounded-2xl">
             <p className="text-[8px] text-zinc-500 uppercase">Von Euro</p>
          ...
          <div className="bg-zinc-900 p-4 rounded-2xl">
             <p className="text-[8px] text-zinc-500 uppercase">In US-Dollar</p>
    ...
    { 
      ...
      desc: "Sofortige Aufladung für mehr als 700 globale Anbieter, einschließlich AWCC, Roshan und Etisalat.",
      icon: <SmartphoneNfc />,
      ui: (
        <div className="p-5 space-y-4">
          <div className="bg-zinc-900 p-3 rounded-xl border border-white/5">
             <input placeholder="Telefonnummer eingeben" className="bg-transparent text-[10px] w-full outline-none" />
          </div>
          ...
          <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">Jetzt aufladen</button>
        </div>
      )
    },
    { 
      title: "Dienstleistungsrechnungen", 
      desc: "Bezahlen Sie internationale Dienstleistungsrechnungen und Starlink-Abonnements direkt aus Ihrer Wallet.",
      icon: <Wifi />,
      ui: (
        <div className="p-5 space-y-3">
          <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
             ...
             <p className="text-[10px] font-black italic">Kabul Strom</p>
          </div>
          <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
             <div className="flex justify-between items-center"><div className="w-8 h-8 bg-zinc-800 rounded-lg" /><div className="w-12 h-4 bg-zinc-800 rounded-full" /></div>
    ...
    { 
      title: "Finanzanalyse", 
      desc: "Verfolgen Sie Ihre finanzielle Lage mit intelligenten, KI-gestützten Diagrammen und einem Transaktionsprotokoll in Echtzeit.",
      icon: <TrendingUp />,
      ui: (
        <div className="p-5 space-y-6">
          ...
          <div className="space-y-3">
             <div className="text-[8px] font-black text-zinc-600 uppercase">Letzte Aktivität</div>
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-28 pb-32 px-6 font-sans">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <div className="relative group">
            ...
            <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-black ring-2 ring-amber-500/30">
              {user?.user_metadata?.avatar_url ? (
                <Image src={user.user_metadata.avatar_url} alt="Profilbild" fill className="object-cover" />
              ) : (
          ...
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
               <span className="px-3 py-1 bg-amber-500/10 border border-amber-500/20 text-amber-500 text-[9px] font-black uppercase rounded-full tracking-widest">VIP Geschäftsführer</span>
               <span className="px-3 py-1 bg-green-500/10 border border-green-500/20 text-green-500 text-[9px] font-black uppercase rounded-full tracking-widest italic flex items-center gap-1"><ShieldCheck size={10} /> Vollständig sicher</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter mb-2">
              {user?.user_metadata?.first_name || 'Benutzer'} <span className="text-amber-500">{user?.user_metadata?.last_name || ''}</span>
            </h1>
            <p className="text-zinc-500 text-xs font-bold uppercase tracking-[0.4em]">Willkommen bei SafiPay International</p>
          </div>
        ...
        {/* --- 7 Feature-Bereiche mit perfekten 3D-Winkeln --- */}
        <section className="space-y-60">
           {features.map((feat, idx) => (
             <div key={idx} className={`flex flex-col ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-20 lg:gap-40`}>
                ...
                {/* Wir haben der äußeren Box Perspektive hinzugefügt, um einen 3D-Raum zu schaffen */}
                <div style={{ perspective: '2000px' }} className="flex justify-center items-center"> 
                  <motion.div 
                    initial={{ 
                      opacity: 0, 
                      x: idx % 2 === 0 ? -100 : 100,
                      rotateY: idx % 2 === 0 ? 30 : -30 // Anfangswinkel
                    }} 
                    whileInView={{ 
                      opacity: 1, 
                      x: 0,
                      rotateY: idx % 2 === 0 ? 15 : -15 // weicher Endwinkel
                    }} 
                    viewport={{ once: true, margin: "-100px" }}
                    transition={{ duration: 1.2, ease: "easeOut" }}
                    style={{ transformStyle: 'preserve-3d' }} // Sehr wichtig: das erlaubt den inneren Elementen, dreidimensional zu bleiben
                  ...
                  >
                    ...
                    {/* Wir haben dem Inhaltscontainer ebenfalls einen 3D-Stil gegeben */}
                    <div 
                      style={{ transformStyle: 'preserve-3d', transform: 'translateZ(1px)' }} // Wir haben den Inhalt 1 Pixel nach vorne gebracht
                    ...
                    <div 
                      style={{ transform: 'translateZ(2px)' }} // Wir haben die Glanzschicht weiter nach vorne gebracht
                ...
                {/* Description Content (ohne Änderung) */}
                <motion.div 
              ...
              >
                <div className="flex justify-between items-center mb-12">
                  <div className="flex items-center gap-6">
                    ...
                    <h3 className="text-4xl font-black italic uppercase tracking-tighter">{selectedCurrency.code} <span className="text-zinc-600">Vermögenswerte</span></h3>
                  </div>
                ...
                <div className="mt-10 p-6 bg-amber-500/5 border border-amber-500/20 rounded-3xl text-center">
                   <p className="text-[10px] text-amber-500 font-black uppercase tracking-widest">Leitfaden für globale Überweisungen</p>
                   <p className="text-[11px] text-zinc-500 mt-2">Verwenden Sie diese lokalen Bankdaten, um Geld direkt in Ihre SafiPay-Wallet zu empfangen. Überweisungen innerhalb des SEPA-/Faster-Payments-Netzwerks erfolgen sofort.</p>
                </div>
              </motion.div>
            </div>
          )}
