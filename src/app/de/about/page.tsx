    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans" dir="ltr">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden border-b border-amber-900/10">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            Transformation des afghanischen Finanzparadigmas
          </motion.span>
          <motion.h1 
          ...
          >
            Grenzenlose <br /> Bankeninnovation
          </motion.h1>
          <motion.p 
          ...
          >
            SafiPay ist mehr als eine App; es ist eine revolutionäre Infrastruktur, die darauf abzielt, den Zugang zu globalen Finanzsystemen für jeden afghanischen Bürger weltweit zu demokratisieren.
          </motion.p>
        </div>
      </section>
        ...
        <div className="flex flex-col gap-40">
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full text-amber-500 text-xs font-bold uppercase tracking-widest">
                <Star size={14} /> Strategie & Führung
              </div>
              <h2 className="text-5xl font-black italic uppercase tracking-tighter">Shaheen Safi <span className="text-gray-600 text-3xl font-light block mt-2">Gründer & CEO</span></h2>
              <div className="space-y-6 text-gray-300 text-xl leading-relaxed font-light">
                <p>
                  Shaheen Safi (geb. 2003) ist FinTech-Stratege und Hauptarchitekt des SafiPay-Ökosystems. Mit der Vision, die finanzielle Isolation Afghanistans zu beenden, leitet er die Makrostrategie und steuert internationale Partnerschaften mit globalen Bankenführern.
                </p>
                <p>
                  Durch seine Expertise in cloud-nativen Finanztechnologien und modernen europäischen Bankstandards hat Shaheen SafiPay als Afghanistans erste echte Neobank etabliert. Sein Ziel: "Wiederherstellung von Prestige und globaler Kreditwürdigkeit für die afghanische Finanzidentität."
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6">
                <div className="p-6 bg-[#0c0c0c] rounded-2xl border border-white/5 hover:border-amber-500/30 transition-colors text-left">
                  ...
                  <p className="text-sm text-gray-500">Business Modeling und globale Bankpartnerschaften.</p>
                </div>
                <div className="p-6 bg-[#0c0c0c] rounded-2xl border border-white/5 hover:border-amber-500/30 transition-colors text-left">
                  <Target className="text-amber-500 mb-3" />
                  <h4 className="text-white font-bold mb-1">Krisenmanagement</h4>
                  <p className="text-sm text-gray-500">Lösungen für globalen Marktzugang.</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-5xl font-black italic uppercase tracking-tighter">Mujtaba Rahmani <span className="text-gray-600 text-3xl font-light block mt-2">Mitgründer & CTO</span></h2>
              <div className="space-y-6 text-gray-300 text-xl leading-relaxed font-light">
                <p>
                  Mujtaba Rahmani (geb. 2006) ist der CTO und Cyber-Security-Architekt von SafiPay. Er bildet das technologische Rückgrat der Plattform und ist verantwortlich für die absolute Unangreifbarkeit und Skalierbarkeit der Echtzeit-Transaktionssysteme.
                </p>
                <p>
                  Mit seinem Verständnis für skalierbare Softwareentwicklung hat Mujtaba ein System entwickelt, das in Geschwindigkeit und Präzision mit globalen Spitzenbanken konkurriert. Seine Mission ist der Aufbau einer „digitalen Festung“ zum Schutz der Nutzervermögen.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6">
                <div className="p-6 bg-[#0c0c0c] rounded-2xl border border-white/5 hover:border-blue-500/30 transition-colors text-left">
                  ...
                  <p className="text-sm text-gray-500">Backend-Entwicklung & Financial Microservices.</p>
                </div>
                <div className="p-6 bg-[#0c0c0c] rounded-2xl border border-white/5 hover:border-blue-500/30 transition-colors text-left">
                  <Shield className="text-blue-500 mb-3" />
                  <h4 className="text-white font-bold mb-1">Cyber-Sicherheit</h4>
                  <p className="text-sm text-gray-500">Fortschrittliche Verschlüsselungsprotokolle.</p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-32 bg-[#080808] border-y border-white/5">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Absolute Sicherheit", desc: "Einsatz mehrschichtiger Verschlüsselungsprotokolle für maximale Integrität.", icon: <Shield className="text-amber-500" size={32} /> },
              { title: "Globale Konnektivität", desc: "Marktzugang für Afghanistan ohne klassische Zwischenhändler.", icon: <Globe className="text-amber-500" size={32} /> },
              { title: "Permanente Innovation", desc: "Kontinuierliche Weiterentwicklung der Neobanking-Funktionen für die nächste Generation.", icon: <Zap className="text-amber-500" size={32} /> }
            ].map((item, idx) => (
              <motion.div 
                key={idx}
                whileHover={{ y: -10 }}
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <div className="relative z-10">
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 italic uppercase tracking-tighter">Bereit für eine Partnerschaft?</h2>
              <p className="text-white/80 text-xl mb-12 font-light">
                SafiPay sucht finanzielle Eliten und internationale strategische Partner, um die Zukunft neu zu gestalten.
              </p>
              <Link href={`/${currentLang}/partners`} className="inline-flex items-center gap-4 px-12 py-6 bg-white text-black font-black text-xl rounded-2xl hover:bg-gray-100 transition-all transform hover:scale-105">
                Partnerschaft anfragen <ArrowRight />
              </Link>
            </div>
          </motion.div>
        </div>
