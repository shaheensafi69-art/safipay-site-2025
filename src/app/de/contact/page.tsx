  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <p className="truncate text-base md:text-lg font-bold tracking-tight text-white/90">
          {value}
        </p>
      </div>
    </motion.a>
...
export default function ContactPageEN() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-black text-white font-sans selection:bg-amber-500/30" dir="ltr">
      ...
      <section className="relative z-10 overflow-hidden pt-40 pb-24">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            KONTAKTIEREN SIE DIE <span className="bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">NÄCHSTE ÄRA</span>
          </motion.h1>
          ...
          >
            Wenn Sie Fragen zu internationalem digitalem Banking, Partnerschaften, Support oder globalem Finanzzugang haben,
            stehen die Führungskanäle von SafiPay für eine Antwort bereit
          </motion.p>
          ...
          >
            <InfoBadge icon={<Headphones size={14} />} text="Live-Support" />
            <InfoBadge icon={<ShieldCheck size={14} />} text="Sicherer Kontakt" />
            <InfoBadge icon={<BadgeCheck size={14} />} text="Verifizierte Kanäle" />
            <InfoBadge icon={<Sparkles size={14} />} text="Premium-Hilfe" />
          </motion.div>
        </div>
      </section>
            ...
            <div className="h-full rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-9 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="my-8 border-t border-white/6 pt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <SocialCard icon={<Facebook size={20} />} name="Facebook" link="https://www.facebook.com/share/1FDnCCnwJ4/" />
                  <SocialCard icon={<Instagram size={20} />} name="Instagram" link="https://www.instagram.com/safipay2022?igsh=ZW9tdHRidHI1d2gz" />
                  <SocialCard icon={<Linkedin size={20} />} name="LinkedIn" link="https://www.linkedin.com/company/safipay" />
                  <SocialCard icon={<Twitter size={20} />} name="X (Twitter)" link="https://x.com/safipay" />
                </div>
              </div>
              ...
              <div className="rounded-[1.8rem] border border-amber-500/15 bg-gradient-to-br from-amber-500/10 to-transparent p-5">
                ...
                <p className="text-sm leading-7 text-gray-400">
                  Jede Kommunikation erfolgt über offizielle und sichere Kanäle mit einer professionellen und datenschutzorientierten Bearbeitung
                </p>
              </div>
            </div>
          </motion.div>
              ...
              <div className="relative z-10">
                <div className="mb-8">
                  ...
                  <h3 className="text-3xl md:text-4xl font-black uppercase tracking-tight">
                    Senden Sie eine sichere Nachricht
                  </h3>
                </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      placeholder="Beschreiben Sie Ihre Anfrage, Partnerschaftsanfrage, Ihr Support-Problem oder Projektdetails..."
                ...
                {submitted && (
                  ...
                  >
                    Ihre Anfrage wurde erfolgreich an die SafiPay-Kanäle gesendet
                  </motion.div>
                )}
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Standort</p>
                    <p className="mt-2 text-sm font-bold text-white">Paris, Frankreich</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Betrieb</p>
                    <p className="mt-2 text-sm font-bold text-white">Globale Reichweite</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Sicherheit</p>
                    <p className="mt-2 text-sm font-bold text-white">Geschützt mit AES-256</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative z-10 border-t border-white/5 bg-black/20 py-16">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {[
              { icon: <MapPin size={16} />, text: 'Paris, Frankreich' },
              { icon: <Globe size={16} />, text: 'Globale Operationen' },
              { icon: <ShieldCheck size={16} />, text: 'AES-256-Verschlüsselung' },
              { icon: <ArrowUpRight size={16} />, text: 'Schnelle Management-Antwort' },
            ].map((item, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -3 }}
