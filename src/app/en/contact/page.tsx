    ...
    <div className="min-h-screen bg-gray-950 text-white" dir="ltr">
      ...
      <section className="relative py-24 md:py-32 border-b border-amber-900/30 bg-gradient-to-b from-black to-gray-950">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            Have questions, suggestions, or need guidance?
            The SafiPay team is always ready to assist you.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
            ...
            >
              ...
              <form
                ...
                className="space-y-6"
              >
                <input type="hidden" name="_subject" value="New message from SafiPay website" />
