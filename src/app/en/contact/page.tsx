    ...
    <div className="min-h-screen overflow-x-hidden bg-black text-white font-sans selection:bg-amber-500/30" dir="ltr">
      ...
      <section className="relative z-10 overflow-hidden pt-40 pb-24">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            CONTACT THE <span className="bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">NEXT ERA</span>
          </motion.h1>
          ...
          >
            Have questions about international digital banking, partnerships, support, or global financial access
            SafiPay’s executive channels are ready to respond
          </motion.p>
          ...
          >
            ...
            <InfoBadge icon={<ShieldCheck size={14} />} text="Secure Contact" />
            <InfoBadge icon={<BadgeCheck size={14} />} text="Verified Channels" />
            <InfoBadge icon={<Sparkles size={14} />} text="Premium Assistance" />
          </motion.div>
        </div>
      </section>
            ...
            <div className="h-full rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-9 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="rounded-[1.8rem] border border-amber-500/15 bg-gradient-to-br from-amber-500/10 to-transparent p-5">
                ...
                <p className="text-sm leading-7 text-gray-400">
                  All communication is directed through secure official channels with a premium and privacy-first handling process
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative h-full overflow-hidden rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-10 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      placeholder="Describe your inquiry, partnership request, support issue, or project details..."
                ...
                {submitted && (
                  ...
                  >
                    Inquiry sent successfully to SafiPay channels
                  </motion.div>
                )}
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Location</p>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Operations</p>
                    <p className="mt-2 text-sm font-bold text-white">Global Coverage</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Security</p>
                    <p className="mt-2 text-sm font-bold text-white">AES-256 Protected</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {[
              ...
              { icon: <Globe size={16} />, text: 'Global Operations' },
              { icon: <ShieldCheck size={16} />, text: 'AES-256 Encryption' },
              { icon: <ArrowUpRight size={16} />, text: 'Fast Executive Response' },
            ].map((item, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -3 }}
