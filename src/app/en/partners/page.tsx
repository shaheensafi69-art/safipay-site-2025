    ...
    <div className="bg-[#020202] text-white overflow-x-hidden selection:bg-amber-500/30 font-sans" dir="ltr">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity, scale: heroScale }} className="container mx-auto px-6 text-center z-10">
          ...
          <h1 className="text-7xl md:text-[13rem] font-black italic tracking-tighter leading-[0.8] uppercase mb-10">
            LIQUIDITY <br/> <span className="text-amber-500">REDEFINED.</span>
          </h1>
          <p className="max-w-3xl mx-auto text-gray-500 text-2xl font-light italic leading-relaxed">
            A sovereign financial infrastructure engineered for the elite digital economy. 
          ...
          <motion.div animate={{ y: [0, 20, 0] }} transition={{ repeat: Infinity, duration: 2 }} className="mt-24 flex flex-col items-center gap-4">
            <span className="text-[10px] font-black tracking-widest text-gray-600 uppercase">Discover the Empire</span>
      ...
      <section className="py-32 border-y border-white/5 bg-white/[0.01]">
        <div className="container mx-auto px-6 grid md:grid-cols-4 gap-12 text-center">
          {[
            { label: "Execution Time", val: "60s", icon: Zap },
            { label: "Global Reach", val: "150+", icon: Globe },
            { label: "Capital Security", val: "Tier 1", icon: ShieldCheck },
      ...
      <section className="py-60 container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-10">
          <div className="max-w-2xl">
            <h2 className="text-8xl font-black italic uppercase tracking-tighter leading-none mb-8">SafiPay <br/> <span className="text-amber-500">Infrastructure.</span></h2>
            <p className="text-gray-500 text-xl font-light italic leading-relaxed">
              We bypass traditional banking bureaucracy. Our vIBAN technology allows you to hold, receive, and send capital globally under your own legal name.
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          <BentoCard className="lg:col-span-8 group">
            <div className="flex justify-between items-start mb-24">
              ...
              <div className="text-right">
                ...
                <h3 className="text-4xl font-black italic uppercase mt-2">Personal vIBANs</h3>
              </div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {['USD', 'EUR', 'GBP', 'PLN', 'SEK', 'NOK', 'RON', 'HUF', 'CZK', 'DKK'].map((curr) => (
                <div key={curr} className="p-6 bg-white/5 border border-white/5 rounded-2xl text-center group-hover:border-amber-500/20 transition-all">
                  ...
                  <div className="text-[8px] text-gray-600 font-bold uppercase tracking-widest">Local Rail</div>
                </div>
              ))}
            </div>
          </BentoCard>
          ...
          <BentoCard className="lg:col-span-4 bg-amber-500 text-black border-none flex flex-col justify-between group">
            ...
            <div>
              <h4 className="text-6xl font-black italic leading-[0.8] mb-6 uppercase tracking-tighter">60 <br/> SECONDS</h4>
              <p className="font-bold text-sm uppercase opacity-80 italic leading-tight">Instant VISA issuance through our Tier-1 European BIN sponsorship.</p>
            </div>
          </BentoCard>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-32 items-center">
          <div className="space-y-12">
            ...
            <div className="space-y-8">
              {[
                { t: "Estonian EFSA Licensed", d: "Regulated infrastructure ensuring EU-standard capital protection." },
                { t: "PCI DSS Level 1", d: "Highest security level for international payment processing." },
                { t: "Institutional vIBANs", d: "Accounts issued directly by Safi International Capital LTD nodes." }
              ].map((item, i) => (
          ...
          <div className="relative p-12 bg-black border border-white/10 rounded-[4rem] overflow-hidden group">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <h3 className="text-4xl font-black italic uppercase tracking-tighter">Regulated & Verified</h3>
              <p className="text-gray-500 text-lg leading-relaxed italic">
                Our infrastructure is built on transparency. Every transaction is monitored by AI-driven AML systems while maintaining the privacy of our elite clients.
              </p>
              <div className="pt-8 border-t border-white/5 flex gap-8">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-700 mb-2">Registration</p>
                  <p className="font-mono text-xs">UK #17063286</p>
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-700 mb-2">Auth Status</p>
      ...
      <section className="py-60 container mx-auto px-6 overflow-hidden">
        <div className="text-center mb-40">
          <motion.h2 initial={{ scale: 0.8 }} whileInView={{ scale: 1 }} className="text-[10vw] font-black italic uppercase tracking-tighter leading-none mb-10">
            Global <br/> <span className="text-blue-500">Connectivity.</span>
          </motion.h2>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <BentoCard className="aspect-square flex flex-col items-center justify-center border-blue-500/10 hover:border-blue-500/40">
            ...
            <p className="text-gray-500 uppercase text-[10px] font-black tracking-[0.5em]">500+ Direct Carrier Nodes</p>
          </BentoCard>

          <div className="space-y-16">
            <h3 className="text-5xl font-black italic uppercase tracking-tighter leading-tight">Powering <br/> 5 Billion Devices.</h3>
            <p className="text-gray-400 text-2xl font-light italic leading-relaxed">
              From the streets of London to the hubs of Dubai, we provide instant airtime and 5G E-SIM data delivery across 150+ countries.
            </p>
            <div className="grid grid-cols-2 gap-8">
              {[
                { label: "Networks", val: "600+", icon: Layers },
      ...
      <section className="py-40 container mx-auto px-6">
        <div className="bg-white/[0.02] border border-white/10 rounded-[4rem] p-16 overflow-hidden relative">
          <div className="relative z-10">
            <h2 className="text-5xl font-black italic uppercase tracking-tighter mb-20 text-center">Legacy Banks vs. <span className="text-amber-500">Safi Empire</span></h2>
            <div className="grid md:grid-cols-2 gap-20">
              <div className="space-y-10 opacity-40">
                <h4 className="text-2xl font-black italic uppercase border-b border-white/10 pb-4">Traditional Banking</h4>
                {["Weeks for Account Opening", "Hidden FX Fees", "Physical Paperwork", "Limited Virtual Cards"].map(text => (
              ...
              <div className="space-y-10">
                ...
                {["60 Second Issuance", "Institutional FX Rates", "100% Digital KYC", "Unlimited vIBAN Assets"].map(text => (
      ...
      <section className="py-60 container mx-auto px-6">
        <div className="max-w-4xl mx-auto space-y-64">
          {[
            { phase: "01", title: "Genesis", date: "MAR 2026", desc: "Incorporation in London. Tier-1 European Banking API nodes deployment.", icon: <Database /> },
            { phase: "02", title: "Hyper-Link", date: "JUN 2026", desc: "Full scale launch of Safi TopUp. Integration of global E-SIM hubs.", icon: <Wifi /> },
            { phase: "03", title: "Sovereignty", date: "SEP 2026", desc: "SafiPay Mobile App release. Automated instant-KYC activation.", icon: <Smartphone /> },
            { phase: "04", title: "Dominion", date: "2027", desc: "Physical Titanium Card issuance. Private Banking Lounges in London & Dubai.", icon: <Briefcase /> }
          ].map((item, i) => (
      ...
      <footer className="py-60 bg-black border-t border-white/5 text-center relative">
        ...
        <div className="container mx-auto px-6">
          <MagneticElement>
            <h2 className="text-8xl md:text-[12rem] font-black italic uppercase tracking-tighter leading-none mb-20 hover:text-amber-500 transition-colors cursor-pointer">
          ...
          <div className="grid md:grid-cols-4 gap-12 mt-40 text-[10px] font-black uppercase tracking-[0.5em] text-gray-700 border-t border-white/5 pt-20">
            <div>
              <p className="text-amber-500 mb-4">Official Entity</p>
              <p className="text-white">UK Reg No. 17063286</p>
            </div>
            <div>
              <p className="text-amber-500 mb-4">Global HQ</p>
              <p className="text-white">71-75 Shelton St, London</p>
            </div>
            <div>
              <p className="text-amber-500 mb-4">Security</p>
              <p className="text-green-500">Nodes Operational</p>
            </div>
            <div>
              <p className="text-amber-500 mb-4">Founder</p>
              <p className="text-white tracking-[0.1em]">Shaheen Safi</p>
            </div>
          </div>
          <p className="mt-20 text-[8px] tracking-[1.5em] text-gray-800 uppercase">Safi International Capital LTD © 2026 | All Rights Reserved</p>
        </div>
      </footer>
    </div>
  );
