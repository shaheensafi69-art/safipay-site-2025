    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans" dir="ltr">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden border-b border-amber-900/10">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            SafiPay is more than an application; it is a revolutionary infrastructure built to democratize access to international financial systems for every Afghan citizen.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-32 container mx-auto px-6">
        <h2 className="text-center text-4xl font-black mb-24 italic uppercase tracking-widest text-amber-500">The Leadership</h2>
        <div className="flex flex-col gap-40">
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-5xl font-black italic uppercase tracking-tighter">Shaheen Safi <span className="text-gray-600 text-3xl font-light block mt-2">Founder & CEO</span></h2>
              <div className="space-y-6 text-gray-300 text-xl leading-relaxed text-justify font-light">
                <p>
                  Shaheen Safi (born 2003) is a FinTech strategist and the visionary behind the SafiPay ecosystem. With extensive experience in IT management and digital business, he leads the mission to bridge the gap between Afghanistan and the global financial markets.
                </p>
              </div>
              <div className="pt-4">
                <Link 
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-5xl font-black italic uppercase tracking-tighter">Mujtaba Rahmani <span className="text-gray-600 text-3xl font-light block mt-2">Chief Technology Officer</span></h2>
              <div className="space-y-6 text-gray-300 text-xl leading-relaxed text-justify font-light">
                <p>
                  Mujtaba Rahmani (born 2006) is the architect of SafiPay's secure infrastructure. As CTO, he oversees cyber-security protocols and the implementation of scalable blockchain and payment technologies.
                </p>
              </div>
              <div className="pt-4">
                <Link 
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-green-500/10 border border-green-500/20 rounded-full text-green-400 text-xs font-bold uppercase tracking-widest">
                <Banknote size={14} /> Ecosystem Banking
              </div>
              <h2 className="text-5xl font-black italic uppercase tracking-tighter">Sahel Salem <span className="text-gray-600 text-3xl font-light block mt-2">Head of Banking</span></h2>
              <p className="text-gray-300 text-xl font-light leading-relaxed">
                Sahel Salem (born 2007) manages the integration of user accounts and the banking ecosystem within SafiPay, ensuring a seamless interface between digital assets and traditional financial frameworks.
              </p>
              <div className="pt-4">
                <Link 
      ...
      {/* --- NEW SECTION: About SafiPay (The Mission) --- */}
      <section className="py-32 bg-[#080808] border-y border-white/5 relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black italic uppercase mb-6 text-white">The SafiPay Mission</h2>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 text-lg text-gray-300 leading-relaxed font-light">
              <p>
                SafiPay was founded on a simple yet powerful premise: <span className="text-white font-bold">Financial inclusion is a fundamental right.</span> In a region often isolated from the global banking network, we provide the technology that bridges the gap.
              </p>
              <p>
                Our platform isn't just about transactions; it's about building a sustainable financial future. We are engineering a borderless system where Afghan freelancers, entrepreneurs, and families can participate in the global economy without barriers.
              </p>
            </div>
            
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: <Landmark className="text-amber-500" />, title: "Digital Banking", desc: "A full-scale virtual bank account for every user." },
                { icon: <ShieldCheck className="text-green-500" />, title: "Secure Custody", desc: "Top-tier encryption and decentralized security." },
                { icon: <Globe className="text-blue-500" />, title: "Global Access", desc: "Connect with international markets instantly." },
                { icon: <Cpu className="text-purple-500" />, title: "AI Powered", desc: "Smart fraud detection and automated insights." }
              ].map((item, i) => (
      ...
      <section className="py-32 container mx-auto px-6">
        <motion.div className="bg-gradient-to-br from-amber-600 to-amber-900 p-20 rounded-[4rem] text-center">
            <h2 className="text-5xl font-black text-white mb-8 italic uppercase">Partner with SafiPay</h2>
            <p className="text-amber-100/70 mb-12 max-w-2xl mx-auto text-lg">Join us in building the next generation of financial infrastructure for Afghanistan and beyond.</p>
