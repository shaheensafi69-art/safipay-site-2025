          ...
          __html: JSON.stringify([
            {
              ...
              "image": "/shaheen.jpeg",
              "description": "Young Afghan fintech entrepreneur and founder of SafiPay – the first international digital bank for Afghans. Born April 2, 2003 in Kabul, aiming to solve banking problems for millions of Afghans inside and outside the country.",
      ...
      <div className="min-h-screen bg-gray-950 text-white" dir="ltr">
        ...
        <section className="py-24">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start">
              ...
              >
                <p>
                  Shaheen Safi was born on April 2, 2003 in Kabul, Afghanistan. He is a young entrepreneur, developer, and fintech activist who launched the SafiPay project to solve one of the biggest problems of Afghan society – lack of access to modern international banking systems.
                </p>

                <p>
                  From childhood, he had a strong interest in technology and economics. While many of his peers were playing computer games, Shaheen started learning programming, blockchain, payment systems, and fintech.
                </p>

                <p>
                  He is self-taught and has practical experience in developing financial applications, cybersecurity, and payment infrastructure. Shaheen believes that "banking is a human right, not a privilege for those living in developed countries."
                </p>

                <p>
                  In 2025, when he saw that millions of Afghans inside and outside the country still do not have access to Visa cards, dollar accounts, fast money transfers, and online shopping, he decided to build a real solution: SafiPay.
                </p>

                <p>
                  With perseverance and round-the-clock effort, he prepared the initial website and app and launched a fundraising campaign to turn this dream into reality.
                </p>
              </motion.div>
              ...
              >
                <div className="bg-gray-900/70 border border-amber-900/40 rounded-2xl p-8 text-left">
                  ...
                  <ul className="space-y-4 text-lg text-gray-300">
                    ...
                    <li><strong>Current Position:</strong> Founder & CEO of SafiPay</li>
                    <li><strong>Location:</strong> Global (focus on France & Afghanistan)</li>
                  </ul>
                </div>
        ...
        <section className="py-24 bg-black/50 border-t border-b border-amber-900/30">
          <div className="container mx-auto px-6">
            ...
            >
              <p>
                Years ago, when millions of Afghans inside the country lacked modern banking and outside faced sanctions and no access to international accounts, I decided to make a change.
              </p>

              <p>
                I saw people paying 10–15% fees to hawalas and exchangers to send money to their families. I saw young people unable to buy from Amazon, Google Play, App Store, or even Netflix. I saw rural women with no bank accounts at all.
              </p>

              <p>
                This situation was unacceptable to me. I wanted to build a bank that belongs to the Afghan people, without borders, without discrimination, and without traditional limitations.
              </p>

              <p>
                SafiPay was born in 2025. The initial goal was a simple money transfer app, but it quickly grew into a bigger dream: a full digital bank with multi-currency accounts, virtual and physical Visa cards, global online payments, and a secure infrastructure for all Afghans.
              </p>

              <p>
                Today, SafiPay is no longer just an idea; the initial website and app are ready, the technical team is growing, and a fundraising campaign has started to obtain international licenses and complete development.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              >
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  To create a complete digital financial ecosystem for Afghans, where every individual – from the most remote villages to major cities around the world – can have a bank account without restrictions, send and receive money, shop online, and participate in the global economy.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  To provide modern, secure, affordable, and borderless banking services to every Afghan citizen, with full transparency, high security, and universal access – regardless of geographic location or economic status.
                </p>
              </motion.div>
            </div>
          </div>
