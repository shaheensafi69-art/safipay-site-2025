    ...
    <main className="min-h-screen bg-black text-[#d4d4d8] selection:bg-[#D4AF37] selection:text-black font-sans overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-up">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[#D4AF37] text-xs font-bold tracking-[0.5em] uppercase">Future of Connectivity</span>
              </div>
              
              <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight italic">
                Borderless <br />
                <span className="text-[#D4AF37] gold-text-glow">Connectivity</span>
              </h1>
              
              <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl mb-10">
                Experience the evolution of travel. SafiPay E-SIM technology connects you to 200+ countries in less than 60 seconds. No physical cards, no roaming fees, just pure digital power.
              </p>

              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-3 px-6 py-3 bg-[#D4AF37] text-black font-bold rounded-full hover:scale-105 transition-transform cursor-pointer">
      ...
      <section className="py-24 px-6 z-10 relative">
        <div className="container mx-auto">
          <div className="text-center mb-20 animate-fade-up">
            <h2 className="text-4xl md:text-5xl font-black text-white italic mb-6">Global <span className="text-[#D4AF37]">Advantages</span></h2>
            <p className="text-gray-500 max-w-2xl mx-auto italic font-light">Engineered by SafiPay for the elite traveler.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-10 rounded-[2.5rem] group hover:border-[#D4AF37]/50 transition-all duration-500">
              ...
              <h3 className="text-white text-2xl font-bold mb-4">Instant Setup</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Download and activate your global data plan in 60 seconds. Speed is our signature.</p>
            </div>

            {/* Feature 2 */}
            <div className="glass-card p-10 rounded-[2.5rem] group hover:border-[#D4AF37]/50 transition-all duration-500">
              <Globe2 className="text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform" size={40} />
              <h3 className="text-white text-2xl font-bold mb-4">200+ Countries</h3>
              <p className="text-gray-500 text-sm leading-relaxed">From London to Dubai, stay connected with local high-speed 5G networks everywhere you go.</p>
            </div>

            {/* Feature 3 */}
            <div className="glass-card p-10 rounded-[2.5rem] group hover:border-[#D4AF37]/50 transition-all duration-500">
              <ShieldCheck className="text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform" size={40} />
              <h3 className="text-white text-2xl font-bold mb-4">EU Security</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Encrypted connections managed under European privacy standards. Your data stays yours.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="glass-card rounded-[3.5rem] p-8 md:p-16 overflow-hidden relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-5xl font-black text-white italic mb-8">Next-Gen <br /><span className="text-[#D4AF37]">Infrastructure</span></h2>
                
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="bg-[#D4AF37]/10 p-2 rounded-lg"><Smartphone className="text-[#D4AF37]" size={24} /></div>
                    <div>
                      <h4 className="text-white font-bold">Multi-Device Support</h4>
                      <p className="text-gray-500 text-sm">Compatible with all iPhone and Android E-SIM devices.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">Ultra-low latency for seamless streaming and business calls.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-[#D4AF37]/10 p-2 rounded-lg"><BarChart3 className="text-[#D4AF37]" size={24} /></div>
                    <div>
                      <h4 className="text-white font-bold">Real-time Management</h4>
                      <p className="text-gray-500 text-sm">Track your data usage live through the SafiPay dashboard.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="py-32 text-center z-10 relative border-t border-white/5">
        <div className="container mx-auto px-6">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white italic mb-8 tracking-tighter uppercase">Ready for Takeoff?</h2>
          <p className="text-gray-400 mb-12 max-w-lg mx-auto italic">Join thousands of elite travelers who trust SafiPay for their global communication needs.</p>
