      ...
      <section className="relative z-10 overflow-hidden pt-40 pb-24">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            پشتیبانی جهانی ۲۴ ساعته فعال است
          </motion.div>
          ...
          >
            با <span className="bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">نسل بعدی</span> تماس بگیرید
          </motion.h1>
          ...
          >
            اگر درباره بانکداری دیجیتال بین‌المللی، شراکت‌ها، پشتیبانی یا دسترسی مالی جهانی سؤال دارید،
            کانال‌های اجرایی SafiPay آماده پاسخ‌گویی هستند
          </motion.p>
          ...
          >
            <InfoBadge icon={<Headphones size={14} />} text="پشتیبانی زنده" />
            <InfoBadge icon={<ShieldCheck size={14} />} text="تماس امن" />
            <InfoBadge icon={<BadgeCheck size={14} />} text="کانال‌های تأییدشده" />
            <InfoBadge icon={<Sparkles size={14} />} text="پشتیبانی پریمیوم" />
          </motion.div>
        </div>
      </section>
            ...
            <div className="h-full rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-9 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="my-8 border-t border-white/6 pt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <SocialCard icon={<Facebook size={20} />} name="فیسبوک" link="https://www.facebook.com/share/1FDnCCnwJ4/" />
                  <SocialCard icon={<Instagram size={20} />} name="اینستاگرام" link="https://www.instagram.com/safipay2022?igsh=ZW9tdHRidHI1d2gz" />
                  <SocialCard icon={<Linkedin size={20} />} name="لینکدین" link="https://www.linkedin.com/company/safipay" />
                  <SocialCard icon={<Twitter size={20} />} name="ایکس (توییتر)" link="https://x.com/safipay" />
                </div>
              </div>
              ...
              <div className="rounded-[1.8rem] border border-amber-500/15 bg-gradient-to-br from-amber-500/10 to-transparent p-5">
                <div className="mb-3 flex items-center gap-3 text-amber-400">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.24em]">
                    حفظ حریم خصوصی تضمین شده
                  </span>
                </div>
                <p className="text-sm leading-7 text-gray-400">
                  تمام ارتباطات از طریق کانال‌های رسمی و امن با روندی حرفه‌ای و حریم‌خصوصی‌محور انجام می‌شود
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative h-full overflow-hidden rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-10 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <div className="space-y-3 text-right">
                    ...
                    <textarea
                      ...
                      rows={6}
                      dir="rtl"
                      placeholder="سؤال، درخواست شراکت، مشکل پشتیبانی یا جزئیات پروژه خود را توضیح دهید..."
                ...
                {submitted && (
                  ...
                  >
                    درخواست شما با موفقیت به کانال‌های SafiPay ارسال شد
                  </motion.div>
                )}
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4 text-right">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">موقعیت</p>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4 text-right">
                    ...
                    <p className="mt-2 text-sm font-bold text-white">پوشش جهانی</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4 text-right">
                    ...
                    <p className="mt-2 text-sm font-bold text-white">محافظت‌شده با AES-256</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {[
              ...
              { icon: <Globe size={16} />, text: 'عملیات جهانی' },
              { icon: <ShieldCheck size={16} />, text: 'رمزنگاری AES-256' },
              { icon: <ArrowUpRight size={16} />, text: 'پاسخ‌گویی سریع مدیریتی' },
            ].map((item, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -3 }}
