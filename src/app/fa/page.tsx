...
const problems = [
  ...
  },
  {
    ...
    desc: 'انتقال پول فرامرزی اغلب به دلیل دسترسی ضعیف بین‌المللی، کند، محدود، پرهزینه یا نامطمئن است.',
  },
  {
    title: 'موانع پرداخت آنلاین',
    desc: 'پرداخت برای آمازون، هاستینگ، ابزارهای SaaS، خدمات ابری، اشتراک‌ها، تبلیغات و پلتفرم‌های دیجیتال هنوز برای بسیاری از کاربران دشوار است.',
  },
  {
    title: 'هزینه بالای انتقال',
    desc: 'کانال‌های سنتی و غیررسمی اغلب باعث هزینه‌های اضافی، تأخیر غیرضروری، شفافیت کمتر و کنترل مالی محدود می‌شوند.',
  },
  {
    title: 'مشکل حفظ ارزش ارز',
    desc: 'کاربران نیاز دارند دارایی خود را به روش‌های امن‌تر در ارزهای قوی‌تر نگهداری کنند، به‌جای آن‌که فقط در یک گزینه محدود محلی قرار بگیرند.',
  },
  {
    title: 'آن‌بوردینگ کند',
    desc: 'افتتاح و استفاده از خدمات مالی باید دیجیتال، سریع و شفاف باشد، اما بسیاری از سیستم‌ها هنوز قدیمی و وابسته به کاغذبازی هستند.',
  },
  {
    title: 'ضعف در اعتماد و امنیت',
    desc: 'شفافیت پایین، سیستم‌های کم‌کیفیت و فرآیندهای ناهماهنگ باعث افزایش ترس، سردرگمی و ریسک تقلب می‌شوند.',
  },
  {
    title: 'محدودیت در تجارت دیجیتال',
    desc: 'کسب‌وکارها، فریلنسرها و تیم‌های دورکار بدون زیرساخت مناسب پرداخت، نمی‌توانند به‌طور کامل در تجارت الکترونیک بین‌المللی فعالیت کنند.',
  },
];
...
const solutions = [
  {
    ...
    desc: 'حساب‌های حرفه‌ای بین‌المللی باز کنید که برای فعالیت واقعی مالی، استفاده فرامرزی و نیازهای مدرن کاربران ساخته شده‌اند.',
  },
  {
    icon: <Wallet />,
    title: 'موجودی چند ارزی',
    desc: 'یورو، دلار، پوند، زلوتی، کرون سوئد، کرون نروژ، لئوی رومانی، فورینت مجارستان، کرون چک و کرون دانمارک را در یک تجربه یکپارچه نگهداری کنید.',
  },
  {
    icon: <CreditCard />,
    title: 'کارت‌های مجازی فوری',
    desc: 'کارت‌های مجازی امن را خیلی سریع برای اشتراک‌ها، خرید آنلاین، پرداخت خدمات و استفاده در کسب‌وکار دیجیتال دریافت کنید.',
  },
  {
    icon: <Banknote />,
    title: 'کارت‌های فیزیکی',
    desc: 'از کارت‌های فیزیکی برای انعطاف‌پذیری بیشتر در پرداخت استفاده کنید، جایی که پذیرش کارت فراتر از استفاده صرفاً دیجیتال مورد نیاز است.',
  },
  {
    icon: <Globe />,
    title: 'جزئیات بانکی محلی',
    desc: 'برای انتقالات روان‌تر، دریافت پرداخت‌ها و عملیات مالی بین‌المللی، جزئیات بانکی محلی دریافت کنید.',
  },
  {
    icon: <RefreshCcw />,
    title: 'انعطاف‌پذیری ارزی',
    desc: 'ارزهای قوی‌تر را با راحتی، محافظت و دید بهتر مدیریت و استفاده کنید.',
  },
  {
    icon: <Smartphone />,
    title: 'آن‌بوردینگ دیجیتال',
    desc: 'به‌جای کاغذبازی سنتی کند، از طریق یک تجربه دیجیتال تمیز برای حساب خود درخواست بدهید و آن را مدیریت کنید.',
  },
  {
    icon: <LockKeyhole />,
    title: 'امنیت در سطح اروپا',
    desc: 'استانداردهای قوی امنیتی و زیرساخت دیجیتال کنترل‌شده به محافظت از کاربران، موجودی‌ها و تراکنش‌ها کمک می‌کند.',
  },
  {
    icon: <Shield />,
    title: 'تمرکز بر تطبیق و انطباق',
    desc: 'این پلتفرم با رویکردی جدی نسبت به عملیات امن، ساختار حقوقی، حفاظت از کاربر و رشد مسئولانه ساخته شده است.',
  },
];
...
const serviceBlocks = [
  {
    ...
    title: 'دریافت پرداخت‌های جهانی',
    desc: 'مناسب برای فریلنسرها، آژانس‌ها، کارمندان دورکار و ارائه‌دهندگان خدماتی که به یک کانال بین‌المللی برای دریافت پول نیاز دارند.',
  },
  {
    icon: <Briefcase />,
    title: 'عملیات پرداخت تجاری',
    desc: 'از اشتراک‌ها، هزینه‌های نرم‌افزار، ابزارهای تیمی، پرداخت‌های بازاریابی و هزینه‌های زیرساخت دیجیتال پشتیبانی می‌کند.',
  },
  {
    icon: <BarChart3 />,
    title: 'کنترل مالی',
    desc: 'موجودی‌ها را شفاف ببینید، ارزها را جدا نگه دارید و پول خود را با ساختار بیشتر و سردرگمی کمتر مدیریت کنید.',
  },
  {
    icon: <Sparkles />,
    title: 'تجربه کاربری مدرن',
    desc: 'طراحی شده تا از مرحله آن‌بوردینگ تا استفاده روزانه، حس پریمیوم، سرعت، سادگی و اعتماد را منتقل کند.',
  },
];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-32 overflow-hidden z-10">
      ...
      <div className="relative z-10 text-center max-w-6xl pointer-events-none">
        ...
        >
          هدف ساده اما قدرتمند است: کمک به افراد، فریلنسرها، خانواده‌ها و کسب‌وکارها تا با امنیت بیشتر به ابزارهای مالی بین‌المللی دسترسی پیدا کنند، ارزش دارایی خود را در ارزهای قوی‌تر حفظ نمایند، و با اطمینان بیشتر در اقتصاد دیجیتال جهانی مشارکت داشته باشند.
        </motion.p>
        ...
        >
          {['حساب‌های چند ارزی', 'جزئیات بانکی محلی', 'کارت‌های فوری ویزا', 'پرداخت‌های بین‌المللی', 'احراز هویت دیجیتال', 'امنیت در سطح اروپا'].map((item, i) => (
            <motion.span
              key={item}
        ...
        >
          ...
          >
            بررسی SafiPay <ArrowRight className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link
          ...
          >
            <Handshake size={24} /> پیوستن به شراکت
          </Link>
        </motion.div>
      </div>
    </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 text-lg">
              ...
              <p>• تیم‌هایی که برای اشتراک‌ها، نرم‌افزار و ابزارهای آنلاین پرداخت انجام می‌دهند</p>
              <p>• دانشجویان و متخصصانی که از خدمات دیجیتال بین‌المللی استفاده می‌کنند</p>
            </div>
          </motion.div>
        </div>
      </div>
    ...
    <section id="problems" className="py-32 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          ...
          title="بحران"
          highlight="بانکداری"
          description="این بخش با کدنویسی تمیز و ریسپانسیو از نو ساخته شده است. به‌جای یک لایه افقی ناپایدار، کارت‌ها حالا در یک گرید قوی و پریمیوم با خوانایی بهتر و رفتار بهتر در موبایل، رو به بالا انیمیت می‌شوند."
        />
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-red-400/70 text-xs tracking-[0.25em] uppercase">مورد {String(i + 1).padStart(2, '0')}</span>
                </div>
...
function SolutionsSection() {
  return (
    <section className="py-32 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          badge="راهکار SafiPay"
          title="ابزارهای مدرن برای"
          highlight="دسترسی جهانی"
          description="SafiPay از طریق حساب‌های بین‌المللی، ارزهای قوی، آن‌بوردینگ دیجیتال و زیرساخت امن پرداخت که برای استفاده واقعی روزانه ساخته شده، مشکلات مالی واقعی را حل می‌کند."
        />
...
function Services3DSection() {
  ...
  return (
    <section ref={ref} className="py-28 relative z-10 overflow-hidden">
      <div className="container mx-auto px-6">
        <SectionTitle
          badge="اطلاعات گسترده‌تر"
          title="بیش از یک"
          highlight="پلتفرم کارت"
          description="این بخش توضیحات بیشتری درباره کاری که SafiPay واقعاً انجام می‌دهد اضافه می‌کند تا صفحه اصلی بتواند به‌تنهایی کامل باشد و از اولین بازدید، درک عمیق‌تری به بازدیدکنندگان بدهد."
        />
    ...
    <section className="py-28 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          ...
          highlight="کاربران واقعی"
          description="صفحه اصلی حالا توضیح می‌دهد که این محصول در زندگی روزمره افراد، فریلنسرها و کسب‌وکارها دقیقاً کجا کاربرد دارد."
        />
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          {[
            {
              title: 'برای افراد',
              text: 'یک حساب بین‌المللی باز کنید، ارزهای قوی‌تر نگهداری کنید، پول دریافت کنید و با اطمینان و راحتی بیشتر پرداخت آنلاین انجام دهید.',
            },
            {
              title: 'برای فریلنسرها',
              text: 'از مشتریان بین‌المللی پول دریافت کنید، برای ابزارها و پلتفرم‌ها پرداخت انجام دهید و درآمد کاری خود را حرفه‌ای‌تر مدیریت کنید.',
            },
            {
              title: 'برای کسب‌وکارها',
              text: 'از اشتراک‌ها، عملیات دیجیتال، خدمات آنلاین، خرید جهانی و مشارکت گسترده‌تر در تجارت مدرن پشتیبانی کنید.',
            },
          ].map((item, i) => (
            <motion.div
              key={item.title}
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            >
              درخواست شراکت <Handshake size={28} />
            </Link>
            <Link
              href="#about"
            ...
            >
              بیشتر بدانید <ArrowRight size={26} />
            </Link>
          </div>
        </motion.div>
      </div>
