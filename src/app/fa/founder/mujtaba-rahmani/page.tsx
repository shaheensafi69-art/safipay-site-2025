      ...
      <div className="relative z-10">
          ...
          <motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }} className="relative">
            <div className="relative w-64 h-64 md:w-80 md:h-80 z-10">
              ...
              <div className="relative h-full w-full rounded-[4rem] overflow-hidden border-2 border-blue-500/30 p-2 bg-[#050505]">
                <Image src="/mujtaba.jpeg" alt="مجتبی رحمانی" fill className="object-cover rounded-[3.5rem]" priority />
              </div>
            </div>
            ...
            <motion.div style={{ x: moveY, y: moveX, translateZ: 180 }} className="absolute -left-16 top-10">
                <div className="bg-blue-600 text-white p-4 rounded-3xl shadow-2xl font-black italic tracking-widest uppercase">بنیان‌گذار</div>
            </motion.div>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mt-12 px-6">
            <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter text-white uppercase">مجتبی <span className="text-blue-500">رحمانی</span></h1>
            <p className="text-blue-400 font-bold tracking-[0.3em] text-xl mt-4 uppercase">بنیان‌گذار صافی‌پی و متخصص امور اقتصادی</p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-10 text-gray-500 text-sm">
               <span className="flex items-center gap-2" dir="ltr"><MapPin size={16}/> کابل، چهارراهی قمبر، ناحیه ۵</span>
        ...
        <section className="py-20 bg-blue-600/[0.02]">
          <div className="container mx-auto max-w-6xl px-6">
            <h2 className="text-center text-4xl font-black mb-20 italic uppercase">تخصص‌های کلیدی</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4">تحلیل بازار</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">تحلیل تکنیکال پیشرفته، پرایس اکشن، مدیریت نقدینگی و استراتژی‌های معاملاتی فارکس.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <Globe className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">اقتصاد دیجیتال</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">توسعه استراتژیک کسب‌وکارهای آنلاین، مقیاس‌پذیری تجارت الکترونیک و گسترش بازار جهانی.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <PieChart className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">استراتژی مالی</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">تخصیص دارایی، مدیریت ریسک به ریوارد و بهینه‌سازی سیستم‌های مالی دیجیتال.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <Gamepad2 className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">تکنولوژی نسل نو</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">زیرساخت‌های بانکی دیجیتال، مفاهیم بلاک‌چین و سیستم‌های گیمینگ با عملکرد بالا.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 text-right">
            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><Briefcase className="text-blue-500"/> تجربیات حرفه‌ای</h2>
              <div className="space-y-8 border-r-2 border-white/10 pr-8">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-xl font-bold text-white">معامله‌گر تمام‌وقت فارکس</h4>
                  <p className="text-blue-400 text-sm mb-2">مستقل (۲۰۲۱ - اکنون)</p>
                  <p className="text-gray-500 text-sm leading-relaxed">تحلیل بازارهای ارز جهانی و مدیریت سبد دارایی‌های دیجیتال با دقت و انضباط بالا.</p>
                </div>
              </div>
            </div>

            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><GraduationCap className="text-blue-500"/> تحصیلات</h2>
              <div className="space-y-8 border-r-2 border-white/10 pr-8">
                <div className="relative">
                  <div className="absolute -right-[41px] top-2 w-4 h-4 bg-blue-600 rounded-full" />
                  <h4 className="text-xl font-bold text-white">کارشناسی اقتصاد و تجارت آنلاین</h4>
                  <p className="text-blue-400 text-sm font-bold uppercase tracking-widest mt-1">مدرک تخصصی</p>
                  <p className="text-gray-500 text-sm mt-2">مطالعه جامع بازارهای مالی جهانی، استراتژی‌های تجارت دیجیتال و مدل‌سازی اقتصادی.</p>
                </div>
                <div className="pt-6">
                   <h3 className="text-xl font-bold mb-6 flex items-center gap-3 uppercase"><Activity size={20} className="text-blue-500"/> انضباط فیزیکی</h3>
                   <div className="flex flex-wrap gap-4">
                     {['ورزش‌های رزمی MMA', 'دویدن استقامتی', 'گیمینگ حرفه‌ای'].map(item => (
        ...
        <section className="py-20 container mx-auto max-w-4xl px-6 text-center">
            <div className="bg-gradient-to-br from-blue-600/20 to-transparent p-12 rounded-[4rem] border border-blue-500/20 relative overflow-hidden text-right">
                ...
                <h2 className="text-3xl font-black mb-6 italic uppercase text-center">دستاورد‌های کلیدی</h2>
        ...
        <footer className="py-20 text-center">
          ...
          <p className="opacity-30 text-[10px] tracking-[0.4em] uppercase font-black">
            مجتبی رحمانی • بنیان‌گذار صافی‌پی و متخصص اقتصاد • ۲۰۲۶
          </p>
        </footer>
      </div>
    </div>
