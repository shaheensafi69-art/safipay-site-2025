    ...
    <div className="min-h-screen bg-gray-950 text-white" dir="rtl">
      ...
      <section className="relative py-24 md:py-32 border-b border-amber-900/30 bg-gradient-to-b from-black to-gray-950">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-amber-500 block mt-4">ستاسو په ملاتړ جوړوو</span>
          </motion.h1>
          ...
          >
            SafiPay د افغانانو لپاره لومړی نړیوال ډیجیټل بانک دی.
            د بانکي مجوزونو، تخنیکي پراختیا، پرمختللي امنیت او بشپړ پیل لپاره ستاسو ملاتړ ته اړتیا لرو.
          </motion.p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div>
                ...
                <p className="text-xl text-gray-400">راټول شوي</p>
              </div>
              <div>
                <div className="text-5xl font-bold text-amber-400 mb-2">
                  ${goal.toLocaleString()}
              ...
              <div>
                ...
                <p className="text-xl text-gray-400">ملاتړ کوونکي</p>
              </div>
            </div>

            <p className="mt-12 text-lg text-gray-400">
              وروستی تازه کول: {new Date().toLocaleString('ps-AF')}
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">
            ستاسو ملاتړ همدا اوس توپیر رامنځته کوي
          </h2>
          ...
          <div className="text-center mt-16">
            <p className="text-xl md:text-2xl text-gray-300 mb-8">
              ټولې مرستې مستقیم د تخنیکي پراختیا، امنیت، مجوزونو او بشپړ پیل لپاره کارول کیږي.
            </p>

            <p className="text-lg text-gray-400 mb-12">
              هره میاشت بشپړ او شفاف راپور ټولو عزیزو ملاتړو ته وړاندې کیږي.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-t from-amber-950/20 to-transparent">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ستاسو هر ډالر نه یوازې د افغانانو د لومړي ډیجیټل بانک په جوړولو کې مرسته کوي، بلکې د میلیونونو کسانو مالي راتلونکی بدلوي.
          </motion.p>
