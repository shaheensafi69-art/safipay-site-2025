      ...
      <section className="relative z-10 overflow-hidden pt-40 pb-24">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            Assistance mondiale active 24h/24 et 7j/7
          </motion.div>
          ...
          >
            CONTACTEZ LA <span className="bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">NOUVELLE ÈRE</span>
          </motion.h1>
          ...
          >
            Si vous avez des questions sur la banque numérique internationale, les partenariats, le support ou l’accès financier mondial,
            les canaux exécutifs de SafiPay sont prêts à vous répondre
          </motion.p>
          ...
          >
            <InfoBadge icon={<Headphones size={14} />} text="Support en direct" />
            <InfoBadge icon={<ShieldCheck size={14} />} text="Contact sécurisé" />
            <InfoBadge icon={<BadgeCheck size={14} />} text="Canaux vérifiés" />
            <InfoBadge icon={<Sparkles size={14} />} text="Assistance premium" />
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="h-full rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-9 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="space-y-4">
                ...
                <ContactCard
                  icon={<Phone size={22} />}
                  title="Ligne directe du support"
                  value="+44 7476 620282"
              ...
              <div className="rounded-[1.8rem] border border-amber-500/15 bg-gradient-to-br from-amber-500/10 to-transparent p-5">
                ...
                <p className="text-sm leading-7 text-gray-400">
                  Toute communication passe par des canaux officiels et sécurisés avec un traitement professionnel centré sur la confidentialité
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative h-full overflow-hidden rounded-[2.5rem] border border-white/8 bg-white/[0.04] p-7 md:p-10 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      placeholder="Décrivez votre demande, votre proposition de partenariat, votre problème de support ou les détails de votre projet..."
                ...
                {submitted && (
                  ...
                  >
                    Votre demande a été envoyée avec succès aux canaux SafiPay
                  </motion.div>
                )}
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Localisation</p>
                    <p className="mt-2 text-sm font-bold text-white">Paris, France</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Opérations</p>
                    <p className="mt-2 text-sm font-bold text-white">Couverture mondiale</p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-black/25 p-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-500">Sécurité</p>
                    <p className="mt-2 text-sm font-bold text-white">Protégé par AES-256</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative z-10 border-t border-white/5 bg-black/20 py-16">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {[
              { icon: <MapPin size={16} />, text: 'Paris, France' },
              { icon: <Globe size={16} />, text: 'Opérations mondiales' },
              { icon: <ShieldCheck size={16} />, text: 'Chiffrement AES-256' },
              { icon: <ArrowUpRight size={16} />, text: 'Réponse rapide de la direction' },
            ].map((item, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -3 }}
