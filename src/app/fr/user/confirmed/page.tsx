      ...
      <div className="relative w-full max-w-lg text-center">
        ...
        >
          ...
          <h1 className="text-4xl font-black italic uppercase tracking-tighter mb-4">
            Vérification <span className="text-amber-500">terminée</span>
          </h1>
          
          <p className="text-zinc-400 text-lg mb-10 leading-relaxed font-light">
            Votre identité numérique SafiPay a été vérifiée. Vous avez maintenant un accès complet à notre écosystème mondial multidevise.
          </p>
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-zinc-600">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.2em]">Sécurité de niveau institutionnel</span>
          </div>
        </motion.div>
        
        <p className="mt-10 text-[10px] text-zinc-700 uppercase tracking-[0.4em] font-bold">
          Porte-parole officiel de SafiPay & Safi TopUp
        </p>
      </div>
    </div>
  );
