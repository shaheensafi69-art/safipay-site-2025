...
export default function FinalEliteDashboard() {
  ...
  const fullName = `${user?.user_metadata?.first_name || ''} ${user?.user_metadata?.last_name || ''}`.trim() || user?.user_metadata?.full_name || 'Utilisateur';

  // --- Liste complète de 10 devises avec tous les détails bancaires requis ---
  const fullCurrencies = [
    { 
      code: 'EUR', name: 'Union européenne', flag: '🇪🇺', balance: '0.00',
      details: [
        { label: 'Bénéficiaire', value: fullName },
        { label: 'IBAN', value: 'BE96 3633 1234 5678 9012' },
        { label: 'BIC / SWIFT', value: 'SAFIBEBBXXX' },
        { label: 'Banque', value: 'SafiPay Europe SA' }
      ]
    },
    { 
      code: 'GBP', name: 'Grande-Bretagne', flag: '🇬🇧', balance: '0.00',
      details: [
        { label: 'Titulaire du compte', value: fullName },
        { label: 'Numéro de compte', value: '88776655' },
    ...
    { 
      code: 'USD', name: 'États-Unis', flag: '🇺🇸', balance: '0.00',
      details: [
        { label: 'Titulaire du compte', value: fullName },
        { label: 'Numéro de compte', value: '009876543210' },
        { label: 'ACH Routing', value: '123456789' },
        { label: 'Wire Routing', value: '987654321' },
        { label: 'Type de compte', value: 'Checking' }
      ]
    },
    { 
      code: 'PLN', name: 'Pologne', flag: '🇵🇱', balance: '0.00',
      details: [
        { label: 'Titulaire du compte', value: fullName },
    ...
    { 
      code: 'SEK', name: 'Suède', flag: '🇸🇪', balance: '0.00',
      details: [
        { label: 'Titulaire du compte', value: fullName },
    ...
    { 
      code: 'NOK', name: 'Norvège', flag: '🇳🇴', balance: '0.00',
      details: [
    ...
    { 
      code: 'RON', name: 'Roumanie', flag: '🇷🇴', balance: '0.00',
      details: [
    ...
    { 
      code: 'HUF', name: 'Hongrie', flag: '🇭🇺', balance: '0.00',
      details: [
        { label: 'Numéro de compte', value: '12345678-87654321' },
        { label: 'Nom de la banque', value: 'SafiPay Budapest' }
      ]
    },
    { 
      code: 'CZK', name: 'République tchèque', flag: '🇨🇿', balance: '0.00',
      details: [
    ...
    { 
      code: 'DKK', name: 'Danemark', flag: '🇩🇰', balance: '0.00',
      details: [
  ...
  // --- Données de 7 téléphones avec interface utilisateur interne ---
  const features = [
    { 
      title: "Transferts mondiaux", 
      desc: "Envoyez de l'argent vers l'Afghanistan et plus de 150 pays avec un suivi instantané et sans frais cachés.",
      icon: <Send />,
      ui: (
        <div className="p-5 space-y-4">
          <div className="bg-zinc-900/80 p-3 rounded-xl border border-white/5">
            <p className="text-[8px] text-zinc-500 uppercase">Montant envoyé</p>
            <p className="text-xl font-black text-amber-500">$1,500.00</p>
          </div>
          <div className="space-y-2">
             <div className="flex justify-between text-[10px] font-bold px-1"><span>Destinataire</span><span className="text-amber-500">Ajouter nouveau +</span></div>
          ...
          <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">Confirmer le transfert</button>
        </div>
      )
    },
    { 
      title: "Cartes Visa dorées", 
      desc: "Créez immédiatement une carte virtuelle ou commandez des cartes physiques dorées pour une utilisation mondiale.",
      icon: <CardIcon />,
      ui: (
        <div className="p-5 space-y-6">
          ...
          <div className="space-y-2">
             <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">Sans contact</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
             <div className="flex justify-between bg-zinc-900 p-3 rounded-xl items-center"><span className="text-[10px]">Paiement en ligne</span><div className="w-8 h-4 bg-amber-500 rounded-full" /></div>
          </div>
        </div>
      )
    },
    { 
      ...
      desc: "Infrastructure bancaire locale complète en Europe, en Grande-Bretagne et en Amérique. Des numéros IBAN personnels pour vous.",
      icon: <Building2 />,
      ui: (
        <div className="p-5 space-y-3">
          <div className="text-[10px] font-black text-zinc-500 uppercase px-1">Mes comptes</div>
          {['IBAN euro', 'Sort Code Grande-Bretagne', 'Routing dollar américain'].map((t, i) => (
          ...
          <button className="w-full border border-dashed border-zinc-700 py-3 rounded-xl text-[8px] text-zinc-500">Demander un nouvel IBAN</button>
        </div>
      )
    },
    { 
      title: "Échange intelligent", 
      desc: "Échange instantané de devises à des taux institutionnels en temps réel et sans commission cachée.",
      icon: <RefreshCcw />,
      ui: (
        <div className="p-5 space-y-8 text-center">
          <div className="bg-zinc-900 p-4 rounded-2xl">
             <p className="text-[8px] text-zinc-500 uppercase">Depuis l'euro</p>
          ...
          <div className="bg-zinc-900 p-4 rounded-2xl">
             <p className="text-[8px] text-zinc-500 uppercase">Vers le dollar américain</p>
    ...
    { 
      title: "Recharger le téléphone", 
      desc: "Recharge instantanée pour plus de 700 opérateurs mondiaux, y compris AWCC, Roshan et Etisalat.",
      icon: <SmartphoneNfc />,
      ui: (
        <div className="p-5 space-y-4">
          <div className="bg-zinc-900 p-3 rounded-xl border border-white/5">
             <input placeholder="Entrez le numéro de téléphone" className="bg-transparent text-[10px] w-full outline-none" />
          </div>
          ...
          <button className="w-full bg-amber-500 py-3 rounded-xl text-black font-black text-[10px]">Recharger maintenant</button>
        </div>
      )
    },
    { 
      title: "Factures de services", 
      desc: "Payez les factures de services internationales et les abonnements Starlink directement depuis votre portefeuille.",
      icon: <Wifi />,
      ui: (
        <div className="p-5 space-y-3">
          <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
             ...
             <p className="text-[10px] font-black italic">Électricité de Kaboul</p>
          </div>
          <div className="h-24 bg-zinc-900 rounded-2xl p-4 flex flex-col justify-between border border-white/5">
             <div className="flex justify-between items-center"><div className="w-8 h-8 bg-zinc-800 rounded-lg" /><div className="w-12 h-4 bg-zinc-800 rounded-full" /></div>
             <p className="text-[10px] font-black italic">Internet Starlink</p>
          </div>
        </div>
      )
    },
    { 
      ...
      desc: "Suivez votre situation financière grâce à des graphiques intelligents alimentés par l'IA et à un journal des transactions en temps réel.",
      icon: <TrendingUp />,
      ui: (
        <div className="p-5 space-y-6">
          ...
          <div className="space-y-3">
             <div className="text-[8px] font-black text-zinc-600 uppercase">Activité récente</div>
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-28 pb-32 px-6 font-sans">
      <div className="container mx-auto max-w-7xl">
        ...
        {/* --- En-tête de profil mis en avant --- */}
        <motion.div 
        ...
        >
          <div className="relative group">
            ...
            <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-black ring-2 ring-amber-500/30">
              {user?.user_metadata?.avatar_url ? (
                <Image src={user.user_metadata.avatar_url} alt="Photo de profil" fill className="object-cover" />
              ) : (
          ...
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
               <span className="px-3 py-1 bg-amber-500/10 border border-amber-500/20 text-amber-500 text-[9px] font-black uppercase rounded-full tracking-widest">Directeur VIP</span>
               <span className="px-3 py-1 bg-green-500/10 border border-green-500/20 text-green-500 text-[9px] font-black uppercase rounded-full tracking-widest italic flex items-center gap-1"><ShieldCheck size={10} /> Entièrement sécurisé</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter mb-2">
              {user?.user_metadata?.first_name || 'Utilisateur'} <span className="text-amber-500">{user?.user_metadata?.last_name || ''}</span>
            </h1>
            <p className="text-zinc-500 text-xs font-bold uppercase tracking-[0.4em]">Bienvenue chez SafiPay International</p>
          </div>
        ...
        {/* --- 7 sections de fonctionnalités avec des angles 3D parfaits --- */}
        <section className="space-y-60">
           {features.map((feat, idx) => (
             <div key={idx} className={`flex flex-col ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-20 lg:gap-40`}>
                ...
                {/* Conteneur de smartphone 3D */}
                {/* Nous avons ajouté une perspective à la boîte extérieure pour créer un espace 3D */}
                <div style={{ perspective: '2000px' }} className="flex justify-center items-center"> 
                  <motion.div 
                    initial={{ 
                      opacity: 0, 
                      x: idx % 2 === 0 ? -100 : 100,
                      rotateY: idx % 2 === 0 ? 30 : -30 // angle initial
                    }} 
                    whileInView={{ 
                      opacity: 1, 
                      x: 0,
                      rotateY: idx % 2 === 0 ? 15 : -15 // angle final doux
                    }} 
                    viewport={{ once: true, margin: "-100px" }}
                    transition={{ duration: 1.2, ease: "easeOut" }}
                    style={{ transformStyle: 'preserve-3d' }} // Très important : cela permet aux éléments intérieurs de rester en 3D
                  ...
                  >
                    ...
                    {/* Nous avons également donné un style 3D au conteneur de contenu */}
                    <div 
                      style={{ transformStyle: 'preserve-3d', transform: 'translateZ(1px)' }} // Nous avons avancé le contenu de 1 pixel
                    ...
                    <div 
                      style={{ transform: 'translateZ(2px)' }} // Nous avons avancé davantage la couche brillante
                ...
                {/* Description Content (sans changement) */}
                <motion.div 
              ...
              >
                <div className="flex justify-between items-center mb-12">
                  <div className="flex items-center gap-6">
                    ...
                    <h3 className="text-4xl font-black italic uppercase tracking-tighter">{selectedCurrency.code} <span className="text-zinc-600">Avoirs</span></h3>
                  </div>
                ...
                <div className="mt-10 p-6 bg-amber-500/5 border border-amber-500/20 rounded-3xl text-center">
                   <p className="text-[10px] text-amber-500 font-black uppercase tracking-widest">Guide des transferts mondiaux</p>
                   <p className="text-[11px] text-zinc-500 mt-2">Utilisez ces coordonnées bancaires locales pour recevoir de l'argent directement dans votre portefeuille SafiPay. Les transferts au sein du réseau SEPA/Faster Payments sont instantanés.</p>
                </div>
              </motion.div>
            </div>
          )}
