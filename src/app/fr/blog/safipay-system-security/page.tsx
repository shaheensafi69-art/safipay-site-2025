        ...
        <div className="container mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-blue-500 font-bold tracking-widest text-[10px] uppercase">
              Encrypted Core v2.0 — Noyau Chiffré
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed max-w-xl font-light text-left opacity-0 animate-[fadeIn_1s_ease-out_0.3s_forwards]">
              Nous ne sommes pas seulement une banque ; nous sommes une forteresse numérique. Sous le commandement technique de Mujtaba, SafiPay utilise les protocoles standards de l'Union Européenne pour briser les frontières financières.
            </p>
            ...
            <div className="flex justify-end group">
              <div className="relative w-full max-w-md aspect-video rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl shadow-blue-500/10 transition-transform duration-500 group-hover:scale-[1.02]">
                ...
                <div className="absolute bottom-6 left-6 flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-green-400">Matrice de Sécurité Mujtaba Active</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-8 rounded-[2rem] bg-white/[0.03] border border-white/10 backdrop-blur-xl hover:bg-white/[0.06] transition-all duration-300">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 uppercase font-bold">Porte-parole Officiel</p>
                  </div>
                </div>
                <p className="text-md text-gray-400 leading-relaxed mb-6 italic text-left">
                  "Notre sécurité est le pont entre l'isolement et le marché mondial. Mujtaba sécurise le code, tandis que Sahel garantit la conformité internationale."
                </p>
                <div className="flex items-center gap-2 text-blue-500 text-xs font-bold">
                  <CheckCircle2 size={14} className="animate-pulse" /> Vérifié par SafiPay UE
                </div>
              </div>

              <div className="space-y-4">
                <div className="text-[10px] font-bold text-gray-600 uppercase tracking-widest px-4">Couches de Défense Technique</div>
                {['Chiffrement AES-256-GCM', 'Haute Sécurité TLS 1.3', 'Zero-Knowledge Proofs'].map((tech) => (
                  <div 
                    key={tech} 
              ...
              <div className="space-y-24">
                ...
                <div className="space-y-8">
                  <h2 className="text-4xl md:text-5xl font-black italic tracking-tight flex items-center gap-4">
                    <Activity className="text-blue-500" /> MATRICE DE SÉCURITÉ
                  </h2>
                  <p className="text-gray-400 text-lg leading-[2.2] text-justify font-light">
                    À l'ère numérique, la sécurité est la seule monnaie qui compte. Notre directeur de la sécurité technique, Mujtaba, a conçu un système de défense multicouche agissant dans l'ombre. Chaque transaction est auditée par Safi AI, et chaque actif est conservé dans une infrastructure régulée par l'UE que les banques traditionnelles ne peuvent égaler en vitesse ou en fiabilité.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-10">
                    <div className="p-10 rounded-[3rem] bg-gradient-to-br from-blue-600/10 to-transparent border border-blue-500/20 hover:translate-y-[-10px] transition-all duration-300">
                      ...
                      <h3 className="text-xl font-bold mb-4 uppercase italic">Code Inviolable</h3>
                      <p className="text-sm text-gray-400 leading-relaxed">L'équipe de Mujtaba effectue des tests d'intrusion 24h/24 sur chaque nœud du réseau pour garantir un fonctionnement sans faille à 100%.</p>
                    </div>
                    ...
                    <div className="p-10 rounded-[3rem] bg-white/[0.02] border border-white/5 hover:translate-y-[-10px] transition-all duration-300">
                      ...
                      <h3 className="text-xl font-bold mb-4 uppercase italic">Surveillance UE</h3>
                      <p className="text-sm text-gray-500 leading-relaxed">Sahel veille à ce que tous les protocoles soient intégrés aux mandats bancaires SEPA pour une sécurité juridique et une liquidité maximale.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative py-20 border-y border-white/10 group">
                  ...
                  <blockquote className="text-3xl md:text-5xl font-light italic leading-tight text-white relative z-10 text-left">
                    "Nous offrons à chaque Afghan un coffre-fort européen dans sa poche. La vitesse est notre arme, la sécurité est notre armure."
                  </blockquote>
                  <div className="mt-12 flex items-center gap-6 justify-start">
                    ...
                    <p className="text-xl font-bold tracking-widest uppercase">Shahin Safi — Fondateur</p>
                  </div>
                </div>
