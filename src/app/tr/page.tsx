...
const problems = [
  ...
  },
  {
    ...
    desc: 'Sınır ötesi para transferleri zayıf uluslararası erişim nedeniyle çoğu zaman yavaş, kısıtlı, pahalı veya güvensiz oluyor.',
  },
  {
    title: 'Çevrim içi ödeme engelleri',
    desc: 'Amazon, hosting, SaaS araçları, bulut hizmetleri, abonelikler, reklamlar ve dijital platformlar için ödeme yapmak birçok kullanıcı için hâlâ zor.',
  },
  {
    title: 'Yüksek transfer maliyeti',
    desc: 'Geleneksel ve gayriresmî kanallar çoğu zaman ek ücretlere, gereksiz gecikmelere, daha düşük şeffaflığa ve sınırlı finansal kontrole yol açıyor.',
  },
  {
    title: 'Para birimi değerini koruma sorunu',
    desc: 'Kullanıcıların varlıklarını yalnızca sınırlı bir yerel seçenekte tutmak yerine, daha güçlü para birimlerinde daha güvenli yollarla saklamaları gerekiyor.',
  },
  {
    title: 'Yavaş onboarding',
    desc: 'Finansal hizmetlerin açılması ve kullanılması dijital, hızlı ve açık olmalıdır; ancak birçok sistem hâlâ eski ve evrak işlerine bağlıdır.',
  },
  {
    title: 'Güven ve güvenlik zayıflığı',
    desc: 'Düşük şeffaflık, düşük kaliteli sistemler ve uyumsuz süreçler korkuyu, karışıklığı ve dolandırıcılık riskini artırıyor.',
  },
  {
    title: 'Dijital ticarette sınırlamalar',
    desc: 'İşletmeler, freelancerlar ve uzaktan çalışan ekipler uygun ödeme altyapısı olmadan uluslararası e-ticarete tam olarak katılamıyor.',
  },
];
...
const solutions = [
  {
    icon: <Landmark />,
    title: 'Uluslararası hesaplar',
    desc: 'Gerçek finansal faaliyet, sınır ötesi kullanım ve modern kullanıcı ihtiyaçları için tasarlanmış profesyonel uluslararası hesaplar açın.',
  },
  {
    icon: <Wallet />,
    title: 'Çok para birimli bakiyeler',
    desc: 'Euro, dolar, sterlin, zloti, İsveç kronu, Norveç kronu, Romen leyi, Macar forinti, Çek kronu ve Danimarka kronunu tek bir entegre deneyimde tutun.',
  },
  {
    icon: <CreditCard />,
    title: 'Anında sanal kartlar',
    desc: 'Abonelikler, çevrim içi alışveriş, hizmet ödemeleri ve dijital iş kullanımı için çok hızlı şekilde güvenli sanal kartlar alın.',
  },
  {
    icon: <Banknote />,
    title: 'Fiziksel kartlar',
    desc: 'Kart kabulünün sadece dijital kullanımla sınırlı olmadığı yerlerde daha fazla ödeme esnekliği için fiziksel kartlar kullanın.',
  },
  {
    icon: <Globe />,
    title: 'Yerel banka bilgileri',
    desc: 'Daha akıcı transferler, ödeme alımı ve uluslararası finansal operasyonlar için yerel banka bilgileri alın.',
  },
  {
    icon: <RefreshCcw />,
    title: 'Para birimi esnekliği',
    desc: 'Daha güçlü para birimlerini daha fazla kolaylık, koruma ve görünürlükle yönetin ve kullanın.',
  },
  {
    icon: <Smartphone />,
    title: 'Dijital onboarding',
    desc: 'Yavaş geleneksel evrak işleri yerine, temiz bir dijital deneyim üzerinden hesabınıza başvurun ve yönetin.',
  },
  {
    icon: <LockKeyhole />,
    title: 'Avrupa düzeyinde güvenlik',
    desc: 'Güçlü güvenlik standartları ve kontrollü dijital altyapı, kullanıcıları, bakiyeleri ve işlemleri korumaya yardımcı olur.',
  },
  {
    icon: <Shield />,
    title: 'Uyum ve mevzuata odaklanma',
    desc: 'Bu platform, güvenli operasyonlar, hukuki yapı, kullanıcı koruması ve sorumlu büyüme konusunda ciddi bir yaklaşımla inşa edilmiştir.',
  },
];
...
const serviceBlocks = [
  {
    ...
    title: 'Küresel ödemeleri alma',
    desc: 'Uluslararası bir para alma kanalına ihtiyaç duyan freelancerlar, ajanslar, uzaktan çalışanlar ve hizmet sağlayıcılar için uygundur.',
  },
  {
    icon: <Briefcase />,
    title: 'Ticari ödeme operasyonları',
    desc: 'Abonelikleri, yazılım maliyetlerini, ekip araçlarını, pazarlama ödemelerini ve dijital altyapı harcamalarını destekler.',
  },
  {
    icon: <BarChart3 />,
    title: 'Finansal kontrol',
    desc: 'Bakiyeleri net biçimde görün, para birimlerini ayırın ve paranızı daha fazla yapı ve daha az karışıklıkla yönetin.',
  },
  {
    icon: <Sparkles />,
    title: 'Modern kullanıcı deneyimi',
    desc: 'Onboarding aşamasından günlük kullanıma kadar premium his, hız, sadelik ve güven vermek için tasarlanmıştır.',
  },
];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-32 overflow-hidden z-10">
      ...
      <div className="relative z-10 text-center max-w-6xl pointer-events-none">
        ...
        >
          Hedef basit ama güçlü: bireylerin, freelancerların, ailelerin ve işletmelerin uluslararası finans araçlarına daha güvenli şekilde erişmesine, varlıklarının değerini daha güçlü para birimlerinde korumasına ve küresel dijital ekonomiye daha fazla güvenle katılmasına yardımcı olmak.
        </motion.p>
        ...
        >
          {['Çok para birimli hesaplar', 'Yerel banka bilgileri', 'Anında Visa kartları', 'Uluslararası ödemeler', 'Dijital KYC', 'Avrupa düzeyinde güvenlik'].map((item, i) => (
            <motion.span
              key={item}
        ...
        >
          ...
          >
            SafiPay’i keşfet <ArrowRight className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link
          ...
          >
            <Handshake size={24} /> İş ortaklığına katıl
          </Link>
        </motion.div>
      </div>
    </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 text-lg">
              ...
              <p>• Abonelikler, yazılımlar ve çevrim içi araçlar için ödeme yapan ekipler için</p>
              <p>• Uluslararası dijital hizmetleri kullanan öğrenciler ve profesyoneller için</p>
            </div>
          </motion.div>
        </div>
      </div>
    ...
    <section id="problems" className="py-32 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          ...
          title="Bankacılık"
          highlight="krizi"
          description="Bu bölüm temiz ve responsive kodla yeniden inşa edildi. Kararsız yatay bir düzen yerine kartlar artık daha iyi okunabilirlik ve mobilde daha iyi davranış sunan güçlü bir premium grid içinde yukarı doğru animasyonla geliyor."
        />
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-red-400/70 text-xs tracking-[0.25em] uppercase">Durum {String(i + 1).padStart(2, '0')}</span>
                </div>
...
function SolutionsSection() {
  return (
    <section className="py-32 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          badge="SafiPay çözümü"
          title="Küresel erişim için"
          highlight="modern araçlar"
          description="SafiPay; uluslararası hesaplar, daha güçlü para birimleri, dijital onboarding ve günlük gerçek kullanım için oluşturulmuş güvenli ödeme altyapısı sayesinde gerçek finansal sorunları çözüyor."
        />
...
function Services3DSection() {
  ...
  return (
    <section ref={ref} className="py-28 relative z-10 overflow-hidden">
      <div className="container mx-auto px-6">
        <SectionTitle
          badge="Genişletilmiş bilgiler"
          title="Bir kart"
          highlight="platformundan daha fazlası"
          description="Bu bölüm, SafiPay’in gerçekte ne yaptığını daha fazla açıklar; böylece ana sayfa kendi başına yeterli olabilir ve ziyaretçilere ilk ziyaretten itibaren daha derin bir anlayış sunar."
        />
    ...
    <section className="py-28 relative z-10">
      <div className="container mx-auto px-6">
        <SectionTitle
          ...
          title="Gerçek"
          highlight="kullanıcılar için tasarlandı"
          description="Ana sayfa artık bu ürünün bireylerin, freelancerların ve işletmelerin günlük yaşamında tam olarak nereye uyduğunu açıkça anlatıyor."
        />
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          {[
            {
              title: 'Bireyler için',
              text: 'Uluslararası bir hesap açın, daha güçlü para birimleri tutun, para alın ve çevrim içi ödemeleri daha fazla güven ve kolaylıkla yapın.',
            },
            {
              title: 'Freelancerlar için',
              text: 'Uluslararası müşterilerden ödeme alın, araçlar ve platformlar için ödeme yapın ve iş gelirlerinizi daha profesyonel şekilde yönetin.',
            },
            {
              title: 'İşletmeler için',
              text: 'Abonelikleri, dijital operasyonları, çevrim içi hizmetleri, küresel satın alımları ve modern ticarette daha geniş katılımı destekleyin.',
            },
          ].map((item, i) => (
            <motion.div
              key={item.title}
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            >
              İş ortaklığı başvurusu <Handshake size={28} />
            </Link>
            <Link
              href="#about"
            ...
            >
              Daha fazla bilgi <ArrowRight size={26} />
            </Link>
          </div>
        </motion.div>
      </div>
