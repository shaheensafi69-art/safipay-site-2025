        ...
        <div className="container mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-blue-500 font-bold tracking-widest text-[10px] uppercase">
              Encrypted Core v2.0 — Şifreli Çekirdek
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed max-w-xl font-light text-left opacity-0 animate-[fadeIn_1s_ease-out_0.3s_forwards]">
              Biz sadece bir banka değiliz; biz dijital bir kaleyiz. Mujtaba'nın teknik komutası altında SafiPay, finansal sınırları ortadan kaldırmak için AB standart protokollerini kullanır.
            </p>
            ...
            <div className="flex justify-end group">
              <div className="relative w-full max-w-md aspect-video rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl shadow-blue-500/10 transition-transform duration-500 group-hover:scale-[1.02]">
                ...
                <div className="absolute bottom-6 left-6 flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-green-400">Mujtaba Güvenlik Matrisi Aktif</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-8 rounded-[2rem] bg-white/[0.03] border border-white/10 backdrop-blur-xl hover:bg-white/[0.06] transition-all duration-300">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 uppercase font-bold">Resmi Sözcü</p>
                  </div>
                </div>
                <p className="text-md text-gray-400 leading-relaxed mb-6 italic text-left">
                  "Güvenliğimiz, izolasyon ile küresel pazar arasındaki köprüdür. Mujtaba kodu güvence altına alırken, Sahel uluslararası uyumluluğu sağlar."
                </p>
                <div className="flex items-center gap-2 text-blue-500 text-xs font-bold">
                  <CheckCircle2 size={14} className="animate-pulse" /> SafiPay AB Tarafından Doğrulandı
                </div>
              </div>

              <div className="space-y-4">
                <div className="text-[10px] font-bold text-gray-600 uppercase tracking-widest px-4">Teknik Savunma Katmanları</div>
                {['AES-256-GCM Şifreleme', 'TLS 1.3 Yüksek Güvenlik', 'Sıfır Bilgi Kanıtları'].map((tech) => (
                  <div 
                    key={tech} 
              ...
              <div className="space-y-24">
                ...
                <div className="space-y-8">
                  <h2 className="text-4xl md:text-5xl font-black italic tracking-tight flex items-center gap-4">
                    <Activity className="text-blue-500" /> GÜVENLİK MATRİSİ
                  </h2>
                  <p className="text-gray-400 text-lg leading-[2.2] text-justify font-light">
                    Dijital çağda güvenlik, önemli olan tek para birimidir. Teknik Güvenlik Direktörümüz Mujtaba, çok katmanlı bir savunma sistemi tasarladı. Her işlem Safi AI tarafından denetlenir ve her varlık, geleneksel bankaların hız ve güvenlik açısından ulaşamayacağı, AB tarafından düzenlenen bir altyapıda tutulur.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-10">
                    <div className="p-10 rounded-[3rem] bg-gradient-to-br from-blue-600/10 to-transparent border border-blue-500/20 hover:translate-y-[-10px] transition-all duration-300">
                      ...
                      <h3 className="text-xl font-bold mb-4 uppercase italic">Kurşun Geçirmez Kod</h3>
                      <p className="text-sm text-gray-400 leading-relaxed">Mujtaba'nın ekibi, %100 açık içermeyen bir çalışma garantilemek için her ağ düğümünde 7/24 sızma testleri yürütür.</p>
                    </div>
                    ...
                    <div className="p-10 rounded-[3rem] bg-white/[0.02] border border-white/5 hover:translate-y-[-10px] transition-all duration-300">
                      ...
                      <h3 className="text-xl font-bold mb-4 uppercase italic">AB Denetimi</h3>
                      <p className="text-sm text-gray-500 leading-relaxed">Sahel, maksimum yasal güvenlik için tüm protokollerin Avrupa SEPA ve bankacılık yönergeleriyle entegre olmasını sağlar.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative py-20 border-y border-white/10 group">
                  ...
                  <blockquote className="text-3xl md:text-5xl font-light italic leading-tight text-white relative z-10 text-left">
                    "Her Afgan'a cebinde taşıyabileceği bir Avrupa kasası sunuyoruz. Hız silahımız, güvenlik ise zırhımızdır."
                  </blockquote>
                  <div className="mt-12 flex items-center gap-6 justify-start">
                    ...
                    <p className="text-xl font-bold tracking-widest uppercase">Shahin Safi — Kurucu</p>
                  </div>
                </div>
