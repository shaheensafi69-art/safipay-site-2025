...
export default function AboutFounderPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-[#d4d4d8] selection:bg-[#D4AF37] selection:text-black font-sans" dir="ltr">
      ...
      {/* Kurucu çerçevesi och animasyonlar için özel stiller */}
      <style jsx global>{`
        .gold-glow {
      ...
      {/* Hero Section: Logo + Başlık + Kurucu Fotoğrafı */}
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            
            {/* Sol Taraf: Kimlik ve Logo */}
            <div className="reveal-up z-20 order-2 lg:order-1 text-left">
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-[#D4AF37] font-bold tracking-[0.4em] text-xs uppercase">Kurucu Kimliği</span>
              </div>
              ...
              <p className="text-xl md:text-2xl font-light text-gray-400 italic border-l-4 border-[#D4AF37] pl-6 max-w-lg">
                SafiPay'in baş mimarı; yeni nesil dünya vatandaşları için finansal özgürlüğün yeniden tanımı.
              </p>
            </div>

            {/* Sağ Taraf: Tasarım çerçevesinde kurucu fotoğrafı */}
      ...
      {/* Vizyon ve Felsefe Bölümü */}
      <section className="py-32 bg-[#050505]">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-24">
            <Quote className="mx-auto text-[#D4AF37] mb-8 opacity-40" size={60} />
            <h2 className="text-4xl md:text-6xl font-black text-white italic mb-10">Kuruluşun <span className="text-[#D4AF37]">Ötesinde</span></h2>
            <p className="text-xl md:text-2xl text-gray-400 leading-relaxed font-light italic">
              "Amacım hiçbir zaman sadece bir uygulama oluşturmak değildi. Bir köprü inşa etmekti; topluluğumuzu Avrupa'nın finans kalbine, hak ettikleri hız ve güvenlikle bağlayan bir kapı."
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 bg-white/5 border border-white/10 rounded-[2.5rem] hover:border-[#D4AF37]/50 transition-all group">
              ...
              <h4 className="text-white text-2xl font-bold mb-3">Orijinallik</h4>
              <p className="text-gray-500 italic leading-relaxed text-sm">Her işlemde küresel güven ve mutlak şeffaflık temeli üzerine inşa edilmiştir.</p>
            </div>

            <div className="p-10 bg-white/5 border border-white/10 rounded-[2.5rem] hover:border-[#D4AF37]/50 transition-all group">
              <ShieldCheck className="text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform" size={32} />
              <h4 className="text-white text-2xl font-bold mb-3">AB Standartları</h4>
              <p className="text-gray-500 italic leading-relaxed text-sm">Varlıkların güvenliği, Avrupa Birliği yasaları çerçevesinde Mücteba'nın doğrudan gözetimi altındadır.</p>
            </div>

            <div className="p-10 bg-white/5 border border-white/10 rounded-[2.5rem] hover:border-[#D4AF37]/50 transition-all group">
              <Zap className="text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform" size={32} />
              <h4 className="text-white text-2xl font-bold mb-3">Anlık Güç</h4>
              <p className="text-gray-500 italic leading-relaxed text-sm">Finansal araçların 60 saniyeden kısa sürede düzenlenmesi ve geleneksel bürokrasinin tamamen ortadan kaldırılması.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-40 border-t border-white/10 bg-black text-center">
        <div className="container mx-auto px-6">
          <p className="text-[#D4AF37] font-black tracking-[1em] text-[10px] uppercase mb-8 opacity-60">Resmi Portfolyo</p>
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12">
            ...
            <h2 className="text-4xl md:text-6xl font-black italic text-[#D4AF37] uppercase tracking-tighter opacity-80">SafiPay Kurucusu</h2>
          </div>
