      ...
      <div className="relative z-10">
        ...
        <section ref={containerRef} className="relative pt-32 pb-20 flex flex-col items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mt-12 px-6">
            <h1 className="text-7xl md:text-9xl font-black italic tracking-tighter text-white uppercase">Shaheen <span className="text-amber-500">Safi</span></h1>
            <p className="text-amber-500 font-bold tracking-[0.2em] text-xl mt-4 uppercase">SafiPay Kurucusu & IT Uzmanı</p>
        ...
        <section className="py-20 container mx-auto max-w-5xl px-6">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="bg-[#080808] border border-white/5 p-10 md:p-16 rounded-[4rem] shadow-2xl">
            <h2 className="text-4xl font-black mb-10 border-l-8 border-amber-500 pl-6 uppercase">Hakkımda</h2>
            <div className="space-y-8 text-gray-300 text-xl leading-[2.3] text-justify font-light">
              <p>
                Ben Shaheen Safi; bilişim teknolojileri uzmanı, yenilikçi, dinamik ve teknoloji ile online ticaret dünyasına tutkuyla bağlı bir profesyonelim. Bilişim teknolojileri (IT) eğitimi ve yönetimi konusundaki geniş tecrübemle, her zaman yeni projeler geliştirmeye ve öğrenmeye odaklandım.
              </p>
              <p>
                Lisans eğitimimi Bilgisayar Mühendisliği alanında Türkiye'nin köklü kurumlarından <span className="text-white font-bold underline decoration-amber-500">İstanbul Teknik Üniversitesi'nde (İTÜ)</span> tamamladım. Eğitimim süresince yazılım mimarisi, ağ güvenliği ve FinTech sistemleri üzerine yoğunlaştım.
              </p>
              <div className="bg-amber-500/10 p-8 rounded-[2.5rem] italic border-l-8 border-amber-500 text-amber-100">
                "Kariyerimdeki en büyük dönüm noktası, SafiPro markasını kurup başarıyla devretmek ve tüm enerjimi dijital bankacılığı dönüştürmeyi hedefleyen SafiPay sistemini geliştirmeye adamak oldu."
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <section className="py-20 bg-amber-500/[0.02]">
          <div className="container mx-auto max-w-6xl px-6">
            <h2 className="text-center text-4xl font-black mb-20 italic uppercase">Teknik Yetkinlikler</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-amber-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4 uppercase">Programlama</h3>
              ...
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-amber-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4 uppercase">Ağ ve Güvenlik</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono">Routing & Switching, Firewall, VPN, Ağ Güvenliği, Cisco, Mikrotik, Kablosuz Ağlar</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-amber-500/40 transition-all group">
                <Database className="text-amber-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4 uppercase">Veritabanı</h3>
              ...
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-amber-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4 uppercase">Ticaret ve Tasarım</h3>
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12">
            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><Briefcase className="text-amber-500"/> İş Deneyimi</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-xl font-bold text-white">Bilgisayar Bilimleri Eğitmeni</h4>
                  <p className="text-amber-500 text-sm mb-2">Çeşitli Eğitim Merkezleri (2019-2024)</p>
                  <p className="text-gray-500 text-sm">Bilgisayar teknolojileri üzerine profesyonel eğitim ve 3 yıllık akademik deneyim.</p>
                </div>
              </div>
            </div>

            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><GraduationCap className="text-amber-500"/> Eğitim</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                <div className="relative">
                  <div className="absolute -left-[41px] top-2 w-4 h-4 bg-amber-500 rounded-full" />
                  <h4 className="text-xl font-bold text-white">İstanbul Teknik Üniversitesi (İTÜ)</h4>
                  <p className="text-amber-500 text-sm uppercase">Bilgisayar Mühendisliği Lisans (2019-2023)</p>
                </div>
                <div className="relative">
                  <div className="absolute -left-[41px] top-2 w-4 h-4 bg-white/20 rounded-full" />
                  <h4 className="text-xl font-bold text-white">İşletme ve Pazarlama Yönetimi</h4>
                  <p className="text-amber-500 text-sm italic">E-ticaret ve dijital girişimcilik üzerine odaklanmıştır.</p>
                </div>
              </div>
              <div className="pt-10">
                <h3 className="text-xl font-bold mb-6 flex items-center gap-3"><Languages size={20} className="text-amber-500"/> Diller</h3>
                <div className="flex gap-4">
                  {['İngilizce', 'Darice', 'Peştuca', 'Türkçe'].map(lang => (
        ...
        <section className="py-20 container mx-auto max-w-4xl px-6 text-center">
           <div className="bg-gradient-to-br from-amber-500/20 to-transparent p-12 rounded-[4rem] border border-amber-500/20">
              ...
              <h2 className="text-3xl font-black mb-6 uppercase">Ödüller ve Sertifikalar</h2>
              <ul className="text-gray-300 space-y-4 text-lg text-left inline-block">
                <li>• **IFTA** tarafından verilen Uluslararası Teknik Analiz Sertifikası</li>
                <li>• Başarı ve iş dünyası üzerine 20'den fazla seminer organizasyonu</li>
                <li>• **SafiPay** finansal sisteminin mucidi ve kurucusu</li>
              </ul>
           </div>
        </section>
        ...
        <footer className="py-20 text-center">
          ...
          <p className="opacity-30 text-xs tracking-[0.5em] uppercase">
            2026 • SHAHEEN SAFI TEKNİK PORTFOLYO
          </p>
        </footer>
      </div>
    </div>
