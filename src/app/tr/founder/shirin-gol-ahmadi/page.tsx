      ...
      <div className="relative z-10">
        ...
        <section ref={containerRef} className="relative pt-32 pb-20 flex flex-col items-center">
          <motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }} className="relative">
            ...
            <motion.div style={{ x: moveY, y: moveX, translateZ: 180 }} className="absolute -right-16 top-10">
                <div className="bg-pink-500 text-white p-4 rounded-3xl shadow-2xl font-black">YÖNETİCİ</div>
            </motion.div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mt-12 px-6">
            ...
            <p className="text-pink-500 font-bold tracking-[0.3em] text-lg mt-4 uppercase">SafiPay Yöneticisi & Full Stack Geliştirici</p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-10 text-gray-500 text-sm">
               <span className="flex items-center gap-2"><MapPin size={16}/> İslamabad, Pakistan</span>
               <span className="flex items-center gap-2"><User size={16}/> Doğum: 16 Aralık 2004</span>
            </div>
          </motion.div>
        </section>
        ...
        <section className="py-20 container mx-auto max-w-5xl px-6">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="bg-[#080808] border border-white/5 p-10 md:p-16 rounded-[4rem] shadow-2xl">
            <h2 className="text-4xl font-black mb-10 border-l-8 border-pink-500 pl-6">Hakkımda</h2>
            <div className="space-y-8 text-gray-300 text-xl leading-[2.3] text-justify font-light">
              <p>
                Ben Shirin Gol Ahmadi, SafiPay'de Yönetici olarak görev yapan çok disiplinli bir profesyonelim. 16 Aralık 2004 doğumluyum ve her zaman teknolojiye, ekonomiye ve yaratıcı problem çözmeye yönelik bir tutkuyla hareket ettim. Geniş yetenek yelpazem, teknik uygulama ile iş stratejisi arasındaki köprüyü kurmaktadır.
              </p>
              <p>
                Pakistan'ın İslamabad kentindeki <span className="text-white font-bold underline decoration-pink-500">Ulusal Bilim ve Teknoloji Üniversitesi'nden (NUST)</span> Ekonomi derecesiyle mezun oldum. Ekonomideki akademik geçmişimin yanı sıra, bir Full Stack Geliştirici, Yapay Zeka meraklısı ve Grafik Tasarımcı olarak kendimi teknoloji dünyasının derinliklerine adadım.
              </p>
              <div className="bg-pink-500/10 p-8 rounded-[2.5rem] italic border-l-8 border-pink-500 text-pink-100">
                "Nihai hedefim; ekonomik stratejiyi, son teknoloji Yapay Zekayı ve kusursuz tasarımı birleştirerek SafiPay'in küresel dijital finans ekosisteminde öncü bir güç olmasına yardımcı olmaktır."
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <section className="py-20 bg-pink-500/[0.02]">
          <div className="container mx-auto max-w-6xl px-6">
            <h2 className="text-center text-4xl font-black mb-20 italic">Mesleki Uzmanlık</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4">Yönetim & Ekonomi</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono">İş Stratejisi, Operasyon Yönetimi, Ekonomik Analiz, Ekip Liderliği, Çevik (Agile) Metodolojiler</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                ...
                <p className="text-gray-500 text-sm leading-relaxed font-mono">React.js, Next.js, Node.js, JavaScript, TypeScript, Python, HTML/CSS, Tailwind, Veritabanı Yönetimi</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                <PenTool className="text-pink-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Grafik Tasarım</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono">UI/UX Tasarımı, Figma, Adobe Photoshop, Illustrator, Marka Kimliği, Görsel İletişim</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                <Cpu className="text-pink-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Yapay Zeka</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono">İstem Mühendisliği (Prompt Engineering), Yapay Zeka Entegrasyonu, Makine Öğrenimi Konseptleri, İş Akışı Otomasyonu</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12">
            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic"><Briefcase className="text-pink-500"/> İş Deneyimi</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                <div className="relative">
                  ...
                  <h4 className="text-xl font-bold text-white">Yönetici</h4>
                  <p className="text-pink-500 text-sm mb-2">SafiPay Ekosistemi (Günümüz)</p>
                  <p className="text-gray-500 text-sm">Operasyonel yönetime liderlik etme, ekip koordinasyonunu denetleme ve teknolojik çözümleri SafiPay platformunun iş stratejileriyle entegre etme.</p>
                </div>
                <div className="relative">
                  <div className="absolute -left-[41px] top-2 w-4 h-4 bg-white/20 rounded-full" />
                  <h4 className="text-xl font-bold text-white">Full Stack Geliştirici & Tasarımcı</h4>
                  <p className="text-pink-500 text-sm mb-2">Serbest Çalışan & Özel Projeler</p>
                  <p className="text-gray-500 text-sm">Uçtan uca web uygulamaları geliştirme, görsel olarak çekici marka kimlikleri ve UI/UX tasarımları oluşturma.</p>
                </div>
              </div>
            </div>

            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic"><GraduationCap className="text-pink-500"/> Eğitim</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                <div className="relative">
                  <div className="absolute -left-[41px] top-2 w-4 h-4 bg-pink-500 rounded-full" />
                  <h4 className="text-xl font-bold text-white">Ulusal Bilim ve Teknoloji Üniversitesi (NUST)</h4>
                  <p className="text-pink-500 text-sm">İslamabad, Pakistan</p>
                  <p className="text-gray-500 text-sm mt-1">Ekonomi Lisans Derecesi. Ekonomik strateji ve finansal yönetim alanında güçlü bir temelle mezun olmuştur.</p>
                </div>
                <div className="relative">
                  <div className="absolute -left-[41px] top-2 w-4 h-4 bg-white/20 rounded-full" />
                  <h4 className="text-xl font-bold text-white">Teknoloji & Tasarım Sertifikaları</h4>
                  <p className="text-pink-500 text-sm italic">Yapay Zeka, Full Stack Geliştirme ve Grafik Tasarım alanlarında ileri düzey çalışmalar.</p>
                </div>
              </div>
              <div className="pt-10">
                <h3 className="text-xl font-bold mb-6 flex items-center gap-3"><Languages size={20} className="text-pink-500"/> Dil Yeterliliği</h3>
                <div className="flex flex-wrap gap-4">
                  {['İngilizce', 'Darice', 'Peştuca', 'Urduca'].map(lang => (
        ...
        <section className="py-20 container mx-auto max-w-4xl px-6 text-center">
           <div className="bg-gradient-to-br from-pink-500/20 to-transparent p-12 rounded-[4rem] border border-pink-500/20">
              ...
              <h2 className="text-3xl font-black mb-6">Temel Yetkinlikler</h2>
              <ul className="text-gray-300 space-y-4 text-lg text-left inline-block">
                <li>• **Ekonomi** ile **Dijital Teknolojiyi** birleştirmede uzmanlık</li>
                <li>• Modern **Yapay Zeka araçları** ve İstem Mühendisliğinde yetkinlik</li>
                <li>• SafiPay ekosistemi içerisinde **Yönetimsel liderlik**</li>
                <li>• Eksiksiz web platformları tasarlama ve kodlama konusunda yaratıcı yetenek</li>
              </ul>
           </div>
        </section>
        ...
        <footer className="py-20 text-center">
          ...
          <p className="opacity-30 text-xs tracking-[0.5em] uppercase">
            Shirin Gol Ahmadi • Teknik & Yönetim Portföyü • 2026
          </p>
        </footer>
      </div>
    </div>
