      ...
      <div className="relative z-10">
        ...
        <section ref={containerRef} className="relative pt-32 pb-20 flex flex-col items-center">
          <motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }} className="relative">
            ...
            <motion.div style={{ x: moveY, y: moveX, translateZ: 180 }} className="absolute -right-16 top-10">
                <div className="bg-blue-600 text-white p-4 rounded-3xl shadow-2xl font-black italic tracking-widest uppercase">Kurucu Ortak</div>
            </motion.div>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mt-12 px-6">
            <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter text-white uppercase">MUJTABA <span className="text-blue-500">RAHMANI</span></h1>
            <p className="text-blue-400 font-bold tracking-[0.3em] text-xl mt-4 uppercase">SafiPay Kurucusu ve Ekonomi Uzmanı</p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-10 text-gray-500 text-sm">
               <span className="flex items-center gap-2"><MapPin size={16}/> 5. Bölge, Kambar Kavşağı, Kabil</span>
        ...
        <section className="py-20 bg-blue-600/[0.02]">
          <div className="container mx-auto max-w-6xl px-6">
            <h2 className="text-center text-4xl font-black mb-20 italic uppercase">Temel Uzmanlıklar</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4">Pazar Analizi</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">İleri düzey teknik analiz, Price Action, likidite yönetimi ve Forex işlem stratejileri.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <Globe className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Dijital Ekonomi</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">Online iş geliştirme stratejileri, e-ticaret ölçeklendirme ve küresel pazar genişlemesi.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <PieChart className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Finansal Strateji</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">Varlık tahsisi, Risk-Getiri (Risk-to-Reward) yönetimi ve FinTech sistem optimizasyonu.</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-blue-500/40 transition-all group">
                <Gamepad2 className="text-blue-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">Yeni Nesil Teknoloji</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono italic">Dijital bankacılık altyapıları, blokzinciri kavramları ve yüksek performanslı oyun sistemleri.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12">
            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><Briefcase className="text-blue-500"/> MESLEKİ DENEYİM</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-xl font-bold text-white">Bağımsız Forex Yatırımcısı</h4>
                  <p className="text-blue-400 text-sm mb-2">Freelance (2021 - Günümüz)</p>
                  <p className="text-gray-500 text-sm leading-relaxed text-justify">Küresel döviz piyasalarının analizi ve dijital varlıkların yüksek disiplinle yönetimi.</p>
                </div>
              </div>
            </div>

            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic uppercase"><GraduationCap className="text-blue-500"/> EĞİTİM</h2>
              <div className="space-y-8 border-l-2 border-white/10 pl-8">
                <div className="relative">
                  <div className="absolute -left-[41px] top-2 w-4 h-4 bg-blue-600 rounded-full" />
                  <h4 className="text-xl font-bold text-white">Ekonomi ve Online Ticaret Lisansı</h4>
                  <p className="text-blue-400 text-sm font-bold uppercase tracking-widest mt-1">Uzmanlık Sertifikası</p>
                  <p className="text-gray-500 text-sm mt-2">Küresel finans piyasaları üzerine kapsamlı çalışmalar, dijital ticaret stratejileri ve ekonomik modelleme.</p>
                </div>
                <div className="pt-6">
                   <h3 className="text-xl font-bold mb-6 flex items-center gap-3 uppercase"><Activity size={20} className="text-blue-500"/> FİZİKSEL DİSİPLİN</h3>
                   <div className="flex flex-wrap gap-4">
                     {['MMA Sporları', 'Dayanıklılık Koşusu', 'Profesyonel Gaming'].map(item => (
        ...
        <section className="py-20 container mx-auto max-w-4xl px-6 text-center">
            <div className="bg-gradient-to-br from-blue-600/20 to-transparent p-12 rounded-[4rem] border border-blue-500/20 relative overflow-hidden">
                ...
                <h2 className="text-3xl font-black mb-6 italic uppercase">Önemli Başarılar</h2>
        ...
        <footer className="py-20 text-center">
          ...
          <p className="opacity-30 text-[10px] tracking-[0.4em] uppercase font-black">
            Mujtaba Rahmani • SafiPay Kurucusu ve Ekonomi Uzmanı • 2026
          </p>
        </footer>
      </div>
    </div>
