...
export default function VisaCardGuidePage() {
  ...
  // د ژبې تنظیمات د پارامتر پر بنسټ یا په اتوماتیک ډول پښتو
  const lang = params?.lang || 'ps';
  const isRtl = lang === 'ar' || lang === 'fa' || lang === 'ps';

  const content = {
    ps: {
      category: "ستراتیژیک لارښود او تحلیل",
      title: "د SafiPay مجازی ویزا کارت؛",
      subtitle: "په افغانستان کې د مالي تجرید پای",
      author: "Safi AI",
      role: "د SafiPay رسمي ویاند",
      readTime: "۱۵ دقیقې لوستل",
      intro: "په افغانستان کې ډېری کورني بانکونه داسې کارتونه ورکوي چې یوازې د هیواد په دننه کې د کارولو وړ وي. SafiPay دا محدودیتونه مات کړل. موږ داسې کارتونه صادروو چې د اروپا په زړه، متحده ایالاتو او ټولو نړیوالو ویب پاڼو او پلیټ فارمونو کې په پوره ځواک سره کار کوي.",
      advantageTitle: "ولې زموږ ویزا کارت توپیر لري؟",
      advantageText: "په افغانستان کې د اوسنیو بانکي کارتونو لویه ستونزه له نړیوالو تادیاتي سیسټمونو سره د بشپړې اړیکې نشتوالی دی. د SafiPay کارتونه په مستقیم ډول د اروپایي اتحادیې له مالي بنسټونو څخه صادریږي. دا پدې مانا ده چې تاسو کولی شئ له کابل، هرات یا بل هر ځای څخه خپل لګښتونه په ټوله نړۍ کې تادیه کړئ — پرته له دې چې د معاملې ردیدو یا بندیدو ویره ولرئ.",
      comparisonTitle: "مهم توپیرونه په لنډه توګه",
      comp1: "نړیوال فعالیت: د کورنیو بانکونو برعکس، زموږ کارت په ټولو نړیوالو دروازو کې پرته له جغرافیایي محدودیتونو ۱۰۰٪ فعال دی.",
      comp2: "د صادرولو سرعت: ډیجیټل صادریدل په لږ تر لږه ۱ دقیقه کې، پداسې حال کې چې دودیز بانکونه تاسو د یو ساده کارت لپاره اونۍ انتظار باسي.",
      comp3: "تخنیکي امنیت: د مجتبی (د تخنیکي امنیت مدیر) لخوا مستقیم نظارت ترڅو په ټولو پروتوکولونو کې د کوډ کولو لوړه کچه تضمین شي.",
      techTitle: "تخنیکي او مدیریتي زیربنا",
      techDesc: "مجتبی، زموږ د عملیاتو او تخنیکي امنیت مدیر، داسې پرمختللي پروتوکولونه پلي کړي چې ډاډ ورکوي ستاسو معاملې له سختو نړیوالو فلټرونو څخه تیریږي. سربیره پردې، ساحل (د نړیوالې پراختیا مدیرې) ډاډ ترلاسه کړی چې دا کارتونه په بشپړ ډول د اروپا له پولي قوانینو او IBAN حسابونو سره د بې ځایه ادغام لپاره همغږي دي.",
      quote: "موږ یوازې یو کارت نه صادروو؛ بلکې د نړۍ د اقتصاد دروازې د هر افغان تبعه پر مخ پرانیزو. دا ستاسو حق دی چې له نړۍ سره وصل شئ.",
      quoteAuthor: "شاهین صافی — د SafiPay بنسټ اېښودونکی",
      backBtn: "د SafiPay پوهنغونډ ته راستنیدل"
    }
  };
            ...
            <article className={`space-y-16 text-gray-300 leading-[2.4] ${isRtl ? 'text-right' : 'text-left'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 my-24">
                <div className="p-12 rounded-[3rem] bg-white/[0.02] border border-white/10 transition-all duration-500 hover:scale-105 hover:bg-white/[0.05] group">
                  ...
                  <h4 className="text-white font-black text-2xl mb-4">نړیواله پیرودنه</h4>
                  <p className="text-gray-500 leading-relaxed text-sm">د SafiPay د لوړ امنیت سره ایمیزون، ای بی او ټولو نړیوالو تادیاتي دروازو ته نامحدود لاسرسی ترلاسه کړئ.</p>
                </div>
                <div className="p-12 rounded-[3rem] bg-white/[0.02] border border-white/10 transition-all duration-500 hover:scale-105 hover:bg-white/[0.05] group">
                  ...
                  <h4 className="text-white font-black text-2xl mb-4">اروپایي امنیت</h4>
                  <p className="text-gray-500 leading-relaxed text-sm">ستاسو معاملې په مستقیم ډول د مجتبی لخوا نظارت کیږي او په بشپړ ډول په اروپایي اتحادیه کې د بانک معیارونو سره مطابقت لري.</p>
                </div>
              </div>
            </article>
