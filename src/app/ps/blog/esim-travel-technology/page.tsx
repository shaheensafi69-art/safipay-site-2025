    ...
    <main className="min-h-screen bg-black text-[#d4d4d8] selection:bg-[#D4AF37] selection:text-black font-sans overflow-x-hidden" dir="rtl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-up text-right">
              <div className="flex items-center gap-3 mb-6 justify-start">
                ...
                <span className="text-[#D4AF37] text-xs font-bold tracking-[0.5em] uppercase">د نړیوالو اړیکو راتلونکی</span>
              </div>
              
              <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight italic">
                بې پولې <br />
                <span className="text-[#D4AF37] gold-text-glow">اړیکې</span>
              </h1>
              
              <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl mb-10">
                د سفر تکامل تجربه کړئ. د صافي‌پی (E-SIM) ټیکنالوژي تاسو په لږه موده کې له ۲۰۰ څخه زیاتو هیوادونو سره وصلوي. فزیکي سیمکارت ته اړتیا نشته؛ خالص ډیجیټل ځواک ستاسو په لاس کې دی.
              </p>
              ...
              <div className="flex flex-wrap gap-6 justify-start">
                <div className="flex items-center gap-3 px-8 py-4 bg-[#D4AF37] text-black font-bold rounded-full hover:scale-105 transition-transform cursor-pointer">
                  سمدستي فعالول <ArrowRight size={18} className="rotate-180" />
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-6 z-10 relative">
        <div className="container mx-auto">
          <div className="text-center mb-20 animate-fade-up">
            <h2 className="text-4xl md:text-5xl font-black text-white italic mb-6">نړیوالې <span className="text-[#D4AF37]">ګټې</span></h2>
            <p className="text-gray-500 max-w-2xl mx-auto italic font-light">د SafiPay لخوا د نړۍ د غوره مسافرینو لپاره ډیزاین شوی.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-10 rounded-[2.5rem] group hover:border-[#D4AF37]/50 transition-all duration-500 text-right">
              ...
              <h3 className="text-white text-2xl font-bold mb-4">چټک تنظیمول</h3>
              <p className="text-gray-500 text-sm leading-relaxed">خپله نړیواله ډیټا بسته په ۶۰ ثانیو کې فعاله کړئ. سرعت زموږ د کار نښه ده.</p>
            </div>

            {/* دویمه ځانګړنه */}
            <div className="glass-card p-10 rounded-[2.5rem] group hover:border-[#D4AF37]/50 transition-all duration-500 text-right">
              <Globe2 className="text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform" size={40} />
              <h3 className="text-white text-2xl font-bold mb-4">له ۲۰۰ څخه زیات هیوادونه</h3>
              <p className="text-gray-500 text-sm leading-relaxed">له لندن څخه تر دوبۍ؛ په هر ځای کې چې یئ، د سیمه ییزو تیزو 5G شبکو سره وصل پاتې شئ.</p>
            </div>

            {/* دریمه ځانګړنه */}
            <div className="glass-card p-10 rounded-[2.5rem] group hover:border-[#D4AF37]/50 transition-all duration-500 text-right">
              <ShieldCheck className="text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform" size={40} />
              <h3 className="text-white text-2xl font-bold mb-4">اروپايي امنیت</h3>
              <p className="text-gray-500 text-sm leading-relaxed">د اروپا د معلوماتو د محرمیت معیارونو سره سم کوډ شوې اړیکې. ستاسو معلومات خوندي دي.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="glass-card rounded-[3.5rem] p-8 md:p-16 overflow-hidden relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-right">
                <h2 className="text-3xl md:text-5xl font-black text-white italic mb-8">د نوي نسل <br /><span className="text-[#D4AF37]">زېربنا</span></h2>
                
                <div className="space-y-6">
                  <div className="flex items-start gap-4 justify-start">
                    <div className="bg-[#D4AF37]/10 p-2 rounded-lg"><Smartphone className="text-[#D4AF37]" size={24} /></div>
                    <div>
                      <h4 className="text-white font-bold">د ټولو وسایلو ملاتړ</h4>
                      <p className="text-gray-500 text-sm">له ټولو آیفون او انډرایډ موبایلونو سره چې E-SIM ټیکنالوژي لري، برابر دی.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 justify-start">
                    <div className="bg-[#D4AF37]/10 p-2 rounded-lg"><Wifi className="text-[#D4AF37]" size={24} /></div>
                    <div>
                      <h4 className="text-white font-bold">5G ته چمتووالی</h4>
                      <p className="text-gray-500 text-sm">بې له ځنډه ویډیوګانو او کاري اړیکو لپاره خورا لوړ سرعت.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 justify-start">
                    <div className="bg-[#D4AF37]/10 p-2 rounded-lg"><BarChart3 className="text-[#D4AF37]" size={24} /></div>
                    <div>
                      <h4 className="text-white font-bold">ژوندۍ اداره کول</h4>
                      <p className="text-gray-500 text-sm">خپله ډیټا مصرف په ژوندۍ بڼه د صافي‌پی کنټرول پینل له لارې وګورئ.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="py-32 text-center z-10 relative border-t border-white/5">
        <div className="container mx-auto px-6">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white italic mb-8 tracking-tighter uppercase">الوتنې ته چمتو یئ؟</h2>
          <p className="text-gray-400 mb-12 max-w-lg mx-auto italic">له زرګونو هغو مسافرو سره یوځای شئ چې د خپلو نړیوالو اړیکو لپاره پر صافي‌پی باور لري.</p>
