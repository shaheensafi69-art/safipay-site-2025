      ...
      <div className="relative z-10">
        ...
        <section ref={containerRef} className="relative pt-32 pb-20 flex flex-col items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mt-12 px-6">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-10 text-gray-500 text-sm">
               <span className="flex items-center gap-2"><MapPin size={16}/> اسلام‌اباد، پاکستان</span>
               <span className="flex items-center gap-2"><User size={16}/> د زېږېدو نېټه: ۱۶ ډسمبر ۲۰۰۴</span>
            </div>
          </motion.div>
        </section>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="bg-[#080808] border border-white/5 p-10 md:p-16 rounded-[4rem] shadow-2xl">
            ...
            <div className="space-y-8 text-gray-300 text-xl leading-[2.3] text-justify font-light">
              ...
              <div className="bg-pink-500/10 p-8 rounded-[2.5rem] italic border-r-8 border-pink-500 text-pink-100">
                "زما وروستی هدف د اقتصادي ستراتیژۍ، پرمختللي مصنوعي ځیرکتیا او بې‌عیبه ډیزاین یوځای کول دي، ترڅو د SafiPay سره مرسته وکړم چې په نړیوال ډیجیټل مالي اکوسیستم کې یو مخکښ ځواک شي."
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <section className="py-20 bg-pink-500/[0.02]">
          <div className="container mx-auto max-w-6xl px-6">
            <h2 className="text-center text-4xl font-black mb-20 italic">مسلکي تخصصونه</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4">مدیریت او اقتصاد</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono">سوداګریزه ستراتیژي، د عملیاتو مدیریت، اقتصادي تحلیل، د ټیم مشرتابه، د چټکو (Agile) میتودونو کارونه</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                <Code2 className="text-pink-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">فول سټیک ډیولپمنټ</h3>
              ...
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-4">ګرافیک ډیزاین</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono">د UI/UX ډیزاین، فیګما (Figma)، فوټوشاپ، الستریټر، د برانډ هویت، بصري ارتباطات</p>
              </div>
              <div className="p-8 bg-black border border-white/5 rounded-[3rem] hover:border-pink-500/40 transition-all group">
                <Cpu className="text-pink-500 mb-6 group-hover:scale-110 transition-transform" size={40} />
                <h3 className="text-xl font-bold mb-4">مصنوعي ځیرکتیا</h3>
                <p className="text-gray-500 text-sm leading-relaxed font-mono">د پرامپټ انجینري، د AI ادغام، د ماشین زده کړې مفاهیم، د کاري جریان اتومات کول</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12">
            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic"><Briefcase className="text-pink-500"/> کاري تجربه</h2>
              <div className="space-y-8 border-l-2 border-white/10 pr-8">
                <div className="relative">
                  <div className="absolute -right-[41px] top-2 w-4 h-4 bg-pink-500 rounded-full" />
                  <h4 className="text-xl font-bold text-white">مدیره</h4>
                  <p className="text-pink-500 text-sm mb-2">د SafiPay اکوسیستم (اوس مهال)</p>
                  <p className="text-gray-500 text-sm">د عملیاتي مدیریت رهبري کول، د ټیم پر همغږۍ څارنه او د SafiPay پلاتفورم لپاره د سوداګریزو ستراتیژیو سره د ټکنالوژۍ د حللارو ادغام کول.</p>
                </div>
                <div className="relative">
                  <div className="absolute -right-[41px] top-2 w-4 h-4 bg-white/20 rounded-full" />
                  <h4 className="text-xl font-bold text-white">فول سټیک ډیولپره او ډیزاینره</h4>
                  <p className="text-pink-500 text-sm mb-2">فریلنسري او شخصي پروژې</p>
                  <p className="text-gray-500 text-sm">د وېب پلاتفورمونو بشپړ ډیولپمنټ، د UI/UX ډیزاینونه او د برانډونو لپاره د زړه پورې لیدلوري رامنځته کول.</p>
                </div>
              </div>
            </div>

            <div className="space-y-10">
              <h2 className="text-3xl font-black flex items-center gap-4 italic"><GraduationCap className="text-pink-500"/> زده کړې</h2>
              <div className="space-y-8 border-l-2 border-white/10 pr-8">
                <div className="relative">
                  <div className="absolute -right-[41px] top-2 w-4 h-4 bg-pink-500 rounded-full" />
                  <h4 className="text-xl font-bold text-white">د ساینس او ​​ټکنالوژۍ ملي پوهنتون (NUST)</h4>
                  <p className="text-pink-500 text-sm">اسلام‌اباد، پاکستان</p>
                  <p className="text-gray-500 text-sm mt-1">په اقتصاد کې د لیسانس سند. په اقتصادي ستراتیژۍ او مالي مدیریت کې د قوي بنسټ سره فارغه شوې.</p>
                </div>
                <div className="relative">
                  <div className="absolute -right-[41px] top-2 w-4 h-4 bg-white/20 rounded-full" />
                  <h4 className="text-xl font-bold text-white">د ټکنالوژۍ او ډیزاین تصدیقپاڼې</h4>
                  <p className="text-pink-500 text-sm italic">په مصنوعي ځیرکتیا، فول سټیک ډیولپمنټ او ګرافیک ډیزاین کې پرمختللې زده کړې.</p>
                </div>
              </div>
              <div className="pt-10">
                <h3 className="text-xl font-bold mb-6 flex items-center gap-3"><Languages size={20} className="text-pink-500"/> د ژبو تسلط</h3>
                <div className="flex flex-wrap gap-4">
                  {['انګلیسي', 'دري', 'پښتو', 'اردو'].map(lang => (
        ...
        <section className="py-20 container mx-auto max-w-4xl px-6 text-center">
           <div className="bg-gradient-to-br from-pink-500/20 to-transparent p-12 rounded-[4rem] border border-pink-500/20">
              ...
              <h2 className="text-3xl font-black mb-6">کلیدي وړتیاوې</h2>
              <ul className="text-gray-300 space-y-4 text-lg text-right inline-block" dir="rtl">
                <li>• له ډیجیټل ټکنالوژۍ سره د اقتصاد په نښلولو کې ځانګړی تخصص</li>
                <li>• د هوش مصنوعي (AI) په وسایلو او د پرامپټ انجینرۍ په برخه کې پوره تسلط</li>
                <li>• د SafiPay په اکوسیستم کې مدیریتي رهبري او سمبالښت</li>
                <li>• د وېب پلاتفورمونو د ډیزاین او بشپړ کوډ کولو خلاقانه وړتیا</li>
              </ul>
           </div>
        </section>
        ...
        <footer className="py-20 text-center">
          ...
          <p className="opacity-30 text-xs tracking-widest uppercase">
            شیرین ګل احمدي • د تخنیکي او مدیریتي پورتفولیو پیاوړې لیدلوری • ۲۰۲۶
          </p>
        </footer>
      </div>
    </div>
